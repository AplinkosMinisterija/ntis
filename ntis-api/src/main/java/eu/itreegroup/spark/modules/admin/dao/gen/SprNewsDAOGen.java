...
public class SprNewsDAOGen extends SprBaseDAO{
   ...
   public void setNw_id(Double nw_id) {
      if (this.isForceUpdate() || (this.nw_id != null && !this.nw_id.equals(nw_id)) || (nw_id != null && !nw_id.equals(this.nw_id))){
   ...
   public void setNw_type(String nw_type) {
      if (this.isForceUpdate() || (this.nw_type != null && !this.nw_type.equals(nw_type)) || (nw_type != null && !nw_type.equals(this.nw_type))){
   ...
   public void setNw_lang(String nw_lang) {
      if (this.isForceUpdate() || (this.nw_lang != null && !this.nw_lang.equals(nw_lang)) || (nw_lang != null && !nw_lang.equals(this.nw_lang))){
   ...
   public void setNw_title(String nw_title) {
      if (this.isForceUpdate() || (this.nw_title != null && !this.nw_title.equals(nw_title)) || (nw_title != null && !nw_title.equals(this.nw_title))){
   ...
   public void setNw_summary(String nw_summary) {
      if (this.isForceUpdate() || (this.nw_summary != null && !this.nw_summary.equals(nw_summary)) || (nw_summary != null && !nw_summary.equals(this.nw_summary))){
   ...
   public void setNw_text(String nw_text) {
      if (this.isForceUpdate() || (this.nw_text != null && !this.nw_text.equals(nw_text)) || (nw_text != null && !nw_text.equals(this.nw_text))){
   ...
   public void setNw_content_for_search(String nw_content_for_search) {
      if (this.isForceUpdate() || (this.nw_content_for_search != null && !this.nw_content_for_search.equals(nw_content_for_search)) || (nw_content_for_search != null && !nw_content_for_search.equals(this.nw_content_for_search))){
   ...
   public void setNw_publication_date(Date nw_publication_date) {
      if (this.isForceUpdate() || (this.nw_publication_date != null && !this.nw_publication_date.equals(nw_publication_date)) || (nw_publication_date != null && !nw_publication_date.equals(this.nw_publication_date))){
   ...
   public void setNw_date_from(Date nw_date_from) {
      if (this.isForceUpdate() || (this.nw_date_from != null && !this.nw_date_from.equals(nw_date_from)) || (nw_date_from != null && !nw_date_from.equals(this.nw_date_from))){
   ...
   public void setNw_date_to(Date nw_date_to) {
      if (this.isForceUpdate() || (this.nw_date_to != null && !this.nw_date_to.equals(nw_date_to)) || (nw_date_to != null && !nw_date_to.equals(this.nw_date_to))){
    ...
    public void validateObject(int operation, SprBaseDBServiceImpl<?> baseService) throws SparkBusinessException{
      ...
      if (nw_title_changed || operation == Utils.OPERATION_INSERT) {
         if (nw_title== null || EMPTY_STRING.equals(nw_title)) {
            ...
            if (nw_title!= null && nw_title.length()>2147483647) {
               throw new SparkBusinessException(new S2Message("SPR_NEWS", "NW_TITLE", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
            }
         }
      }
      if (nw_summary_changed || operation == Utils.OPERATION_INSERT) {
         if (nw_summary== null || EMPTY_STRING.equals(nw_summary)) {
            ...
            if (nw_summary!= null && nw_summary.length()>2147483647) {
               throw new SparkBusinessException(new S2Message("SPR_NEWS", "NW_SUMMARY", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
            }
         }
      }
      if (nw_text_changed || operation == Utils.OPERATION_INSERT) {
         if (nw_text== null || EMPTY_STRING.equals(nw_text)) {
            ...
            if (nw_text!= null && nw_text.length()>2147483647) {
               throw new SparkBusinessException(new S2Message("SPR_NEWS", "NW_TEXT", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
            }
         }
      }
      if (nw_content_for_search_changed || operation == Utils.OPERATION_INSERT) {
         if (nw_content_for_search!= null && nw_content_for_search.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("SPR_NEWS", "NW_CONTENT_FOR_SEARCH", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      ...
      if (c01_changed || operation == Utils.OPERATION_INSERT) {
         if (c01!= null && c01.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("SPR_NEWS", "C01", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c02_changed || operation == Utils.OPERATION_INSERT) {
         if (c02!= null && c02.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("SPR_NEWS", "C02", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c03_changed || operation == Utils.OPERATION_INSERT) {
         if (c03!= null && c03.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("SPR_NEWS", "C03", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c04_changed || operation == Utils.OPERATION_INSERT) {
         if (c04!= null && c04.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("SPR_NEWS", "C04", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c05_changed || operation == Utils.OPERATION_INSERT) {
         if (c05!= null && c05.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("SPR_NEWS", "C05", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
   }
   ...
   public UpdateStatementPart constructUpdatePart(String userName) {
      ...
      if (nw_date_from_changed) {
         ...
         changedExists = true;
         updateStatementPart.addStatementTimestampParam(nw_date_from);
      }
      if (nw_date_to_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"NW_DATE_TO = ? ";
         changedExists = true;
         updateStatementPart.addStatementTimestampParam(nw_date_to);
      }
      if (n01_changed) {

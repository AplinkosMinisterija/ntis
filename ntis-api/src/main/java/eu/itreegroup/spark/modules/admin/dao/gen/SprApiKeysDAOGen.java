...
public class SprApiKeysDAOGen extends SprBaseDAO{
   public static String IDENTIFIER="SPR_API_KEYS.API_ID";
   ...
   protected boolean api_id_changed;
   protected boolean api_type_code_changed;
   protected boolean api_key_changed;
   protected boolean api_ou_id_changed;
   protected boolean api_usr_id_changed;
   protected boolean api_date_from_changed;
   protected boolean api_date_to_changed;
   ...
   public SprApiKeysDAOGen() {
      markObjectAsInitial();
      setRecordLoaded(false);
      setForceUpdate(false);
   }
   public SprApiKeysDAOGen(Double api_id, String api_type_code, String api_key, Double api_ou_id, Double api_usr_id, Date api_date_from, Date api_date_to, Double rec_version, Date rec_create_timestamp, String rec_userid, Date rec_timestamp, Double n01, Double n02, Double n03, Double n04, Double n05, String c01, String c02, String c03, String c04, String c05, Date d01, Date d02, Date d03, Date d04, Date d05) {
      this.api_id = api_id;
   ...
   public void copyValues(SprApiKeysDAOGen obj) {
      this.setApi_id(obj.getApi_id());
      this.setApi_type_code(obj.getApi_type_code());
      this.setApi_key(obj.getApi_key());
      this.setApi_ou_id(obj.getApi_ou_id());
      this.setApi_usr_id(obj.getApi_usr_id());
      this.setApi_date_from(obj.getApi_date_from());
      this.setApi_date_to(obj.getApi_date_to());
   ...
   protected void markObjectAsInitial() {
      this.api_id_changed = false;
      this.api_type_code_changed = false;
      this.api_key_changed = false;
      this.api_ou_id_changed = false;
      this.api_usr_id_changed = false;
      this.api_date_from_changed = false;
      this.api_date_to_changed = false;
   ...
   public void setApi_id(Double api_id) {
      if (this.isForceUpdate() || (this.api_id != null && !this.api_id.equals(api_id)) || (api_id != null && !api_id.equals(this.api_id))){
         this.api_id_changed = true; 
   ...
   public void setApi_type_code(String api_type_code) {
      if (this.isForceUpdate() || (this.api_type_code != null && !this.api_type_code.equals(api_type_code)) || (api_type_code != null && !api_type_code.equals(this.api_type_code))){
         this.api_type_code_changed = true; 
         this.record_changed = true;
         this.api_type_code = api_type_code;
      }
   }
   public String getApi_type_code() {
      return this.api_type_code;
   }
   public void setApi_key(String api_key) {
      if (this.isForceUpdate() || (this.api_key != null && !this.api_key.equals(api_key)) || (api_key != null && !api_key.equals(this.api_key))){
   ...
   public void setApi_ou_id(Double api_ou_id) {
      if (this.isForceUpdate() || (this.api_ou_id != null && !this.api_ou_id.equals(api_ou_id)) || (api_ou_id != null && !api_ou_id.equals(this.api_ou_id))){
         this.api_ou_id_changed = true; 
         this.record_changed = true;
         this.api_ou_id = api_ou_id;
      }
   }
   public Double getApi_ou_id() {
      return this.api_ou_id;
   }
   public void setApi_usr_id(Double api_usr_id) {
      if (this.isForceUpdate() || (this.api_usr_id != null && !this.api_usr_id.equals(api_usr_id)) || (api_usr_id != null && !api_usr_id.equals(this.api_usr_id))){
         this.api_usr_id_changed = true; 
         this.record_changed = true;
         this.api_usr_id = api_usr_id;
      }
   }
   public Double getApi_usr_id() {
      return this.api_usr_id;
   }
   public void setApi_date_from(Date api_date_from) {
      if (this.isForceUpdate() || (this.api_date_from != null && !this.api_date_from.equals(api_date_from)) || (api_date_from != null && !api_date_from.equals(this.api_date_from))){
         this.api_date_from_changed = true; 
         this.record_changed = true;
         this.api_date_from = api_date_from;
      }
   }
   public Date getApi_date_from() {
      return this.api_date_from;
   }
   public void setApi_date_to(Date api_date_to) {
      if (this.isForceUpdate() || (this.api_date_to != null && !this.api_date_to.equals(api_date_to)) || (api_date_to != null && !api_date_to.equals(this.api_date_to))){
         this.api_date_to_changed = true; 
         this.record_changed = true;
         this.api_date_to = api_date_to;
      }
   }
   public Date getApi_date_to() {
      return this.api_date_to;
   }
   ...
   public Date getD05() {
    ...
    public void setRecordIdentifier(Object recIdentifier) {
        if (recIdentifier != null && !EMPTY_STRING.equals(recIdentifier)  && !"null".equalsIgnoreCase(recIdentifier.toString())){
            this.api_id = (Double)recIdentifier;
        }
    }
    @JsonIgnore
    ...
    public void validateObject(int operation, SprBaseDBServiceImpl<?> baseService) throws SparkBusinessException{
      if (api_type_code_changed || operation == Utils.OPERATION_INSERT) {
         if (api_type_code!= null && api_type_code.length()>50) {
            throw new SparkBusinessException(new S2Message("SPR_API_KEYS", "API_TYPE_CODE", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"50"));
         }
      }
      if (api_key_changed || operation == Utils.OPERATION_INSERT) {
         if (api_key!= null && api_key.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("SPR_API_KEYS", "API_KEY", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (api_ou_id_changed || operation == Utils.OPERATION_INSERT) {
         if (api_ou_id!= null && (""+api_ou_id.intValue()).length()>10) {
            throw new SparkBusinessException(new S2Message("SPR_API_KEYS", "API_OU_ID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"10"));
         }
      }
      if (api_usr_id_changed || operation == Utils.OPERATION_INSERT) {
         if (api_usr_id!= null && (""+api_usr_id.intValue()).length()>10) {
            throw new SparkBusinessException(new S2Message("SPR_API_KEYS", "API_USR_ID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"10"));
         }
      }
      if (api_date_from_changed || operation == Utils.OPERATION_INSERT) {
         if (api_date_from== null) {
            throw new SparkBusinessException(new S2Message("SPR_API_KEYS", "API_DATE_FROM", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }
      }
      if (rec_version_changed || operation == Utils.OPERATION_INSERT) {
         if (rec_version!= null && (""+rec_version.intValue()).length()>6) {
            throw new SparkBusinessException(new S2Message("SPR_API_KEYS", "REC_VERSION", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"6"));
         }
      }
      if (rec_userid_changed || operation == Utils.OPERATION_INSERT) {
         if (rec_userid!= null && rec_userid.length()>128) {
            throw new SparkBusinessException(new S2Message("SPR_API_KEYS", "REC_USERID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"128"));
         }
      }
      if (c01_changed || operation == Utils.OPERATION_INSERT) {
         if (c01!= null && c01.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("SPR_API_KEYS", "C01", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c02_changed || operation == Utils.OPERATION_INSERT) {
         if (c02!= null && c02.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("SPR_API_KEYS", "C02", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c03_changed || operation == Utils.OPERATION_INSERT) {
         if (c03!= null && c03.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("SPR_API_KEYS", "C03", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c04_changed || operation == Utils.OPERATION_INSERT) {
         if (c04!= null && c04.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("SPR_API_KEYS", "C04", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c05_changed || operation == Utils.OPERATION_INSERT) {
         if (c05!= null && c05.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("SPR_API_KEYS", "C05", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
   }
   ...
   public UpdateStatementPart constructUpdatePart(String userName) {
      ...
      String answer = "UPDATE SPR_API_KEYS SET ";
      boolean changedExists = false;      if (api_type_code_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"API_TYPE_CODE = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(api_type_code);
      }
      if (api_key_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"API_KEY = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(api_key);
      }
      if (api_ou_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"API_OU_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(api_ou_id);
      }
      if (api_usr_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"API_USR_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(api_usr_id);
      }
      if (api_date_from_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"API_DATE_FROM = ? ";
         changedExists = true;
         updateStatementPart.addStatementTimestampParam(api_date_from);
      }
      if (api_date_to_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"API_DATE_TO = ? ";
         changedExists = true;
         updateStatementPart.addStatementTimestampParam(api_date_to);
      }
      if (n01_changed) {
      ...
      answer = answer +" WHERE  API_ID = ? ";
      updateStatementPart.addStatementParam(api_id);
      updateStatementPart.setStatementPart(answer);
      return updateStatementPart;
   }
   public String toString() {
      return "{\"SprApiKeysDAO\":{\"api_id\": \""+getApi_id()+"\", \"api_type_code\": \""+getApi_type_code()+"\", \"api_key\": \""+getApi_key()+"\", \"api_ou_id\": \""+getApi_ou_id()+"\", \"api_usr_id\": \""+getApi_usr_id()+"\", \"api_date_from\": \""+getApi_date_from()+"\", \"api_date_to\": \""+getApi_date_to()+"\", \"rec_version\": \""+getRec_version()+"\", \"rec_create_timestamp\": \""+getRec_create_timestamp()+"\", \"rec_userid\": \""+getRec_userid()+"\", \"rec_timestamp\": \""+getRec_timestamp()+"\", \"n01\": \""+getN01()+"\", \"n02\": \""+getN02()+"\", \"n03\": \""+getN03()+"\", \"n04\": \""+getN04()+"\", \"n05\": \""+getN05()+"\", \"c01\": \""+getC01()+"\", \"c02\": \""+getC02()+"\", \"c03\": \""+getC03()+"\", \"c04\": \""+getC04()+"\", \"c05\": \""+getC05()+"\", \"d01\": \""+getD01()+"\", \"d02\": \""+getD02()+"\", \"d03\": \""+getD03()+"\", \"d04\": \""+getD04()+"\", \"d05\": \""+getD05()+"\"}}";
   }

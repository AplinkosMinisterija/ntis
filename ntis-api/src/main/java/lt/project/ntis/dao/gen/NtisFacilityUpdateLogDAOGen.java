...
public class NtisFacilityUpdateLogDAOGen extends SprBaseDAO{
   public static String IDENTIFIER="NTIS_FACILITY_UPDATE_LOGS.FUL_ID";
   private Double ful_id;
   private String ful_operation;
   private Date ful_created;
   private Double ful_wtf_id;
   private Double ful_usr_id;
   private Double ful_org_id;
   ...
   protected boolean ful_id_changed;
   protected boolean ful_operation_changed;
   protected boolean ful_created_changed;
   protected boolean ful_wtf_id_changed;
   protected boolean ful_usr_id_changed;
   protected boolean ful_org_id_changed;
   ...
   public NtisFacilityUpdateLogDAOGen() {
      markObjectAsInitial();
      setRecordLoaded(false);
      setForceUpdate(false);
   }
   public NtisFacilityUpdateLogDAOGen(Double ful_id, String ful_operation, Date ful_created, Double ful_wtf_id, Double ful_usr_id, Double ful_org_id, Double rec_version, Date rec_create_timestamp, String rec_userid, Date rec_timestamp, Double n01, Double n02, Double n03, Double n04, Double n05, String c01, String c02, String c03, String c04, String c05, Date d01, Date d02, Date d03, Date d04, Date d05) {
      this.ful_id = ful_id;
      this.ful_operation = ful_operation;
      this.ful_created = ful_created;
      this.ful_wtf_id = ful_wtf_id;
      this.ful_usr_id = ful_usr_id;
      this.ful_org_id = ful_org_id;
   ...
   public void copyValues(NtisFacilityUpdateLogDAOGen obj) {
      this.setFul_id(obj.getFul_id());
      this.setFul_operation(obj.getFul_operation());
      this.setFul_created(obj.getFul_created());
      this.setFul_wtf_id(obj.getFul_wtf_id());
      this.setFul_usr_id(obj.getFul_usr_id());
      this.setFul_org_id(obj.getFul_org_id());
   ...
   protected void markObjectAsInitial() {
      this.ful_id_changed = false;
      this.ful_operation_changed = false;
      this.ful_created_changed = false;
      this.ful_wtf_id_changed = false;
      this.ful_usr_id_changed = false;
      this.ful_org_id_changed = false;
   ...
   public void setFul_id(Double ful_id) {
      if (this.isForceUpdate() || (this.ful_id != null && !this.ful_id.equals(ful_id)) || (ful_id != null && !ful_id.equals(this.ful_id))){
         this.ful_id_changed = true; 
   ...
   public void setFul_operation(String ful_operation) {
      if (this.isForceUpdate() || (this.ful_operation != null && !this.ful_operation.equals(ful_operation)) || (ful_operation != null && !ful_operation.equals(this.ful_operation))){
         this.ful_operation_changed = true; 
         this.record_changed = true;
         this.ful_operation = ful_operation;
      }
   }
   public String getFul_operation() {
      return this.ful_operation;
   }
   public void setFul_created(Date ful_created) {
      if (this.isForceUpdate() || (this.ful_created != null && !this.ful_created.equals(ful_created)) || (ful_created != null && !ful_created.equals(this.ful_created))){
         this.ful_created_changed = true; 
         this.record_changed = true;
         this.ful_created = ful_created;
      }
   }
   public Date getFul_created() {
      return this.ful_created;
   }
   public void setFul_wtf_id(Double ful_wtf_id) {
      if (this.isForceUpdate() || (this.ful_wtf_id != null && !this.ful_wtf_id.equals(ful_wtf_id)) || (ful_wtf_id != null && !ful_wtf_id.equals(this.ful_wtf_id))){
         this.ful_wtf_id_changed = true; 
         this.record_changed = true;
         this.ful_wtf_id = ful_wtf_id;
      }
   }
   public Double getFul_wtf_id() {
      return this.ful_wtf_id;
   }
   public void setFul_usr_id(Double ful_usr_id) {
      if (this.isForceUpdate() || (this.ful_usr_id != null && !this.ful_usr_id.equals(ful_usr_id)) || (ful_usr_id != null && !ful_usr_id.equals(this.ful_usr_id))){
         this.ful_usr_id_changed = true; 
         this.record_changed = true;
         this.ful_usr_id = ful_usr_id;
      }
   }
   public Double getFul_usr_id() {
      return this.ful_usr_id;
   }
   public void setFul_org_id(Double ful_org_id) {
      if (this.isForceUpdate() || (this.ful_org_id != null && !this.ful_org_id.equals(ful_org_id)) || (ful_org_id != null && !ful_org_id.equals(this.ful_org_id))){
         this.ful_org_id_changed = true; 
         this.record_changed = true;
         this.ful_org_id = ful_org_id;
      }
   }
   public Double getFul_org_id() {
      return this.ful_org_id;
   }
   ...
   public Date getD05() {
    ...
    public void setRecordIdentifier(Object recIdentifier) {
        if (recIdentifier != null && !EMPTY_STRING.equals(recIdentifier)  && !"null".equalsIgnoreCase(recIdentifier.toString())){
            this.ful_id = (Double)recIdentifier;
        }
    }
    @JsonIgnore
    ...
    public void validateObject(int operation, SprBaseDBServiceImpl<?> baseService) throws SparkBusinessException{
      if (ful_operation_changed || operation == Utils.OPERATION_INSERT) {
         if (ful_operation!= null && ful_operation.length()>50) {
            throw new SparkBusinessException(new S2Message("NTIS_FACILITY_UPDATE_LOGS", "FUL_OPERATION", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"50"));
         }
      }
      if (ful_created_changed || operation == Utils.OPERATION_INSERT) {
         if (ful_created== null) {
            throw new SparkBusinessException(new S2Message("NTIS_FACILITY_UPDATE_LOGS", "FUL_CREATED", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }
      }
      if (ful_wtf_id_changed || operation == Utils.OPERATION_INSERT) {
         if (ful_wtf_id!= null && (""+ful_wtf_id.intValue()).length()>10) {
            throw new SparkBusinessException(new S2Message("NTIS_FACILITY_UPDATE_LOGS", "FUL_WTF_ID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"10"));
         }
      }
      if (ful_usr_id_changed || operation == Utils.OPERATION_INSERT) {
         if (ful_usr_id!= null && (""+ful_usr_id.intValue()).length()>10) {
            throw new SparkBusinessException(new S2Message("NTIS_FACILITY_UPDATE_LOGS", "FUL_USR_ID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"10"));
         }
      }
      if (ful_org_id_changed || operation == Utils.OPERATION_INSERT) {
         if (ful_org_id!= null && (""+ful_org_id.intValue()).length()>10) {
            throw new SparkBusinessException(new S2Message("NTIS_FACILITY_UPDATE_LOGS", "FUL_ORG_ID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"10"));
         }
      }
      if (rec_version_changed || operation == Utils.OPERATION_INSERT) {
         if (rec_version!= null && (""+rec_version.intValue()).length()>6) {
            throw new SparkBusinessException(new S2Message("NTIS_FACILITY_UPDATE_LOGS", "REC_VERSION", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"6"));
         }
      }
      if (rec_userid_changed || operation == Utils.OPERATION_INSERT) {
         if (rec_userid!= null && rec_userid.length()>128) {
            throw new SparkBusinessException(new S2Message("NTIS_FACILITY_UPDATE_LOGS", "REC_USERID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"128"));
         }
      }
      if (c01_changed || operation == Utils.OPERATION_INSERT) {
         if (c01!= null && c01.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_FACILITY_UPDATE_LOGS", "C01", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c02_changed || operation == Utils.OPERATION_INSERT) {
         if (c02!= null && c02.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_FACILITY_UPDATE_LOGS", "C02", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c03_changed || operation == Utils.OPERATION_INSERT) {
         if (c03!= null && c03.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_FACILITY_UPDATE_LOGS", "C03", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c04_changed || operation == Utils.OPERATION_INSERT) {
         if (c04!= null && c04.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_FACILITY_UPDATE_LOGS", "C04", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c05_changed || operation == Utils.OPERATION_INSERT) {
         if (c05!= null && c05.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_FACILITY_UPDATE_LOGS", "C05", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
   }
   ...
   public UpdateStatementPart constructUpdatePart(String userName) {
      ...
      String answer = "UPDATE NTIS_FACILITY_UPDATE_LOGS SET ";
      boolean changedExists = false;      if (ful_operation_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"FUL_OPERATION = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(ful_operation);
      }
      if (ful_created_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"FUL_CREATED = ? ";
         changedExists = true;
         updateStatementPart.addStatementTimestampParam(ful_created);
      }
      if (ful_wtf_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"FUL_WTF_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(ful_wtf_id);
      }
      if (ful_usr_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"FUL_USR_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(ful_usr_id);
      }
      if (ful_org_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"FUL_ORG_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(ful_org_id);
      }
      if (n01_changed) {

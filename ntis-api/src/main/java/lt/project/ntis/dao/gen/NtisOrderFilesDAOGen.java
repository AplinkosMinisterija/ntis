...
public class NtisOrderFilesDAOGen extends SprBaseDAO{
   public static String IDENTIFIER="NTIS_ORDER_FILES.ORF_ID";
   private Double orf_id;
   private Date orf_import_date;
   private String orf_status;
   private Date orf_status_date;
   private Double orf_org_id;
   private Double orf_fil_id;
   private Double orf_srv_id;
   ...
   private Date d04;
   private Date d05;
   private Double orf_usr_id;

   protected boolean orf_id_changed;
   protected boolean orf_import_date_changed;
   protected boolean orf_status_changed;
   protected boolean orf_status_date_changed;
   protected boolean orf_org_id_changed;
   protected boolean orf_fil_id_changed;
   protected boolean orf_srv_id_changed;
   ...
   public NtisOrderFilesDAOGen(Double orf_id, Date orf_import_date, String orf_status, Date orf_status_date, Double orf_org_id, Double orf_fil_id, Double orf_srv_id, Double rec_version, Date rec_create_timestamp, String rec_userid, Date rec_timestamp, Double n01, Double n02, Double n03, Double n04, Double n05, String c01, String c02, String c03, String c04, String c05, Date d01, Date d02, Date d03, Date d04, Date d05, Double orf_usr_id) {
      ...
      this.d04 = d04;
      this.d05 = d05;
      this.orf_usr_id = orf_usr_id;
   }
   public void copyValues(NtisOrderFilesDAOGen obj) {
      this.setOrf_id(obj.getOrf_id());
      this.setOrf_import_date(obj.getOrf_import_date());
      this.setOrf_status(obj.getOrf_status());
      this.setOrf_status_date(obj.getOrf_status_date());
      this.setOrf_org_id(obj.getOrf_org_id());
      this.setOrf_fil_id(obj.getOrf_fil_id());
      this.setOrf_srv_id(obj.getOrf_srv_id());
      ...
      this.setOrf_usr_id(obj.getOrf_usr_id());
   }
   protected void markObjectAsInitial() {
      this.orf_id_changed = false;
      this.orf_import_date_changed = false;
      this.orf_status_changed = false;
      this.orf_status_date_changed = false;
      this.orf_org_id_changed = false;
      this.orf_fil_id_changed = false;
      this.orf_srv_id_changed = false;
      ...
      this.orf_usr_id_changed = false;
      this.record_changed = false;
   }
   public void setOrf_id(Double orf_id) {
      if (this.isForceUpdate() || (this.orf_id != null && !this.orf_id.equals(orf_id)) || (orf_id != null && !orf_id.equals(this.orf_id))){
         this.orf_id_changed = true; 
   ...
   public void setOrf_import_date(Date orf_import_date) {
      if (this.isForceUpdate() || (this.orf_import_date != null && !this.orf_import_date.equals(orf_import_date)) || (orf_import_date != null && !orf_import_date.equals(this.orf_import_date))){
         this.orf_import_date_changed = true; 
         this.record_changed = true;
         this.orf_import_date = orf_import_date;
      }
   }
   public Date getOrf_import_date() {
      return this.orf_import_date;
   }
   public void setOrf_status(String orf_status) {
      if (this.isForceUpdate() || (this.orf_status != null && !this.orf_status.equals(orf_status)) || (orf_status != null && !orf_status.equals(this.orf_status))){
         this.orf_status_changed = true; 
         this.record_changed = true;
         this.orf_status = orf_status;
      }
   }
   ...
   public void setOrf_status_date(Date orf_status_date) {
      if (this.isForceUpdate() || (this.orf_status_date != null && !this.orf_status_date.equals(orf_status_date)) || (orf_status_date != null && !orf_status_date.equals(this.orf_status_date))){
         this.orf_status_date_changed = true; 
         this.record_changed = true;
         this.orf_status_date = orf_status_date;
      }
   }
   public Date getOrf_status_date() {
      return this.orf_status_date;
   }
   public void setOrf_org_id(Double orf_org_id) {
      if (this.isForceUpdate() || (this.orf_org_id != null && !this.orf_org_id.equals(orf_org_id)) || (orf_org_id != null && !orf_org_id.equals(this.orf_org_id))){
         this.orf_org_id_changed = true; 
         this.record_changed = true;
         this.orf_org_id = orf_org_id;
      }
   }
   public Double getOrf_org_id() {
      return this.orf_org_id;
   }
   public void setOrf_fil_id(Double orf_fil_id) {
      if (this.isForceUpdate() || (this.orf_fil_id != null && !this.orf_fil_id.equals(orf_fil_id)) || (orf_fil_id != null && !orf_fil_id.equals(this.orf_fil_id))){
         this.orf_fil_id_changed = true; 
         this.record_changed = true;
         this.orf_fil_id = orf_fil_id;
      }
   }
   public Double getOrf_fil_id() {
      return this.orf_fil_id;
   }
   public void setOrf_srv_id(Double orf_srv_id) {
      if (this.isForceUpdate() || (this.orf_srv_id != null && !this.orf_srv_id.equals(orf_srv_id)) || (orf_srv_id != null && !orf_srv_id.equals(this.orf_srv_id))){
         this.orf_srv_id_changed = true; 
         this.record_changed = true;
         this.orf_srv_id = orf_srv_id;
      }
   }
   public Double getOrf_srv_id() {
      return this.orf_srv_id;
   }
   ...
   public void setOrf_usr_id(Double orf_usr_id) {
      if (this.isForceUpdate() || (this.orf_usr_id != null && !this.orf_usr_id.equals(orf_usr_id)) || (orf_usr_id != null && !orf_usr_id.equals(this.orf_usr_id))){
         this.orf_usr_id_changed = true; 
         this.record_changed = true;
         this.orf_usr_id = orf_usr_id;
      }
   }
   public Double getOrf_usr_id() {
      return this.orf_usr_id;
   }
    @JsonIgnore
    ...
    public void setRecordIdentifier(Object recIdentifier) {
        if (recIdentifier != null && !EMPTY_STRING.equals(recIdentifier)  && !"null".equalsIgnoreCase(recIdentifier.toString())){
            this.orf_id = (Double)recIdentifier;
        }
    }
    @JsonIgnore
    ...
    public void validateObject(int operation, SprBaseDBServiceImpl<?> baseService) throws SparkBusinessException{
      if (orf_import_date_changed || operation == Utils.OPERATION_INSERT) {
         if (orf_import_date== null) {
            throw new SparkBusinessException(new S2Message("NTIS_ORDER_FILES", "ORF_IMPORT_DATE", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }
      }
      if (orf_status_changed || operation == Utils.OPERATION_INSERT) {
         if (orf_status== null || EMPTY_STRING.equals(orf_status)) {
            throw new SparkBusinessException(new S2Message("NTIS_ORDER_FILES", "ORF_STATUS", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }else{
            if (orf_status!= null && orf_status.length()>50) {
               throw new SparkBusinessException(new S2Message("NTIS_ORDER_FILES", "ORF_STATUS", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"50"));
            }
         }
      }
      if (orf_status_date_changed || operation == Utils.OPERATION_INSERT) {
         if (orf_status_date== null) {
            throw new SparkBusinessException(new S2Message("NTIS_ORDER_FILES", "ORF_STATUS_DATE", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }
      }
      if (orf_org_id_changed || operation == Utils.OPERATION_INSERT) {
         if (orf_org_id== null) {
            throw new SparkBusinessException(new S2Message("NTIS_ORDER_FILES", "ORF_ORG_ID", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }else{
            if (orf_org_id!= null && (""+orf_org_id.intValue()).length()>10) {
               throw new SparkBusinessException(new S2Message("NTIS_ORDER_FILES", "ORF_ORG_ID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"10"));
            }
         }
      }
      if (orf_fil_id_changed || operation == Utils.OPERATION_INSERT) {
         if (orf_fil_id== null) {
            throw new SparkBusinessException(new S2Message("NTIS_ORDER_FILES", "ORF_FIL_ID", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }else{
            if (orf_fil_id!= null && (""+orf_fil_id.intValue()).length()>10) {
               throw new SparkBusinessException(new S2Message("NTIS_ORDER_FILES", "ORF_FIL_ID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"10"));
            }
         }
      }
      if (orf_srv_id_changed || operation == Utils.OPERATION_INSERT) {
         if (orf_srv_id== null) {
            throw new SparkBusinessException(new S2Message("NTIS_ORDER_FILES", "ORF_SRV_ID", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }else{
            if (orf_srv_id!= null && (""+orf_srv_id.intValue()).length()>10) {
               throw new SparkBusinessException(new S2Message("NTIS_ORDER_FILES", "ORF_SRV_ID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"10"));
            }
         }
      }
      if (rec_version_changed || operation == Utils.OPERATION_INSERT) {
         if (rec_version!= null && (""+rec_version.intValue()).length()>6) {
            throw new SparkBusinessException(new S2Message("NTIS_ORDER_FILES", "REC_VERSION", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"6"));
         }
      }
      if (rec_userid_changed || operation == Utils.OPERATION_INSERT) {
         if (rec_userid!= null && rec_userid.length()>128) {
            throw new SparkBusinessException(new S2Message("NTIS_ORDER_FILES", "REC_USERID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"128"));
         }
      }
      if (c01_changed || operation == Utils.OPERATION_INSERT) {
         if (c01!= null && c01.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_ORDER_FILES", "C01", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c02_changed || operation == Utils.OPERATION_INSERT) {
         if (c02!= null && c02.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_ORDER_FILES", "C02", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c03_changed || operation == Utils.OPERATION_INSERT) {
         if (c03!= null && c03.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_ORDER_FILES", "C03", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c04_changed || operation == Utils.OPERATION_INSERT) {
         if (c04!= null && c04.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_ORDER_FILES", "C04", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c05_changed || operation == Utils.OPERATION_INSERT) {
         if (c05!= null && c05.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_ORDER_FILES", "C05", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (orf_usr_id_changed || operation == Utils.OPERATION_INSERT) {
         if (orf_usr_id!= null && (""+orf_usr_id.intValue()).length()>10) {
            throw new SparkBusinessException(new S2Message("NTIS_ORDER_FILES", "ORF_USR_ID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"10"));
         }
      }
   }
   ...
   public UpdateStatementPart constructUpdatePart(String userName) {
      ...
      String answer = "UPDATE NTIS_ORDER_FILES SET ";
      boolean changedExists = false;      if (orf_import_date_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"ORF_IMPORT_DATE = ? ";
         changedExists = true;
         updateStatementPart.addStatementTimestampParam(orf_import_date);
      }
      if (orf_status_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"ORF_STATUS = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(orf_status);
      }
      if (orf_status_date_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"ORF_STATUS_DATE = ? ";
         changedExists = true;
         updateStatementPart.addStatementTimestampParam(orf_status_date);
      }
      if (orf_org_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"ORF_ORG_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(orf_org_id);
      }
      if (orf_fil_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"ORF_FIL_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(orf_fil_id);
      }
      if (orf_srv_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"ORF_SRV_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(orf_srv_id);
      }
      if (n01_changed) {
      ...
      if (orf_usr_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"ORF_USR_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(orf_usr_id);
      }
      ...
      answer = answer +" WHERE  ORF_ID = ? ";
      updateStatementPart.addStatementParam(orf_id);
      updateStatementPart.setStatementPart(answer);
      return updateStatementPart;
   }
   public String toString() {
      return "{\"NtisOrderFilesDAO\":{\"orf_id\": \""+getOrf_id()+"\", \"orf_import_date\": \""+getOrf_import_date()+"\", \"orf_status\": \""+getOrf_status()+"\", \"orf_status_date\": \""+getOrf_status_date()+"\", \"orf_org_id\": \""+getOrf_org_id()+"\", \"orf_fil_id\": \""+getOrf_fil_id()+"\", \"orf_srv_id\": \""+getOrf_srv_id()+"\", \"rec_version\": \""+getRec_version()+"\", \"rec_create_timestamp\": \""+getRec_create_timestamp()+"\", \"rec_userid\": \""+getRec_userid()+"\", \"rec_timestamp\": \""+getRec_timestamp()+"\", \"n01\": \""+getN01()+"\", \"n02\": \""+getN02()+"\", \"n03\": \""+getN03()+"\", \"n04\": \""+getN04()+"\", \"n05\": \""+getN05()+"\", \"c01\": \""+getC01()+"\", \"c02\": \""+getC02()+"\", \"c03\": \""+getC03()+"\", \"c04\": \""+getC04()+"\", \"c05\": \""+getC05()+"\", \"d01\": \""+getD01()+"\", \"d02\": \""+getD02()+"\", \"d03\": \""+getD03()+"\", \"d04\": \""+getD04()+"\", \"d05\": \""+getD05()+"\", \"orf_usr_id\": \""+getOrf_usr_id()+"\"}}";
   }

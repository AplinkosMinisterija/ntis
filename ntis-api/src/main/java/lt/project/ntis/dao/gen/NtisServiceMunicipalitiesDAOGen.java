...
public class NtisServiceMunicipalitiesDAOGen extends SprBaseDAO{
   public static String IDENTIFIER="NTIS_SERVICE_MUNICIPALITIES.SMN_ID";
   private Double smn_id;
   private String smn_municipality;
   private Date smn_date_from;
   private Date smn_date_to;
   private Double smn_srv_id;
   ...
   protected boolean smn_id_changed;
   protected boolean smn_municipality_changed;
   protected boolean smn_date_from_changed;
   protected boolean smn_date_to_changed;
   protected boolean smn_srv_id_changed;
   ...
   public NtisServiceMunicipalitiesDAOGen() {
      markObjectAsInitial();
      setRecordLoaded(false);
      setForceUpdate(false);
   }
   public NtisServiceMunicipalitiesDAOGen(Double smn_id, String smn_municipality, Date smn_date_from, Date smn_date_to, Double smn_srv_id, Double rec_version, Date rec_create_timestamp, String rec_userid, Date rec_timestamp, Double n01, Double n02, Double n03, Double n04, Double n05, String c01, String c02, String c03, String c04, String c05, Date d01, Date d02, Date d03, Date d04, Date d05) {
      this.smn_id = smn_id;
      this.smn_municipality = smn_municipality;
      this.smn_date_from = smn_date_from;
      this.smn_date_to = smn_date_to;
      this.smn_srv_id = smn_srv_id;
   ...
   public void copyValues(NtisServiceMunicipalitiesDAOGen obj) {
      this.setSmn_id(obj.getSmn_id());
      this.setSmn_municipality(obj.getSmn_municipality());
      this.setSmn_date_from(obj.getSmn_date_from());
      this.setSmn_date_to(obj.getSmn_date_to());
      this.setSmn_srv_id(obj.getSmn_srv_id());
   ...
   protected void markObjectAsInitial() {
      this.smn_id_changed = false;
      this.smn_municipality_changed = false;
      this.smn_date_from_changed = false;
      this.smn_date_to_changed = false;
      this.smn_srv_id_changed = false;
   ...
   public void setSmn_id(Double smn_id) {
      if (this.isForceUpdate() || (this.smn_id != null && !this.smn_id.equals(smn_id)) || (smn_id != null && !smn_id.equals(this.smn_id))){
         this.smn_id_changed = true; 
         this.record_changed = true;
         this.smn_id = smn_id;
      }
   }
   public Double getSmn_id() {
      return this.smn_id;
   }
   public void setSmn_municipality(String smn_municipality) {
      if (this.isForceUpdate() || (this.smn_municipality != null && !this.smn_municipality.equals(smn_municipality)) || (smn_municipality != null && !smn_municipality.equals(this.smn_municipality))){
         this.smn_municipality_changed = true; 
         this.record_changed = true;
         this.smn_municipality = smn_municipality;
      }
   }
   public String getSmn_municipality() {
      return this.smn_municipality;
   }
   public void setSmn_date_from(Date smn_date_from) {
      if (this.isForceUpdate() || (this.smn_date_from != null && !this.smn_date_from.equals(smn_date_from)) || (smn_date_from != null && !smn_date_from.equals(this.smn_date_from))){
         this.smn_date_from_changed = true; 
         this.record_changed = true;
         this.smn_date_from = smn_date_from;
      }
   }
   public Date getSmn_date_from() {
      return this.smn_date_from;
   }
   public void setSmn_date_to(Date smn_date_to) {
      if (this.isForceUpdate() || (this.smn_date_to != null && !this.smn_date_to.equals(smn_date_to)) || (smn_date_to != null && !smn_date_to.equals(this.smn_date_to))){
         this.smn_date_to_changed = true; 
         this.record_changed = true;
         this.smn_date_to = smn_date_to;
      }
   }
   public Date getSmn_date_to() {
      return this.smn_date_to;
   }
   public void setSmn_srv_id(Double smn_srv_id) {
      if (this.isForceUpdate() || (this.smn_srv_id != null && !this.smn_srv_id.equals(smn_srv_id)) || (smn_srv_id != null && !smn_srv_id.equals(this.smn_srv_id))){
         this.smn_srv_id_changed = true; 
         this.record_changed = true;
         this.smn_srv_id = smn_srv_id;
      }
   }
   public Double getSmn_srv_id() {
      return this.smn_srv_id;
   }
   ...
   public Date getD05() {
    ...
    public void setRecordIdentifier(Object recIdentifier) {
        if (recIdentifier != null && !EMPTY_STRING.equals(recIdentifier)  && !"null".equalsIgnoreCase(recIdentifier.toString())){
            this.smn_id = (Double)recIdentifier;
        }
    }
    @JsonIgnore
    ...
    public void validateObject(int operation, SprBaseDBServiceImpl<?> baseService) throws SparkBusinessException{
      if (smn_municipality_changed || operation == Utils.OPERATION_INSERT) {
         if (smn_municipality== null || EMPTY_STRING.equals(smn_municipality)) {
            throw new SparkBusinessException(new S2Message("NTIS_SERVICE_MUNICIPALITIES", "SMN_MUNICIPALITY", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }else{
            if (smn_municipality!= null && smn_municipality.length()>50) {
               throw new SparkBusinessException(new S2Message("NTIS_SERVICE_MUNICIPALITIES", "SMN_MUNICIPALITY", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"50"));
            }
         }
      }
      if (smn_srv_id_changed || operation == Utils.OPERATION_INSERT) {
         if (smn_srv_id!= null && (""+smn_srv_id.intValue()).length()>10) {
            throw new SparkBusinessException(new S2Message("NTIS_SERVICE_MUNICIPALITIES", "SMN_SRV_ID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"10"));
         }
      }
      if (rec_version_changed || operation == Utils.OPERATION_INSERT) {
         if (rec_version!= null && (""+rec_version.intValue()).length()>6) {
            throw new SparkBusinessException(new S2Message("NTIS_SERVICE_MUNICIPALITIES", "REC_VERSION", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"6"));
         }
      }
      if (rec_userid_changed || operation == Utils.OPERATION_INSERT) {
         if (rec_userid!= null && rec_userid.length()>128) {
            throw new SparkBusinessException(new S2Message("NTIS_SERVICE_MUNICIPALITIES", "REC_USERID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"128"));
         }
      }
      if (c01_changed || operation == Utils.OPERATION_INSERT) {
         if (c01!= null && c01.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_SERVICE_MUNICIPALITIES", "C01", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c02_changed || operation == Utils.OPERATION_INSERT) {
         if (c02!= null && c02.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_SERVICE_MUNICIPALITIES", "C02", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c03_changed || operation == Utils.OPERATION_INSERT) {
         if (c03!= null && c03.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_SERVICE_MUNICIPALITIES", "C03", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c04_changed || operation == Utils.OPERATION_INSERT) {
         if (c04!= null && c04.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_SERVICE_MUNICIPALITIES", "C04", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c05_changed || operation == Utils.OPERATION_INSERT) {
         if (c05!= null && c05.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_SERVICE_MUNICIPALITIES", "C05", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
   }
   ...
   public UpdateStatementPart constructUpdatePart(String userName) {
      ...
      String answer = "UPDATE NTIS_SERVICE_MUNICIPALITIES SET ";
      boolean changedExists = false;      if (smn_municipality_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"SMN_MUNICIPALITY = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(smn_municipality);
      }
      if (smn_date_from_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"SMN_DATE_FROM = ? ";
         changedExists = true;
         updateStatementPart.addStatementTimestampParam(smn_date_from);
      }
      if (smn_date_to_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"SMN_DATE_TO = ? ";
         changedExists = true;
         updateStatementPart.addStatementTimestampParam(smn_date_to);
      }
      if (smn_srv_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"SMN_SRV_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(smn_srv_id);
      }
      if (n01_changed) {
      ...
      answer = answer +" WHERE  SMN_ID = ? ";
      updateStatementPart.addStatementParam(smn_id);
      updateStatementPart.setStatementPart(answer);
      return updateStatementPart;
   }
   public String toString() {
      return "{\"NtisServiceMunicipalitiesDAO\":{\"smn_id\": \""+getSmn_id()+"\", \"smn_municipality\": \""+getSmn_municipality()+"\", \"smn_date_from\": \""+getSmn_date_from()+"\", \"smn_date_to\": \""+getSmn_date_to()+"\", \"smn_srv_id\": \""+getSmn_srv_id()+"\", \"rec_version\": \""+getRec_version()+"\", \"rec_create_timestamp\": \""+getRec_create_timestamp()+"\", \"rec_userid\": \""+getRec_userid()+"\", \"rec_timestamp\": \""+getRec_timestamp()+"\", \"n01\": \""+getN01()+"\", \"n02\": \""+getN02()+"\", \"n03\": \""+getN03()+"\", \"n04\": \""+getN04()+"\", \"n05\": \""+getN05()+"\", \"c01\": \""+getC01()+"\", \"c02\": \""+getC02()+"\", \"c03\": \""+getC03()+"\", \"c04\": \""+getC04()+"\", \"c05\": \""+getC05()+"\", \"d01\": \""+getD01()+"\", \"d02\": \""+getD02()+"\", \"d03\": \""+getD03()+"\", \"d04\": \""+getD04()+"\", \"d05\": \""+getD05()+"\"}}";
   }

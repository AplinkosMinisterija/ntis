...
public class NtisServiceReqStatusLogsDAOGen extends SprBaseDAO{
   public static String IDENTIFIER="NTIS_SERVICE_REQ_STATUS_LOGS.SRS_ID";
   private Double srs_id;
   private String srs_status;
   private Date srs_status_date;
   private Double srs_sr_id;
   private Double srs_sri_id;
   ...
   protected boolean srs_id_changed;
   protected boolean srs_status_changed;
   protected boolean srs_status_date_changed;
   protected boolean srs_sr_id_changed;
   protected boolean srs_sri_id_changed;
   ...
   public NtisServiceReqStatusLogsDAOGen() {
      markObjectAsInitial();
      setRecordLoaded(false);
      setForceUpdate(false);
   }
   public NtisServiceReqStatusLogsDAOGen(Double srs_id, String srs_status, Date srs_status_date, Double srs_sr_id, Double srs_sri_id, Double rec_version, Date rec_create_timestamp, String rec_userid, Date rec_timestamp, Double n01, Double n02, Double n03, Double n04, Double n05, String c01, String c02, String c03, String c04, String c05, Date d01, Date d02, Date d03, Date d04, Date d05) {
      this.srs_id = srs_id;
      this.srs_status = srs_status;
      this.srs_status_date = srs_status_date;
      this.srs_sr_id = srs_sr_id;
      this.srs_sri_id = srs_sri_id;
   ...
   public void copyValues(NtisServiceReqStatusLogsDAOGen obj) {
      this.setSrs_id(obj.getSrs_id());
      this.setSrs_status(obj.getSrs_status());
      this.setSrs_status_date(obj.getSrs_status_date());
      this.setSrs_sr_id(obj.getSrs_sr_id());
      this.setSrs_sri_id(obj.getSrs_sri_id());
   ...
   protected void markObjectAsInitial() {
      this.srs_id_changed = false;
      this.srs_status_changed = false;
      this.srs_status_date_changed = false;
      this.srs_sr_id_changed = false;
      this.srs_sri_id_changed = false;
   ...
   public void setSrs_id(Double srs_id) {
      if (this.isForceUpdate() || (this.srs_id != null && !this.srs_id.equals(srs_id)) || (srs_id != null && !srs_id.equals(this.srs_id))){
         this.srs_id_changed = true; 
         this.record_changed = true;
         this.srs_id = srs_id;
      }
   }
   public Double getSrs_id() {
      return this.srs_id;
   }
   public void setSrs_status(String srs_status) {
      if (this.isForceUpdate() || (this.srs_status != null && !this.srs_status.equals(srs_status)) || (srs_status != null && !srs_status.equals(this.srs_status))){
         this.srs_status_changed = true; 
         this.record_changed = true;
         this.srs_status = srs_status;
      }
   }
   public String getSrs_status() {
      return this.srs_status;
   }
   public void setSrs_status_date(Date srs_status_date) {
      if (this.isForceUpdate() || (this.srs_status_date != null && !this.srs_status_date.equals(srs_status_date)) || (srs_status_date != null && !srs_status_date.equals(this.srs_status_date))){
         this.srs_status_date_changed = true; 
         this.record_changed = true;
         this.srs_status_date = srs_status_date;
      }
   }
   public Date getSrs_status_date() {
      return this.srs_status_date;
   }
   public void setSrs_sr_id(Double srs_sr_id) {
      if (this.isForceUpdate() || (this.srs_sr_id != null && !this.srs_sr_id.equals(srs_sr_id)) || (srs_sr_id != null && !srs_sr_id.equals(this.srs_sr_id))){
         this.srs_sr_id_changed = true; 
         this.record_changed = true;
         this.srs_sr_id = srs_sr_id;
      }
   }
   public Double getSrs_sr_id() {
      return this.srs_sr_id;
   }
   public void setSrs_sri_id(Double srs_sri_id) {
      if (this.isForceUpdate() || (this.srs_sri_id != null && !this.srs_sri_id.equals(srs_sri_id)) || (srs_sri_id != null && !srs_sri_id.equals(this.srs_sri_id))){
         this.srs_sri_id_changed = true; 
         this.record_changed = true;
         this.srs_sri_id = srs_sri_id;
      }
   }
   public Double getSrs_sri_id() {
      return this.srs_sri_id;
   }
   ...
   public Date getD05() {
    ...
    public void setRecordIdentifier(Object recIdentifier) {
        if (recIdentifier != null && !EMPTY_STRING.equals(recIdentifier)  && !"null".equalsIgnoreCase(recIdentifier.toString())){
            this.srs_id = (Double)recIdentifier;
        }
    }
    @JsonIgnore
    ...
    public void validateObject(int operation, SprBaseDBServiceImpl<?> baseService) throws SparkBusinessException{
      if (srs_status_changed || operation == Utils.OPERATION_INSERT) {
         if (srs_status== null || EMPTY_STRING.equals(srs_status)) {
            throw new SparkBusinessException(new S2Message("NTIS_SERVICE_REQ_STATUS_LOGS", "SRS_STATUS", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }else{
            if (srs_status!= null && srs_status.length()>50) {
               throw new SparkBusinessException(new S2Message("NTIS_SERVICE_REQ_STATUS_LOGS", "SRS_STATUS", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"50"));
            }
         }
      }
      if (srs_status_date_changed || operation == Utils.OPERATION_INSERT) {
         if (srs_status_date== null) {
            throw new SparkBusinessException(new S2Message("NTIS_SERVICE_REQ_STATUS_LOGS", "SRS_STATUS_DATE", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }
      }
      if (srs_sr_id_changed || operation == Utils.OPERATION_INSERT) {
         if (srs_sr_id!= null && (""+srs_sr_id.intValue()).length()>10) {
            throw new SparkBusinessException(new S2Message("NTIS_SERVICE_REQ_STATUS_LOGS", "SRS_SR_ID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"10"));
         }
      }
      if (srs_sri_id_changed || operation == Utils.OPERATION_INSERT) {
         if (srs_sri_id!= null && (""+srs_sri_id.intValue()).length()>10) {
            throw new SparkBusinessException(new S2Message("NTIS_SERVICE_REQ_STATUS_LOGS", "SRS_SRI_ID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"10"));
         }
      }
      if (rec_version_changed || operation == Utils.OPERATION_INSERT) {
         if (rec_version!= null && (""+rec_version.intValue()).length()>6) {
            throw new SparkBusinessException(new S2Message("NTIS_SERVICE_REQ_STATUS_LOGS", "REC_VERSION", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"6"));
         }
      }
      if (rec_userid_changed || operation == Utils.OPERATION_INSERT) {
         if (rec_userid!= null && rec_userid.length()>128) {
            throw new SparkBusinessException(new S2Message("NTIS_SERVICE_REQ_STATUS_LOGS", "REC_USERID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"128"));
         }
      }
      if (c01_changed || operation == Utils.OPERATION_INSERT) {
         if (c01!= null && c01.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_SERVICE_REQ_STATUS_LOGS", "C01", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c02_changed || operation == Utils.OPERATION_INSERT) {
         if (c02!= null && c02.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_SERVICE_REQ_STATUS_LOGS", "C02", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c03_changed || operation == Utils.OPERATION_INSERT) {
         if (c03!= null && c03.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_SERVICE_REQ_STATUS_LOGS", "C03", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c04_changed || operation == Utils.OPERATION_INSERT) {
         if (c04!= null && c04.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_SERVICE_REQ_STATUS_LOGS", "C04", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c05_changed || operation == Utils.OPERATION_INSERT) {
         if (c05!= null && c05.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_SERVICE_REQ_STATUS_LOGS", "C05", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
   }
   ...
   public UpdateStatementPart constructUpdatePart(String userName) {
      ...
      String answer = "UPDATE NTIS_SERVICE_REQ_STATUS_LOGS SET ";
      boolean changedExists = false;      if (srs_status_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"SRS_STATUS = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(srs_status);
      }
      if (srs_status_date_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"SRS_STATUS_DATE = ? ";
         changedExists = true;
         updateStatementPart.addStatementTimestampParam(srs_status_date);
      }
      if (srs_sr_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"SRS_SR_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(srs_sr_id);
      }
      if (srs_sri_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"SRS_SRI_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(srs_sri_id);
      }
      if (n01_changed) {
      ...
      answer = answer +" WHERE  SRS_ID = ? ";
      updateStatementPart.addStatementParam(srs_id);
      updateStatementPart.setStatementPart(answer);
      return updateStatementPart;
   }
   public String toString() {
      return "{\"NtisServiceReqStatusLogsDAO\":{\"srs_id\": \""+getSrs_id()+"\", \"srs_status\": \""+getSrs_status()+"\", \"srs_status_date\": \""+getSrs_status_date()+"\", \"srs_sr_id\": \""+getSrs_sr_id()+"\", \"srs_sri_id\": \""+getSrs_sri_id()+"\", \"rec_version\": \""+getRec_version()+"\", \"rec_create_timestamp\": \""+getRec_create_timestamp()+"\", \"rec_userid\": \""+getRec_userid()+"\", \"rec_timestamp\": \""+getRec_timestamp()+"\", \"n01\": \""+getN01()+"\", \"n02\": \""+getN02()+"\", \"n03\": \""+getN03()+"\", \"n04\": \""+getN04()+"\", \"n05\": \""+getN05()+"\", \"c01\": \""+getC01()+"\", \"c02\": \""+getC02()+"\", \"c03\": \""+getC03()+"\", \"c04\": \""+getC04()+"\", \"c05\": \""+getC05()+"\", \"d01\": \""+getD01()+"\", \"d02\": \""+getD02()+"\", \"d03\": \""+getD03()+"\", \"d04\": \""+getD04()+"\", \"d05\": \""+getD05()+"\"}}";
   }

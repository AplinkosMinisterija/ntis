...
public class NtisCwFilesDAOGen extends SprBaseDAO{
   public static String IDENTIFIER="NTIS_CW_FILES.CWF_ID";
   private Double cwf_id;
   private Date cwf_import_date;
   private String cwf_status;
   private Date cwf_status_date;
   private Double cwf_org_id;
   private Double cwf_fil_id;
   ...
   private Date d04;
   private Date d05;
   private Double cwf_usr_id;

   protected boolean cwf_id_changed;
   protected boolean cwf_import_date_changed;
   protected boolean cwf_status_changed;
   protected boolean cwf_status_date_changed;
   protected boolean cwf_org_id_changed;
   protected boolean cwf_fil_id_changed;
   ...
   public NtisCwFilesDAOGen(Double cwf_id, Date cwf_import_date, String cwf_status, Date cwf_status_date, Double cwf_org_id, Double cwf_fil_id, Double rec_version, Date rec_create_timestamp, String rec_userid, Date rec_timestamp, Double n01, Double n02, Double n03, Double n04, Double n05, String c01, String c02, String c03, String c04, String c05, Date d01, Date d02, Date d03, Date d04, Date d05, Double cwf_usr_id) {
      ...
      this.d04 = d04;
      this.d05 = d05;
      this.cwf_usr_id = cwf_usr_id;
   }
   public void copyValues(NtisCwFilesDAOGen obj) {
      this.setCwf_id(obj.getCwf_id());
      this.setCwf_import_date(obj.getCwf_import_date());
      this.setCwf_status(obj.getCwf_status());
      this.setCwf_status_date(obj.getCwf_status_date());
      this.setCwf_org_id(obj.getCwf_org_id());
      this.setCwf_fil_id(obj.getCwf_fil_id());
      ...
      this.setCwf_usr_id(obj.getCwf_usr_id());
   }
   protected void markObjectAsInitial() {
      this.cwf_id_changed = false;
      this.cwf_import_date_changed = false;
      this.cwf_status_changed = false;
      this.cwf_status_date_changed = false;
      this.cwf_org_id_changed = false;
      this.cwf_fil_id_changed = false;
      ...
      this.cwf_usr_id_changed = false;
      this.record_changed = false;
   }
   public void setCwf_id(Double cwf_id) {
      if (this.isForceUpdate() || (this.cwf_id != null && !this.cwf_id.equals(cwf_id)) || (cwf_id != null && !cwf_id.equals(this.cwf_id))){
         this.cwf_id_changed = true; 
   ...
   public void setCwf_import_date(Date cwf_import_date) {
      if (this.isForceUpdate() || (this.cwf_import_date != null && !this.cwf_import_date.equals(cwf_import_date)) || (cwf_import_date != null && !cwf_import_date.equals(this.cwf_import_date))){
         this.cwf_import_date_changed = true; 
         this.record_changed = true;
         this.cwf_import_date = cwf_import_date;
      }
   }
   public Date getCwf_import_date() {
      return this.cwf_import_date;
   }
   public void setCwf_status(String cwf_status) {
      if (this.isForceUpdate() || (this.cwf_status != null && !this.cwf_status.equals(cwf_status)) || (cwf_status != null && !cwf_status.equals(this.cwf_status))){
         this.cwf_status_changed = true; 
         this.record_changed = true;
         this.cwf_status = cwf_status;
      }
   }
   public String getCwf_status() {
      return this.cwf_status;
   }
   public void setCwf_status_date(Date cwf_status_date) {
      if (this.isForceUpdate() || (this.cwf_status_date != null && !this.cwf_status_date.equals(cwf_status_date)) || (cwf_status_date != null && !cwf_status_date.equals(this.cwf_status_date))){
         this.cwf_status_date_changed = true; 
         this.record_changed = true;
         this.cwf_status_date = cwf_status_date;
      }
   }
   public Date getCwf_status_date() {
      return this.cwf_status_date;
   }
   public void setCwf_org_id(Double cwf_org_id) {
      if (this.isForceUpdate() || (this.cwf_org_id != null && !this.cwf_org_id.equals(cwf_org_id)) || (cwf_org_id != null && !cwf_org_id.equals(this.cwf_org_id))){
         this.cwf_org_id_changed = true; 
         this.record_changed = true;
         this.cwf_org_id = cwf_org_id;
      }
   }
   public Double getCwf_org_id() {
      return this.cwf_org_id;
   }
   public void setCwf_fil_id(Double cwf_fil_id) {
      if (this.isForceUpdate() || (this.cwf_fil_id != null && !this.cwf_fil_id.equals(cwf_fil_id)) || (cwf_fil_id != null && !cwf_fil_id.equals(this.cwf_fil_id))){
         this.cwf_fil_id_changed = true; 
         this.record_changed = true;
         this.cwf_fil_id = cwf_fil_id;
      }
   }
   public Double getCwf_fil_id() {
      return this.cwf_fil_id;
   }
   ...
   public void setCwf_usr_id(Double cwf_usr_id) {
      if (this.isForceUpdate() || (this.cwf_usr_id != null && !this.cwf_usr_id.equals(cwf_usr_id)) || (cwf_usr_id != null && !cwf_usr_id.equals(this.cwf_usr_id))){
         this.cwf_usr_id_changed = true; 
         this.record_changed = true;
         this.cwf_usr_id = cwf_usr_id;
      }
   }
   public Double getCwf_usr_id() {
      return this.cwf_usr_id;
   }
    @JsonIgnore
    ...
    public void setRecordIdentifier(Object recIdentifier) {
        if (recIdentifier != null && !EMPTY_STRING.equals(recIdentifier)  && !"null".equalsIgnoreCase(recIdentifier.toString())){
            this.cwf_id = (Double)recIdentifier;
        }
    }
    @JsonIgnore
    ...
    public void validateObject(int operation, SprBaseDBServiceImpl<?> baseService) throws SparkBusinessException{
      if (cwf_import_date_changed || operation == Utils.OPERATION_INSERT) {
         if (cwf_import_date== null) {
            throw new SparkBusinessException(new S2Message("NTIS_CW_FILES", "CWF_IMPORT_DATE", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }
      }
      if (cwf_status_changed || operation == Utils.OPERATION_INSERT) {
         if (cwf_status== null || EMPTY_STRING.equals(cwf_status)) {
            throw new SparkBusinessException(new S2Message("NTIS_CW_FILES", "CWF_STATUS", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }else{
            if (cwf_status!= null && cwf_status.length()>50) {
               throw new SparkBusinessException(new S2Message("NTIS_CW_FILES", "CWF_STATUS", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"50"));
            }
         }
      }
      if (cwf_status_date_changed || operation == Utils.OPERATION_INSERT) {
         if (cwf_status_date== null) {
            throw new SparkBusinessException(new S2Message("NTIS_CW_FILES", "CWF_STATUS_DATE", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }
      }
      if (cwf_org_id_changed || operation == Utils.OPERATION_INSERT) {
         if (cwf_org_id== null) {
            throw new SparkBusinessException(new S2Message("NTIS_CW_FILES", "CWF_ORG_ID", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }else{
            if (cwf_org_id!= null && (""+cwf_org_id.intValue()).length()>10) {
               throw new SparkBusinessException(new S2Message("NTIS_CW_FILES", "CWF_ORG_ID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"10"));
            }
         }
      }
      if (cwf_fil_id_changed || operation == Utils.OPERATION_INSERT) {
         if (cwf_fil_id!= null && (""+cwf_fil_id.intValue()).length()>10) {
            throw new SparkBusinessException(new S2Message("NTIS_CW_FILES", "CWF_FIL_ID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"10"));
         }
      }
      if (rec_version_changed || operation == Utils.OPERATION_INSERT) {
         if (rec_version!= null && (""+rec_version.intValue()).length()>6) {
            throw new SparkBusinessException(new S2Message("NTIS_CW_FILES", "REC_VERSION", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"6"));
         }
      }
      if (rec_userid_changed || operation == Utils.OPERATION_INSERT) {
         if (rec_userid!= null && rec_userid.length()>128) {
            throw new SparkBusinessException(new S2Message("NTIS_CW_FILES", "REC_USERID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"128"));
         }
      }
      if (c01_changed || operation == Utils.OPERATION_INSERT) {
         if (c01!= null && c01.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_CW_FILES", "C01", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c02_changed || operation == Utils.OPERATION_INSERT) {
         if (c02!= null && c02.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_CW_FILES", "C02", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c03_changed || operation == Utils.OPERATION_INSERT) {
         if (c03!= null && c03.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_CW_FILES", "C03", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c04_changed || operation == Utils.OPERATION_INSERT) {
         if (c04!= null && c04.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_CW_FILES", "C04", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c05_changed || operation == Utils.OPERATION_INSERT) {
         if (c05!= null && c05.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_CW_FILES", "C05", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (cwf_usr_id_changed || operation == Utils.OPERATION_INSERT) {
         if (cwf_usr_id!= null && (""+cwf_usr_id.intValue()).length()>10) {
            throw new SparkBusinessException(new S2Message("NTIS_CW_FILES", "CWF_USR_ID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"10"));
         }
      }
   }
   ...
   public UpdateStatementPart constructUpdatePart(String userName) {
      ...
      String answer = "UPDATE NTIS_CW_FILES SET ";
      boolean changedExists = false;      if (cwf_import_date_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"CWF_IMPORT_DATE = ? ";
         changedExists = true;
         updateStatementPart.addStatementTimestampParam(cwf_import_date);
      }
      if (cwf_status_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"CWF_STATUS = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(cwf_status);
      }
      if (cwf_status_date_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"CWF_STATUS_DATE = ? ";
         changedExists = true;
         updateStatementPart.addStatementTimestampParam(cwf_status_date);
      }
      if (cwf_org_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"CWF_ORG_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(cwf_org_id);
      }
      if (cwf_fil_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"CWF_FIL_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(cwf_fil_id);
      }
      if (n01_changed) {
      ...
      if (cwf_usr_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"CWF_USR_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(cwf_usr_id);
      }
      ...
      answer = answer +" WHERE  CWF_ID = ? ";
      updateStatementPart.addStatementParam(cwf_id);
      updateStatementPart.setStatementPart(answer);
      return updateStatementPart;
   }
   public String toString() {
      return "{\"NtisCwFilesDAO\":{\"cwf_id\": \""+getCwf_id()+"\", \"cwf_import_date\": \""+getCwf_import_date()+"\", \"cwf_status\": \""+getCwf_status()+"\", \"cwf_status_date\": \""+getCwf_status_date()+"\", \"cwf_org_id\": \""+getCwf_org_id()+"\", \"cwf_fil_id\": \""+getCwf_fil_id()+"\", \"rec_version\": \""+getRec_version()+"\", \"rec_create_timestamp\": \""+getRec_create_timestamp()+"\", \"rec_userid\": \""+getRec_userid()+"\", \"rec_timestamp\": \""+getRec_timestamp()+"\", \"n01\": \""+getN01()+"\", \"n02\": \""+getN02()+"\", \"n03\": \""+getN03()+"\", \"n04\": \""+getN04()+"\", \"n05\": \""+getN05()+"\", \"c01\": \""+getC01()+"\", \"c02\": \""+getC02()+"\", \"c03\": \""+getC03()+"\", \"c04\": \""+getC04()+"\", \"c05\": \""+getC05()+"\", \"d01\": \""+getD01()+"\", \"d02\": \""+getD02()+"\", \"d03\": \""+getD03()+"\", \"d04\": \""+getD04()+"\", \"d05\": \""+getD05()+"\", \"cwf_usr_id\": \""+getCwf_usr_id()+"\"}}";
   }

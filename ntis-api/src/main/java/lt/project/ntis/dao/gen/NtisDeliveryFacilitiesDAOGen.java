...
public class NtisDeliveryFacilitiesDAOGen extends SprBaseDAO{
   public static String IDENTIFIER="NTIS_DELIVERY_FACILITIES.DF_ID";
   private Double df_id;
   private Double df_delivery_sludge_quentity;
   private Double df_wtf_id;
   private Double df_ord_id;
   private Double df_wd_id;
   ...
   private Date d04;
   private Date d05;
   private Date df_removed_date;

   protected boolean df_id_changed;
   protected boolean df_delivery_sludge_quentity_changed;
   protected boolean df_wtf_id_changed;
   protected boolean df_ord_id_changed;
   protected boolean df_wd_id_changed;
   ...
   public NtisDeliveryFacilitiesDAOGen(Double df_id, Double df_delivery_sludge_quentity, Double df_wtf_id, Double df_ord_id, Double df_wd_id, Double rec_version, Date rec_create_timestamp, String rec_userid, Date rec_timestamp, Double n01, Double n02, Double n03, Double n04, Double n05, String c01, String c02, String c03, String c04, String c05, Date d01, Date d02, Date d03, Date d04, Date d05, Date df_removed_date) {
      ...
      this.d04 = d04;
      this.d05 = d05;
      this.df_removed_date = df_removed_date;
   }
   public void copyValues(NtisDeliveryFacilitiesDAOGen obj) {
      this.setDf_id(obj.getDf_id());
      this.setDf_delivery_sludge_quentity(obj.getDf_delivery_sludge_quentity());
      this.setDf_wtf_id(obj.getDf_wtf_id());
      this.setDf_ord_id(obj.getDf_ord_id());
      this.setDf_wd_id(obj.getDf_wd_id());
      ...
      this.setDf_removed_date(obj.getDf_removed_date());
   }
   protected void markObjectAsInitial() {
      this.df_id_changed = false;
      this.df_delivery_sludge_quentity_changed = false;
      this.df_wtf_id_changed = false;
      this.df_ord_id_changed = false;
      this.df_wd_id_changed = false;
      ...
      this.df_removed_date_changed = false;
      this.record_changed = false;
   }
   public void setDf_id(Double df_id) {
      if (this.isForceUpdate() || 
               (this.df_id != null && !this.df_id.equals(df_id))  ||
               (df_id != null && !df_id.equals(this.df_id)) ){
         this.df_id_changed = true; 
         this.record_changed = true;
         this.df_id = df_id;
      }
   }
   public Double getDf_id() {
      return this.df_id;
   }
   public void setDf_delivery_sludge_quentity(Double df_delivery_sludge_quentity) {
      if (this.isForceUpdate() || 
               (this.df_delivery_sludge_quentity != null && !this.df_delivery_sludge_quentity.equals(df_delivery_sludge_quentity))  ||
               (df_delivery_sludge_quentity != null && !df_delivery_sludge_quentity.equals(this.df_delivery_sludge_quentity)) ){
         this.df_delivery_sludge_quentity_changed = true; 
         this.record_changed = true;
         this.df_delivery_sludge_quentity = df_delivery_sludge_quentity;
      }
   }
   public Double getDf_delivery_sludge_quentity() {
      return this.df_delivery_sludge_quentity;
   }
   public void setDf_wtf_id(Double df_wtf_id) {
      if (this.isForceUpdate() || 
               (this.df_wtf_id != null && !this.df_wtf_id.equals(df_wtf_id))  ||
               (df_wtf_id != null && !df_wtf_id.equals(this.df_wtf_id)) ){
         this.df_wtf_id_changed = true; 
         this.record_changed = true;
         this.df_wtf_id = df_wtf_id;
      }
   }
   public Double getDf_wtf_id() {
      return this.df_wtf_id;
   }
   public void setDf_ord_id(Double df_ord_id) {
      if (this.isForceUpdate() || 
               (this.df_ord_id != null && !this.df_ord_id.equals(df_ord_id))  ||
               (df_ord_id != null && !df_ord_id.equals(this.df_ord_id)) ){
         this.df_ord_id_changed = true; 
         this.record_changed = true;
         this.df_ord_id = df_ord_id;
      }
   }
   public Double getDf_ord_id() {
      return this.df_ord_id;
   }
   public void setDf_wd_id(Double df_wd_id) {
      if (this.isForceUpdate() || 
               (this.df_wd_id != null && !this.df_wd_id.equals(df_wd_id))  ||
               (df_wd_id != null && !df_wd_id.equals(this.df_wd_id)) ){
         this.df_wd_id_changed = true; 
         this.record_changed = true;
         this.df_wd_id = df_wd_id;
      }
   }
   public Double getDf_wd_id() {
      return this.df_wd_id;
   }
   ...
   public void setDf_removed_date(Date df_removed_date) {
      if (this.isForceUpdate() || 
               (this.df_removed_date != null && (df_removed_date == null ||this.df_removed_date.compareTo(df_removed_date) != 0 )) ||
               (df_removed_date != null && (this.df_removed_date == null ||df_removed_date.compareTo(this.df_removed_date) != 0 ))){
         this.df_removed_date_changed = true; 
         this.record_changed = true;
         this.df_removed_date = df_removed_date;
      }
   }
   public Date getDf_removed_date() {
      return this.df_removed_date;
   }
    @JsonIgnore
    ...
    public void setRecordIdentifier(Object recIdentifier) {
        if (recIdentifier != null && !EMPTY_STRING.equals(recIdentifier)  && !"null".equalsIgnoreCase(recIdentifier.toString())){
            this.df_id = (Double)recIdentifier;
        }
    }
    @JsonIgnore
    ...
    public void validateObject(int operation, SprBaseDBServiceImpl<?> baseService) throws SparkBusinessException{
      if (df_wtf_id_changed || operation == Utils.OPERATION_INSERT) {
         if (df_wtf_id!= null && (""+df_wtf_id.intValue()).length()>10) {
            throw new SparkBusinessException(new S2Message("NTIS_DELIVERY_FACILITIES", "DF_WTF_ID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"10"));
         }
      }
      if (df_ord_id_changed || operation == Utils.OPERATION_INSERT) {
         if (df_ord_id!= null && (""+df_ord_id.intValue()).length()>10) {
            throw new SparkBusinessException(new S2Message("NTIS_DELIVERY_FACILITIES", "DF_ORD_ID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"10"));
         }
      }
      if (df_wd_id_changed || operation == Utils.OPERATION_INSERT) {
         if (df_wd_id!= null && (""+df_wd_id.intValue()).length()>10) {
            throw new SparkBusinessException(new S2Message("NTIS_DELIVERY_FACILITIES", "DF_WD_ID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"10"));
         }
      }
      if (rec_version_changed || operation == Utils.OPERATION_INSERT) {
         if (rec_version!= null && (""+rec_version.intValue()).length()>6) {
            throw new SparkBusinessException(new S2Message("NTIS_DELIVERY_FACILITIES", "REC_VERSION", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"6"));
         }
      }
      if (rec_userid_changed || operation == Utils.OPERATION_INSERT) {
         if (rec_userid!= null && rec_userid.length()>128) {
            throw new SparkBusinessException(new S2Message("NTIS_DELIVERY_FACILITIES", "REC_USERID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"128"));
         }
      }
      if (c01_changed || operation == Utils.OPERATION_INSERT) {
         if (c01!= null && c01.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_DELIVERY_FACILITIES", "C01", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c02_changed || operation == Utils.OPERATION_INSERT) {
         if (c02!= null && c02.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_DELIVERY_FACILITIES", "C02", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c03_changed || operation == Utils.OPERATION_INSERT) {
         if (c03!= null && c03.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_DELIVERY_FACILITIES", "C03", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c04_changed || operation == Utils.OPERATION_INSERT) {
         if (c04!= null && c04.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_DELIVERY_FACILITIES", "C04", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c05_changed || operation == Utils.OPERATION_INSERT) {
         if (c05!= null && c05.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_DELIVERY_FACILITIES", "C05", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
   }
   ...
   public UpdateStatementPart constructUpdatePart(String userName) {
      ...
      String answer = "UPDATE NTIS_DELIVERY_FACILITIES SET ";
      boolean changedExists = false;      if (df_delivery_sludge_quentity_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"DF_DELIVERY_SLUDGE_QUENTITY = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(df_delivery_sludge_quentity);
      }
      if (df_wtf_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"DF_WTF_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(df_wtf_id);
      }
      if (df_ord_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"DF_ORD_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(df_ord_id);
      }
      if (df_wd_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"DF_WD_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(df_wd_id);
      }
      if (n01_changed) {
      ...
      if (df_removed_date_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"DF_REMOVED_DATE = ? ";
         changedExists = true;
         updateStatementPart.addStatementTimestampParam(df_removed_date);
      }
      ...
      answer = answer +" WHERE  DF_ID = ? ";
      updateStatementPart.addStatementParam(df_id);
      updateStatementPart.setStatementPart(answer);
      return updateStatementPart;
   }
   public String toString() {
      return "{\"NtisDeliveryFacilitiesDAO\":{\"df_id\": \""+getDf_id()+"\", \"df_delivery_sludge_quentity\": \""+getDf_delivery_sludge_quentity()+"\", \"df_wtf_id\": \""+getDf_wtf_id()+"\", \"df_ord_id\": \""+getDf_ord_id()+"\", \"df_wd_id\": \""+getDf_wd_id()+"\", \"rec_version\": \""+getRec_version()+"\", \"rec_create_timestamp\": \""+getRec_create_timestamp()+"\", \"rec_userid\": \""+getRec_userid()+"\", \"rec_timestamp\": \""+getRec_timestamp()+"\", \"n01\": \""+getN01()+"\", \"n02\": \""+getN02()+"\", \"n03\": \""+getN03()+"\", \"n04\": \""+getN04()+"\", \"n05\": \""+getN05()+"\", \"c01\": \""+getC01()+"\", \"c02\": \""+getC02()+"\", \"c03\": \""+getC03()+"\", \"c04\": \""+getC04()+"\", \"c05\": \""+getC05()+"\", \"d01\": \""+getD01()+"\", \"d02\": \""+getD02()+"\", \"d03\": \""+getD03()+"\", \"d04\": \""+getD04()+"\", \"d05\": \""+getD05()+"\", \"df_removed_date\": \""+getDf_removed_date()+"\"}}";
   }

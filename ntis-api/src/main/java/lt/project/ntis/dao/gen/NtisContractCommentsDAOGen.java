...
public class NtisContractCommentsDAOGen extends SprBaseDAO{
   public static String IDENTIFIER="NTIS_CONTRACT_COMMENTS.CC_ID";
   private Double cc_id;
   private String cc_message;
   private Date cc_created;
   private Double cc_cot_id;
   private Double cc_org_id;
   private Double cc_per_id;
   ...
   protected boolean cc_id_changed;
   protected boolean cc_message_changed;
   protected boolean cc_created_changed;
   protected boolean cc_cot_id_changed;
   protected boolean cc_org_id_changed;
   protected boolean cc_per_id_changed;
   ...
   public NtisContractCommentsDAOGen() {
      markObjectAsInitial();
      setRecordLoaded(false);
      setForceUpdate(false);
   }
   public NtisContractCommentsDAOGen(Double cc_id, String cc_message, Date cc_created, Double cc_cot_id, Double cc_org_id, Double cc_per_id, Double rec_version, Date rec_create_timestamp, String rec_userid, Date rec_timestamp, Double n01, Double n02, Double n03, Double n04, Double n05, String c01, String c02, String c03, String c04, String c05, Date d01, Date d02, Date d03, Date d04, Date d05) {
      this.cc_id = cc_id;
      this.cc_message = cc_message;
      this.cc_created = cc_created;
      this.cc_cot_id = cc_cot_id;
      this.cc_org_id = cc_org_id;
      this.cc_per_id = cc_per_id;
   ...
   public void copyValues(NtisContractCommentsDAOGen obj) {
      this.setCc_id(obj.getCc_id());
      this.setCc_message(obj.getCc_message());
      this.setCc_created(obj.getCc_created());
      this.setCc_cot_id(obj.getCc_cot_id());
      this.setCc_org_id(obj.getCc_org_id());
      this.setCc_per_id(obj.getCc_per_id());
   ...
   protected void markObjectAsInitial() {
      this.cc_id_changed = false;
      this.cc_message_changed = false;
      this.cc_created_changed = false;
      this.cc_cot_id_changed = false;
      this.cc_org_id_changed = false;
      this.cc_per_id_changed = false;
   ...
   public void setCc_id(Double cc_id) {
      if (this.isForceUpdate() || (this.cc_id != null && !this.cc_id.equals(cc_id)) || (cc_id != null && !cc_id.equals(this.cc_id))){
         this.cc_id_changed = true; 
   ...
   public void setCc_message(String cc_message) {
      if (this.isForceUpdate() || (this.cc_message != null && !this.cc_message.equals(cc_message)) || (cc_message != null && !cc_message.equals(this.cc_message))){
         this.cc_message_changed = true; 
         this.record_changed = true;
         this.cc_message = cc_message;
      }
   }
   ...
   public void setCc_created(Date cc_created) {
      if (this.isForceUpdate() || (this.cc_created != null && !this.cc_created.equals(cc_created)) || (cc_created != null && !cc_created.equals(this.cc_created))){
         this.cc_created_changed = true; 
         this.record_changed = true;
         this.cc_created = cc_created;
      }
   }
   public Date getCc_created() {
      return this.cc_created;
   }
   public void setCc_cot_id(Double cc_cot_id) {
      if (this.isForceUpdate() || (this.cc_cot_id != null && !this.cc_cot_id.equals(cc_cot_id)) || (cc_cot_id != null && !cc_cot_id.equals(this.cc_cot_id))){
         this.cc_cot_id_changed = true; 
         this.record_changed = true;
         this.cc_cot_id = cc_cot_id;
      }
   }
   public Double getCc_cot_id() {
      return this.cc_cot_id;
   }
   public void setCc_org_id(Double cc_org_id) {
      if (this.isForceUpdate() || (this.cc_org_id != null && !this.cc_org_id.equals(cc_org_id)) || (cc_org_id != null && !cc_org_id.equals(this.cc_org_id))){
         this.cc_org_id_changed = true; 
         this.record_changed = true;
         this.cc_org_id = cc_org_id;
      }
   }
   public Double getCc_org_id() {
      return this.cc_org_id;
   }
   public void setCc_per_id(Double cc_per_id) {
      if (this.isForceUpdate() || (this.cc_per_id != null && !this.cc_per_id.equals(cc_per_id)) || (cc_per_id != null && !cc_per_id.equals(this.cc_per_id))){
         this.cc_per_id_changed = true; 
         this.record_changed = true;
         this.cc_per_id = cc_per_id;
      }
   }
   public Double getCc_per_id() {
      return this.cc_per_id;
   }
   ...
   public Date getD05() {
    ...
    public void setRecordIdentifier(Object recIdentifier) {
        if (recIdentifier != null && !EMPTY_STRING.equals(recIdentifier)  && !"null".equalsIgnoreCase(recIdentifier.toString())){
            this.cc_id = (Double)recIdentifier;
        }
    }
    @JsonIgnore
    ...
    public void validateObject(int operation, SprBaseDBServiceImpl<?> baseService) throws SparkBusinessException{
      if (cc_message_changed || operation == Utils.OPERATION_INSERT) {
         if (cc_message== null || EMPTY_STRING.equals(cc_message)) {
            throw new SparkBusinessException(new S2Message("NTIS_CONTRACT_COMMENTS", "CC_MESSAGE", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }else{
            if (cc_message!= null && cc_message.length()>2147483647) {
               throw new SparkBusinessException(new S2Message("NTIS_CONTRACT_COMMENTS", "CC_MESSAGE", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
            }
         }
      }
      if (cc_created_changed || operation == Utils.OPERATION_INSERT) {
         if (cc_created== null) {
            throw new SparkBusinessException(new S2Message("NTIS_CONTRACT_COMMENTS", "CC_CREATED", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }
      }
      if (cc_cot_id_changed || operation == Utils.OPERATION_INSERT) {
         if (cc_cot_id!= null && (""+cc_cot_id.intValue()).length()>10) {
            throw new SparkBusinessException(new S2Message("NTIS_CONTRACT_COMMENTS", "CC_COT_ID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"10"));
         }
      }
      if (cc_org_id_changed || operation == Utils.OPERATION_INSERT) {
         if (cc_org_id!= null && (""+cc_org_id.intValue()).length()>10) {
            throw new SparkBusinessException(new S2Message("NTIS_CONTRACT_COMMENTS", "CC_ORG_ID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"10"));
         }
      }
      if (cc_per_id_changed || operation == Utils.OPERATION_INSERT) {
         if (cc_per_id!= null && (""+cc_per_id.intValue()).length()>10) {
            throw new SparkBusinessException(new S2Message("NTIS_CONTRACT_COMMENTS", "CC_PER_ID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"10"));
         }
      }
      if (rec_version_changed || operation == Utils.OPERATION_INSERT) {
         if (rec_version!= null && (""+rec_version.intValue()).length()>6) {
            throw new SparkBusinessException(new S2Message("NTIS_CONTRACT_COMMENTS", "REC_VERSION", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"6"));
         }
      }
      if (rec_userid_changed || operation == Utils.OPERATION_INSERT) {
         if (rec_userid!= null && rec_userid.length()>128) {
            throw new SparkBusinessException(new S2Message("NTIS_CONTRACT_COMMENTS", "REC_USERID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"128"));
         }
      }
      if (c01_changed || operation == Utils.OPERATION_INSERT) {
         if (c01!= null && c01.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_CONTRACT_COMMENTS", "C01", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c02_changed || operation == Utils.OPERATION_INSERT) {
         if (c02!= null && c02.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_CONTRACT_COMMENTS", "C02", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c03_changed || operation == Utils.OPERATION_INSERT) {
         if (c03!= null && c03.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_CONTRACT_COMMENTS", "C03", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c04_changed || operation == Utils.OPERATION_INSERT) {
         if (c04!= null && c04.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_CONTRACT_COMMENTS", "C04", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c05_changed || operation == Utils.OPERATION_INSERT) {
         if (c05!= null && c05.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_CONTRACT_COMMENTS", "C05", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
   }
   ...
   public UpdateStatementPart constructUpdatePart(String userName) {
      ...
      String answer = "UPDATE NTIS_CONTRACT_COMMENTS SET ";
      boolean changedExists = false;      if (cc_message_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"CC_MESSAGE = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(cc_message);
      }
      if (cc_created_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"CC_CREATED = ? ";
         changedExists = true;
         updateStatementPart.addStatementTimestampParam(cc_created);
      }
      if (cc_cot_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"CC_COT_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(cc_cot_id);
      }
      if (cc_org_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"CC_ORG_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(cc_org_id);
      }
      if (cc_per_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"CC_PER_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(cc_per_id);
      }
      if (n01_changed) {
      ...
      answer = answer +" WHERE  CC_ID = ? ";
      updateStatementPart.addStatementParam(cc_id);
      updateStatementPart.setStatementPart(answer);
      return updateStatementPart;
   }
   public String toString() {
      return "{\"NtisContractCommentsDAO\":{\"cc_id\": \""+getCc_id()+"\", \"cc_message\": \""+getCc_message()+"\", \"cc_created\": \""+getCc_created()+"\", \"cc_cot_id\": \""+getCc_cot_id()+"\", \"cc_org_id\": \""+getCc_org_id()+"\", \"cc_per_id\": \""+getCc_per_id()+"\", \"rec_version\": \""+getRec_version()+"\", \"rec_create_timestamp\": \""+getRec_create_timestamp()+"\", \"rec_userid\": \""+getRec_userid()+"\", \"rec_timestamp\": \""+getRec_timestamp()+"\", \"n01\": \""+getN01()+"\", \"n02\": \""+getN02()+"\", \"n03\": \""+getN03()+"\", \"n04\": \""+getN04()+"\", \"n05\": \""+getN05()+"\", \"c01\": \""+getC01()+"\", \"c02\": \""+getC02()+"\", \"c03\": \""+getC03()+"\", \"c04\": \""+getC04()+"\", \"c05\": \""+getC05()+"\", \"d01\": \""+getD01()+"\", \"d02\": \""+getD02()+"\", \"d03\": \""+getD03()+"\", \"d04\": \""+getD04()+"\", \"d05\": \""+getD05()+"\"}}";
   }

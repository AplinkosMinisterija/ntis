...
public class NtisResearchOrderServiceDAOGen extends SprBaseDAO{
   public static String IDENTIFIER="NTIS_RESEARCH_ORDER_SERVICES.ROS_ID";
   private Double ros_id;
   private Double ros_srv_id;
   private Double ros_ro_id;
   ...
   protected boolean ros_id_changed;
   protected boolean ros_srv_id_changed;
   protected boolean ros_ro_id_changed;
   ...
   public void copyValues(NtisResearchOrderServiceDAOGen obj) {
      this.setRos_id(obj.getRos_id());
      this.setRos_srv_id(obj.getRos_srv_id());
      this.setRos_ro_id(obj.getRos_ro_id());
   ...
   protected void markObjectAsInitial() {
      this.ros_id_changed = false;
      this.ros_srv_id_changed = false;
      this.ros_ro_id_changed = false;
   ...
   public void setRos_id(Double ros_id) {
      if (this.isForceUpdate() || (this.ros_id != null && !this.ros_id.equals(ros_id)) || (ros_id != null && !ros_id.equals(this.ros_id))){
         this.ros_id_changed = true; 
         this.record_changed = true;
         this.ros_id = ros_id;
      }
   }
   public Double getRos_id() {
      return this.ros_id;
   }
   public void setRos_srv_id(Double ros_srv_id) {
      if (this.isForceUpdate() || (this.ros_srv_id != null && !this.ros_srv_id.equals(ros_srv_id)) || (ros_srv_id != null && !ros_srv_id.equals(this.ros_srv_id))){
         this.ros_srv_id_changed = true; 
         this.record_changed = true;
         this.ros_srv_id = ros_srv_id;
      }
   }
   public Double getRos_srv_id() {
      return this.ros_srv_id;
   }
   public void setRos_ro_id(Double ros_ro_id) {
      if (this.isForceUpdate() || (this.ros_ro_id != null && !this.ros_ro_id.equals(ros_ro_id)) || (ros_ro_id != null && !ros_ro_id.equals(this.ros_ro_id))){
         this.ros_ro_id_changed = true; 
         this.record_changed = true;
         this.ros_ro_id = ros_ro_id;
      }
   }
   public Double getRos_ro_id() {
      return this.ros_ro_id;
   }
   ...
   public Date getD05() {
    ...
    public void setRecordIdentifier(Object recIdentifier) {
        if (recIdentifier != null && !EMPTY_STRING.equals(recIdentifier)  && !"null".equalsIgnoreCase(recIdentifier.toString())){
            this.ros_id = (Double)recIdentifier;
        }
    }
    @JsonIgnore
    ...
    public void validateObject(int operation, SprBaseDBServiceImpl<?> baseService) throws SparkBusinessException{
      if (ros_srv_id_changed || operation == Utils.OPERATION_INSERT) {
         if (ros_srv_id!= null && (""+ros_srv_id.intValue()).length()>10) {
            throw new SparkBusinessException(new S2Message("NTIS_RESEARCH_ORDER_SERVICES", "ROS_SRV_ID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"10"));
         }
      }
      if (ros_ro_id_changed || operation == Utils.OPERATION_INSERT) {
         if (ros_ro_id!= null && (""+ros_ro_id.intValue()).length()>10) {
            throw new SparkBusinessException(new S2Message("NTIS_RESEARCH_ORDER_SERVICES", "ROS_RO_ID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"10"));
         }
      }
      if (rec_version_changed || operation == Utils.OPERATION_INSERT) {
         if (rec_version!= null && (""+rec_version.intValue()).length()>6) {
            throw new SparkBusinessException(new S2Message("NTIS_RESEARCH_ORDER_SERVICES", "REC_VERSION", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"6"));
         }
      }
      if (rec_userid_changed || operation == Utils.OPERATION_INSERT) {
         if (rec_userid!= null && rec_userid.length()>128) {
            throw new SparkBusinessException(new S2Message("NTIS_RESEARCH_ORDER_SERVICES", "REC_USERID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"128"));
         }
      }
      if (c01_changed || operation == Utils.OPERATION_INSERT) {
         if (c01!= null && c01.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_RESEARCH_ORDER_SERVICES", "C01", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c02_changed || operation == Utils.OPERATION_INSERT) {
         if (c02!= null && c02.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_RESEARCH_ORDER_SERVICES", "C02", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c03_changed || operation == Utils.OPERATION_INSERT) {
         if (c03!= null && c03.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_RESEARCH_ORDER_SERVICES", "C03", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c04_changed || operation == Utils.OPERATION_INSERT) {
         if (c04!= null && c04.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_RESEARCH_ORDER_SERVICES", "C04", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c05_changed || operation == Utils.OPERATION_INSERT) {
         if (c05!= null && c05.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_RESEARCH_ORDER_SERVICES", "C05", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
   }
   ...
   public UpdateStatementPart constructUpdatePart(String userName) {
      ...
      String answer = "UPDATE NTIS_RESEARCH_ORDER_SERVICES SET ";
      boolean changedExists = false;      if (ros_srv_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"ROS_SRV_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(ros_srv_id);
      }
      if (ros_ro_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"ROS_RO_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(ros_ro_id);
      }
      if (n01_changed) {
      ...
      answer = answer +" WHERE  ROS_ID = ? ";
      updateStatementPart.addStatementParam(ros_id);
      updateStatementPart.setStatementPart(answer);
      return updateStatementPart;
   }
   public String toString() {
      return "{\"NtisResearchOrderServiceDAO\":{\"ros_id\": \""+getRos_id()+"\", \"ros_srv_id\": \""+getRos_srv_id()+"\", \"ros_ro_id\": \""+getRos_ro_id()+"\", \"rec_version\": \""+getRec_version()+"\", \"rec_create_timestamp\": \""+getRec_create_timestamp()+"\", \"rec_userid\": \""+getRec_userid()+"\", \"rec_timestamp\": \""+getRec_timestamp()+"\", \"n01\": \""+getN01()+"\", \"n02\": \""+getN02()+"\", \"n03\": \""+getN03()+"\", \"n04\": \""+getN04()+"\", \"n05\": \""+getN05()+"\", \"c01\": \""+getC01()+"\", \"c02\": \""+getC02()+"\", \"c03\": \""+getC03()+"\", \"c04\": \""+getC04()+"\", \"c05\": \""+getC05()+"\", \"d01\": \""+getD01()+"\", \"d02\": \""+getD02()+"\", \"d03\": \""+getD03()+"\", \"d04\": \""+getD04()+"\", \"d05\": \""+getD05()+"\"}}";
   }

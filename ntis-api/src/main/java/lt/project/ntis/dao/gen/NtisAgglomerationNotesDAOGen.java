...
public class NtisAgglomerationNotesDAOGen extends SprBaseDAO{
   public static String IDENTIFIER="NTIS_AGGLOMERATION_NOTES.AN_ID";
   private Double an_id;
   private String an_type;
   private String an_description;
   private Date an_created;
   private Double an_av_id;
   ...
   protected boolean an_id_changed;
   protected boolean an_type_changed;
   protected boolean an_description_changed;
   protected boolean an_created_changed;
   protected boolean an_av_id_changed;
   ...
   public NtisAgglomerationNotesDAOGen() {
      markObjectAsInitial();
      setRecordLoaded(false);
      setForceUpdate(false);
   }
   public NtisAgglomerationNotesDAOGen(Double an_id, String an_type, String an_description, Date an_created, Double an_av_id, Double rec_version, Date rec_create_timestamp, String rec_userid, Date rec_timestamp, Double n01, Double n02, Double n03, Double n04, Double n05, String c01, String c02, String c03, String c04, String c05, Date d01, Date d02, Date d03, Date d04, Date d05) {
      this.an_id = an_id;
      this.an_type = an_type;
      this.an_description = an_description;
      this.an_created = an_created;
      this.an_av_id = an_av_id;
   ...
   public void copyValues(NtisAgglomerationNotesDAOGen obj) {
      this.setAn_id(obj.getAn_id());
      this.setAn_type(obj.getAn_type());
      this.setAn_description(obj.getAn_description());
      this.setAn_created(obj.getAn_created());
      this.setAn_av_id(obj.getAn_av_id());
   ...
   protected void markObjectAsInitial() {
      this.an_id_changed = false;
      this.an_type_changed = false;
      this.an_description_changed = false;
      this.an_created_changed = false;
      this.an_av_id_changed = false;
   ...
   public void setAn_id(Double an_id) {
      if (this.isForceUpdate() || (this.an_id != null && !this.an_id.equals(an_id)) || (an_id != null && !an_id.equals(this.an_id))){
         this.an_id_changed = true; 
         this.record_changed = true;
         this.an_id = an_id;
      }
   }
   public Double getAn_id() {
      return this.an_id;
   }
   public void setAn_type(String an_type) {
      if (this.isForceUpdate() || (this.an_type != null && !this.an_type.equals(an_type)) || (an_type != null && !an_type.equals(this.an_type))){
         this.an_type_changed = true; 
         this.record_changed = true;
         this.an_type = an_type;
      }
   }
   ...
   public void setAn_description(String an_description) {
      if (this.isForceUpdate() || (this.an_description != null && !this.an_description.equals(an_description)) || (an_description != null && !an_description.equals(this.an_description))){
         this.an_description_changed = true; 
         this.record_changed = true;
         this.an_description = an_description;
      }
   }
   ...
   public void setAn_created(Date an_created) {
      if (this.isForceUpdate() || (this.an_created != null && !this.an_created.equals(an_created)) || (an_created != null && !an_created.equals(this.an_created))){
         this.an_created_changed = true; 
         this.record_changed = true;
         this.an_created = an_created;
      }
   }
   public Date getAn_created() {
      return this.an_created;
   }
   public void setAn_av_id(Double an_av_id) {
      if (this.isForceUpdate() || (this.an_av_id != null && !this.an_av_id.equals(an_av_id)) || (an_av_id != null && !an_av_id.equals(this.an_av_id))){
         this.an_av_id_changed = true; 
         this.record_changed = true;
         this.an_av_id = an_av_id;
      }
   }
   public Double getAn_av_id() {
      return this.an_av_id;
   }
   ...
   public Date getD05() {
    ...
    public void setRecordIdentifier(Object recIdentifier) {
        if (recIdentifier != null && !EMPTY_STRING.equals(recIdentifier)  && !"null".equalsIgnoreCase(recIdentifier.toString())){
            this.an_id = (Double)recIdentifier;
        }
    }
    @JsonIgnore
    ...
    public void validateObject(int operation, SprBaseDBServiceImpl<?> baseService) throws SparkBusinessException{
      if (an_type_changed || operation == Utils.OPERATION_INSERT) {
         if (an_type== null || EMPTY_STRING.equals(an_type)) {
            throw new SparkBusinessException(new S2Message("NTIS_AGGLOMERATION_NOTES", "AN_TYPE", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }else{
            if (an_type!= null && an_type.length()>2147483647) {
               throw new SparkBusinessException(new S2Message("NTIS_AGGLOMERATION_NOTES", "AN_TYPE", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
            }
         }
      }
      if (an_description_changed || operation == Utils.OPERATION_INSERT) {
         if (an_description== null || EMPTY_STRING.equals(an_description)) {
            throw new SparkBusinessException(new S2Message("NTIS_AGGLOMERATION_NOTES", "AN_DESCRIPTION", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }else{
            if (an_description!= null && an_description.length()>2147483647) {
               throw new SparkBusinessException(new S2Message("NTIS_AGGLOMERATION_NOTES", "AN_DESCRIPTION", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
            }
         }
      }
      if (an_created_changed || operation == Utils.OPERATION_INSERT) {
         if (an_created== null) {
            throw new SparkBusinessException(new S2Message("NTIS_AGGLOMERATION_NOTES", "AN_CREATED", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }
      }
      if (an_av_id_changed || operation == Utils.OPERATION_INSERT) {
         if (an_av_id== null) {
            throw new SparkBusinessException(new S2Message("NTIS_AGGLOMERATION_NOTES", "AN_AV_ID", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }else{
            if (an_av_id!= null && (""+an_av_id.intValue()).length()>10) {
               throw new SparkBusinessException(new S2Message("NTIS_AGGLOMERATION_NOTES", "AN_AV_ID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"10"));
            }
         }
      }
      if (rec_version_changed || operation == Utils.OPERATION_INSERT) {
         if (rec_version!= null && (""+rec_version.intValue()).length()>6) {
            throw new SparkBusinessException(new S2Message("NTIS_AGGLOMERATION_NOTES", "REC_VERSION", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"6"));
         }
      }
      if (rec_userid_changed || operation == Utils.OPERATION_INSERT) {
         if (rec_userid!= null && rec_userid.length()>128) {
            throw new SparkBusinessException(new S2Message("NTIS_AGGLOMERATION_NOTES", "REC_USERID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"128"));
         }
      }
      if (c01_changed || operation == Utils.OPERATION_INSERT) {
         if (c01!= null && c01.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_AGGLOMERATION_NOTES", "C01", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c02_changed || operation == Utils.OPERATION_INSERT) {
         if (c02!= null && c02.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_AGGLOMERATION_NOTES", "C02", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c03_changed || operation == Utils.OPERATION_INSERT) {
         if (c03!= null && c03.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_AGGLOMERATION_NOTES", "C03", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c04_changed || operation == Utils.OPERATION_INSERT) {
         if (c04!= null && c04.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_AGGLOMERATION_NOTES", "C04", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c05_changed || operation == Utils.OPERATION_INSERT) {
         if (c05!= null && c05.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_AGGLOMERATION_NOTES", "C05", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
   }
   ...
   public UpdateStatementPart constructUpdatePart(String userName) {
      ...
      String answer = "UPDATE NTIS_AGGLOMERATION_NOTES SET ";
      boolean changedExists = false;      if (an_type_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"AN_TYPE = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(an_type);
      }
      if (an_description_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"AN_DESCRIPTION = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(an_description);
      }
      if (an_created_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"AN_CREATED = ? ";
         changedExists = true;
         updateStatementPart.addStatementTimestampParam(an_created);
      }
      if (an_av_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"AN_AV_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(an_av_id);
      }
      if (n01_changed) {

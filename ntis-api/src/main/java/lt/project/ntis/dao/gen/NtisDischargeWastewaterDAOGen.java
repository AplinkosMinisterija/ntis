...
public class NtisDischargeWastewaterDAOGen extends SprBaseDAO{
   public static String IDENTIFIER="NTIS_DISCHARGE_WASTEWATER.DW_ID";
   private Double dw_id;
   private String dw_type;
   private Double dw_coordinate_latitude;
   private Double dw_coordinate_longitude;
   private Double dw_ad_id;
   private Double dw_wtf_id;
   ...
   protected boolean dw_id_changed;
   protected boolean dw_type_changed;
   protected boolean dw_coordinate_latitude_changed;
   protected boolean dw_coordinate_longitude_changed;
   protected boolean dw_ad_id_changed;
   protected boolean dw_wtf_id_changed;
   ...
   public NtisDischargeWastewaterDAOGen() {
      markObjectAsInitial();
      setRecordLoaded(false);
      setForceUpdate(false);
   }
   public NtisDischargeWastewaterDAOGen(Double dw_id, String dw_type, Double dw_coordinate_latitude, Double dw_coordinate_longitude, Double dw_ad_id, Double dw_wtf_id, Double rec_version, Date rec_create_timestamp, String rec_userid, Date rec_timestamp, Double n01, Double n02, Double n03, Double n04, Double n05, String c01, String c02, String c03, String c04, String c05, Date d01, Date d02, Date d03, Date d04, Date d05) {
      this.dw_id = dw_id;
      this.dw_type = dw_type;
      this.dw_coordinate_latitude = dw_coordinate_latitude;
      this.dw_coordinate_longitude = dw_coordinate_longitude;
      this.dw_ad_id = dw_ad_id;
      this.dw_wtf_id = dw_wtf_id;
   ...
   public void copyValues(NtisDischargeWastewaterDAOGen obj) {
      this.setDw_id(obj.getDw_id());
      this.setDw_type(obj.getDw_type());
      this.setDw_coordinate_latitude(obj.getDw_coordinate_latitude());
      this.setDw_coordinate_longitude(obj.getDw_coordinate_longitude());
      this.setDw_ad_id(obj.getDw_ad_id());
      this.setDw_wtf_id(obj.getDw_wtf_id());
   ...
   protected void markObjectAsInitial() {
      this.dw_id_changed = false;
      this.dw_type_changed = false;
      this.dw_coordinate_latitude_changed = false;
      this.dw_coordinate_longitude_changed = false;
      this.dw_ad_id_changed = false;
      this.dw_wtf_id_changed = false;
   ...
   public void setDw_id(Double dw_id) {
      if (this.isForceUpdate() || (this.dw_id != null && !this.dw_id.equals(dw_id)) || (dw_id != null && !dw_id.equals(this.dw_id))){
         this.dw_id_changed = true; 
         this.record_changed = true;
         this.dw_id = dw_id;
      }
   }
   public Double getDw_id() {
      return this.dw_id;
   }
   public void setDw_type(String dw_type) {
      if (this.isForceUpdate() || (this.dw_type != null && !this.dw_type.equals(dw_type)) || (dw_type != null && !dw_type.equals(this.dw_type))){
         this.dw_type_changed = true; 
         this.record_changed = true;
         this.dw_type = dw_type;
      }
   }
   ...
   public void setDw_coordinate_latitude(Double dw_coordinate_latitude) {
      if (this.isForceUpdate() || (this.dw_coordinate_latitude != null && !this.dw_coordinate_latitude.equals(dw_coordinate_latitude)) || (dw_coordinate_latitude != null && !dw_coordinate_latitude.equals(this.dw_coordinate_latitude))){
         this.dw_coordinate_latitude_changed = true; 
         this.record_changed = true;
         this.dw_coordinate_latitude = dw_coordinate_latitude;
      }
   }
   public Double getDw_coordinate_latitude() {
      return this.dw_coordinate_latitude;
   }
   public void setDw_coordinate_longitude(Double dw_coordinate_longitude) {
      if (this.isForceUpdate() || (this.dw_coordinate_longitude != null && !this.dw_coordinate_longitude.equals(dw_coordinate_longitude)) || (dw_coordinate_longitude != null && !dw_coordinate_longitude.equals(this.dw_coordinate_longitude))){
         this.dw_coordinate_longitude_changed = true; 
         this.record_changed = true;
         this.dw_coordinate_longitude = dw_coordinate_longitude;
      }
   }
   public Double getDw_coordinate_longitude() {
      return this.dw_coordinate_longitude;
   }
   public void setDw_ad_id(Double dw_ad_id) {
      if (this.isForceUpdate() || (this.dw_ad_id != null && !this.dw_ad_id.equals(dw_ad_id)) || (dw_ad_id != null && !dw_ad_id.equals(this.dw_ad_id))){
         this.dw_ad_id_changed = true; 
         this.record_changed = true;
         this.dw_ad_id = dw_ad_id;
      }
   }
   public Double getDw_ad_id() {
      return this.dw_ad_id;
   }
   public void setDw_wtf_id(Double dw_wtf_id) {
      if (this.isForceUpdate() || (this.dw_wtf_id != null && !this.dw_wtf_id.equals(dw_wtf_id)) || (dw_wtf_id != null && !dw_wtf_id.equals(this.dw_wtf_id))){
         this.dw_wtf_id_changed = true; 
         this.record_changed = true;
         this.dw_wtf_id = dw_wtf_id;
      }
   }
   public Double getDw_wtf_id() {
      return this.dw_wtf_id;
   }
   ...
   public Date getD05() {
    ...
    public void setRecordIdentifier(Object recIdentifier) {
        if (recIdentifier != null && !EMPTY_STRING.equals(recIdentifier)  && !"null".equalsIgnoreCase(recIdentifier.toString())){
            this.dw_id = (Double)recIdentifier;
        }
    }
    @JsonIgnore
    ...
    public void validateObject(int operation, SprBaseDBServiceImpl<?> baseService) throws SparkBusinessException{
      if (dw_type_changed || operation == Utils.OPERATION_INSERT) {
         if (dw_type!= null && dw_type.length()>50) {
            throw new SparkBusinessException(new S2Message("NTIS_DISCHARGE_WASTEWATER", "DW_TYPE", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"50"));
         }
      }
      if (dw_coordinate_latitude_changed || operation == Utils.OPERATION_INSERT) {
         if (dw_coordinate_latitude== null) {
            throw new SparkBusinessException(new S2Message("NTIS_DISCHARGE_WASTEWATER", "DW_COORDINATE_LATITUDE", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }else{
            if (dw_coordinate_latitude!= null && (""+dw_coordinate_latitude.intValue()).length()>12) {
               throw new SparkBusinessException(new S2Message("NTIS_DISCHARGE_WASTEWATER", "DW_COORDINATE_LATITUDE", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"12"));
            }
         }
      }
      if (dw_coordinate_longitude_changed || operation == Utils.OPERATION_INSERT) {
         if (dw_coordinate_longitude== null) {
            throw new SparkBusinessException(new S2Message("NTIS_DISCHARGE_WASTEWATER", "DW_COORDINATE_LONGITUDE", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }else{
            if (dw_coordinate_longitude!= null && (""+dw_coordinate_longitude.intValue()).length()>12) {
               throw new SparkBusinessException(new S2Message("NTIS_DISCHARGE_WASTEWATER", "DW_COORDINATE_LONGITUDE", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"12"));
            }
         }
      }
      if (dw_ad_id_changed || operation == Utils.OPERATION_INSERT) {
         if (dw_ad_id!= null && (""+dw_ad_id.intValue()).length()>10) {
            throw new SparkBusinessException(new S2Message("NTIS_DISCHARGE_WASTEWATER", "DW_AD_ID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"10"));
         }
      }
      if (dw_wtf_id_changed || operation == Utils.OPERATION_INSERT) {
         if (dw_wtf_id!= null && (""+dw_wtf_id.intValue()).length()>10) {
            throw new SparkBusinessException(new S2Message("NTIS_DISCHARGE_WASTEWATER", "DW_WTF_ID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"10"));
         }
      }
      if (rec_version_changed || operation == Utils.OPERATION_INSERT) {
         if (rec_version!= null && (""+rec_version.intValue()).length()>6) {
            throw new SparkBusinessException(new S2Message("NTIS_DISCHARGE_WASTEWATER", "REC_VERSION", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"6"));
         }
      }
      if (rec_userid_changed || operation == Utils.OPERATION_INSERT) {
         if (rec_userid!= null && rec_userid.length()>128) {
            throw new SparkBusinessException(new S2Message("NTIS_DISCHARGE_WASTEWATER", "REC_USERID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"128"));
         }
      }
      if (c01_changed || operation == Utils.OPERATION_INSERT) {
         if (c01!= null && c01.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_DISCHARGE_WASTEWATER", "C01", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c02_changed || operation == Utils.OPERATION_INSERT) {
         if (c02!= null && c02.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_DISCHARGE_WASTEWATER", "C02", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c03_changed || operation == Utils.OPERATION_INSERT) {
         if (c03!= null && c03.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_DISCHARGE_WASTEWATER", "C03", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c04_changed || operation == Utils.OPERATION_INSERT) {
         if (c04!= null && c04.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_DISCHARGE_WASTEWATER", "C04", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c05_changed || operation == Utils.OPERATION_INSERT) {
         if (c05!= null && c05.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_DISCHARGE_WASTEWATER", "C05", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
   }
   ...
   public UpdateStatementPart constructUpdatePart(String userName) {
      ...
      String answer = "UPDATE NTIS_DISCHARGE_WASTEWATER SET ";
      boolean changedExists = false;      if (dw_type_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"DW_TYPE = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(dw_type);
      }
      if (dw_coordinate_latitude_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"DW_COORDINATE_LATITUDE = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(dw_coordinate_latitude);
      }
      if (dw_coordinate_longitude_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"DW_COORDINATE_LONGITUDE = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(dw_coordinate_longitude);
      }
      if (dw_ad_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"DW_AD_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(dw_ad_id);
      }
      if (dw_wtf_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"DW_WTF_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(dw_wtf_id);
      }
      if (n01_changed) {
      ...
      answer = answer +" WHERE  DW_ID = ? ";
      updateStatementPart.addStatementParam(dw_id);
      updateStatementPart.setStatementPart(answer);
      return updateStatementPart;
   }
   public String toString() {
      return "{\"NtisDischargeWastewaterDAO\":{\"dw_id\": \""+getDw_id()+"\", \"dw_type\": \""+getDw_type()+"\", \"dw_coordinate_latitude\": \""+getDw_coordinate_latitude()+"\", \"dw_coordinate_longitude\": \""+getDw_coordinate_longitude()+"\", \"dw_ad_id\": \""+getDw_ad_id()+"\", \"dw_wtf_id\": \""+getDw_wtf_id()+"\", \"rec_version\": \""+getRec_version()+"\", \"rec_create_timestamp\": \""+getRec_create_timestamp()+"\", \"rec_userid\": \""+getRec_userid()+"\", \"rec_timestamp\": \""+getRec_timestamp()+"\", \"n01\": \""+getN01()+"\", \"n02\": \""+getN02()+"\", \"n03\": \""+getN03()+"\", \"n04\": \""+getN04()+"\", \"n05\": \""+getN05()+"\", \"c01\": \""+getC01()+"\", \"c02\": \""+getC02()+"\", \"c03\": \""+getC03()+"\", \"c04\": \""+getC04()+"\", \"c05\": \""+getC05()+"\", \"d01\": \""+getD01()+"\", \"d02\": \""+getD02()+"\", \"d03\": \""+getD03()+"\", \"d04\": \""+getD04()+"\", \"d05\": \""+getD05()+"\"}}";
   }

...
public class NtisServiceReqItemsDAOGen extends SprBaseDAO{
   public static String IDENTIFIER="NTIS_SERVICE_REQ_ITEMS.SRI_ID";
   private Double sri_id;
   private String sri_service_type;
   private String sri_status;
   private Date sri_status_date;
   private Date sri_registration_date;
   private Date sri_removal_date;
   private Double sri_srv_id;
   private Double sri_sr_id;
   ...
   protected boolean sri_id_changed;
   protected boolean sri_service_type_changed;
   protected boolean sri_status_changed;
   protected boolean sri_status_date_changed;
   protected boolean sri_registration_date_changed;
   protected boolean sri_removal_date_changed;
   protected boolean sri_srv_id_changed;
   protected boolean sri_sr_id_changed;
   ...
   public NtisServiceReqItemsDAOGen() {
      markObjectAsInitial();
      setRecordLoaded(false);
      setForceUpdate(false);
   }
   public NtisServiceReqItemsDAOGen(Double sri_id, String sri_service_type, String sri_status, Date sri_status_date, Date sri_registration_date, Date sri_removal_date, Double sri_srv_id, Double sri_sr_id, Double rec_version, Date rec_create_timestamp, String rec_userid, Date rec_timestamp, Double n01, Double n02, Double n03, Double n04, Double n05, String c01, String c02, String c03, String c04, String c05, Date d01, Date d02, Date d03, Date d04, Date d05) {
      this.sri_id = sri_id;
      this.sri_service_type = sri_service_type;
      this.sri_status = sri_status;
      this.sri_status_date = sri_status_date;
      this.sri_registration_date = sri_registration_date;
      this.sri_removal_date = sri_removal_date;
      this.sri_srv_id = sri_srv_id;
      this.sri_sr_id = sri_sr_id;
   ...
   public void copyValues(NtisServiceReqItemsDAOGen obj) {
      this.setSri_id(obj.getSri_id());
      this.setSri_service_type(obj.getSri_service_type());
      this.setSri_status(obj.getSri_status());
      this.setSri_status_date(obj.getSri_status_date());
      this.setSri_registration_date(obj.getSri_registration_date());
      this.setSri_removal_date(obj.getSri_removal_date());
      this.setSri_srv_id(obj.getSri_srv_id());
      this.setSri_sr_id(obj.getSri_sr_id());
   ...
   protected void markObjectAsInitial() {
      this.sri_id_changed = false;
      this.sri_service_type_changed = false;
      this.sri_status_changed = false;
      this.sri_status_date_changed = false;
      this.sri_registration_date_changed = false;
      this.sri_removal_date_changed = false;
      this.sri_srv_id_changed = false;
      this.sri_sr_id_changed = false;
   ...
   public void setSri_id(Double sri_id) {
      if (this.isForceUpdate() || (this.sri_id != null && !this.sri_id.equals(sri_id)) || (sri_id != null && !sri_id.equals(this.sri_id))){
         this.sri_id_changed = true; 
   ...
   public void setSri_service_type(String sri_service_type) {
      if (this.isForceUpdate() || (this.sri_service_type != null && !this.sri_service_type.equals(sri_service_type)) || (sri_service_type != null && !sri_service_type.equals(this.sri_service_type))){
         this.sri_service_type_changed = true; 
         this.record_changed = true;
         this.sri_service_type = sri_service_type;
      }
   }
   public String getSri_service_type() {
      return this.sri_service_type;
   }
   public void setSri_status(String sri_status) {
      if (this.isForceUpdate() || (this.sri_status != null && !this.sri_status.equals(sri_status)) || (sri_status != null && !sri_status.equals(this.sri_status))){
         this.sri_status_changed = true; 
         this.record_changed = true;
         this.sri_status = sri_status;
      }
   }
   public String getSri_status() {
      return this.sri_status;
   }
   public void setSri_status_date(Date sri_status_date) {
      if (this.isForceUpdate() || (this.sri_status_date != null && !this.sri_status_date.equals(sri_status_date)) || (sri_status_date != null && !sri_status_date.equals(this.sri_status_date))){
         this.sri_status_date_changed = true; 
         this.record_changed = true;
         this.sri_status_date = sri_status_date;
      }
   }
   public Date getSri_status_date() {
      return this.sri_status_date;
   }
   public void setSri_registration_date(Date sri_registration_date) {
      if (this.isForceUpdate() || (this.sri_registration_date != null && !this.sri_registration_date.equals(sri_registration_date)) || (sri_registration_date != null && !sri_registration_date.equals(this.sri_registration_date))){
         this.sri_registration_date_changed = true; 
         this.record_changed = true;
         this.sri_registration_date = sri_registration_date;
      }
   }
   public Date getSri_registration_date() {
      return this.sri_registration_date;
   }
   public void setSri_removal_date(Date sri_removal_date) {
      if (this.isForceUpdate() || (this.sri_removal_date != null && !this.sri_removal_date.equals(sri_removal_date)) || (sri_removal_date != null && !sri_removal_date.equals(this.sri_removal_date))){
         this.sri_removal_date_changed = true; 
         this.record_changed = true;
         this.sri_removal_date = sri_removal_date;
      }
   }
   public Date getSri_removal_date() {
      return this.sri_removal_date;
   }
   public void setSri_srv_id(Double sri_srv_id) {
      if (this.isForceUpdate() || (this.sri_srv_id != null && !this.sri_srv_id.equals(sri_srv_id)) || (sri_srv_id != null && !sri_srv_id.equals(this.sri_srv_id))){
         this.sri_srv_id_changed = true; 
         this.record_changed = true;
         this.sri_srv_id = sri_srv_id;
      }
   }
   public Double getSri_srv_id() {
      return this.sri_srv_id;
   }
   public void setSri_sr_id(Double sri_sr_id) {
      if (this.isForceUpdate() || (this.sri_sr_id != null && !this.sri_sr_id.equals(sri_sr_id)) || (sri_sr_id != null && !sri_sr_id.equals(this.sri_sr_id))){
         this.sri_sr_id_changed = true; 
         this.record_changed = true;
         this.sri_sr_id = sri_sr_id;
      }
   }
   public Double getSri_sr_id() {
      return this.sri_sr_id;
   }
   ...
   public Date getD05() {
    ...
    public void setRecordIdentifier(Object recIdentifier) {
        if (recIdentifier != null && !EMPTY_STRING.equals(recIdentifier)  && !"null".equalsIgnoreCase(recIdentifier.toString())){
            this.sri_id = (Double)recIdentifier;
        }
    }
    @JsonIgnore
    ...
    public void validateObject(int operation, SprBaseDBServiceImpl<?> baseService) throws SparkBusinessException{
      if (sri_service_type_changed || operation == Utils.OPERATION_INSERT) {
         if (sri_service_type== null || EMPTY_STRING.equals(sri_service_type)) {
            throw new SparkBusinessException(new S2Message("NTIS_SERVICE_REQ_ITEMS", "SRI_SERVICE_TYPE", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }else{
            if (sri_service_type!= null && sri_service_type.length()>50) {
               throw new SparkBusinessException(new S2Message("NTIS_SERVICE_REQ_ITEMS", "SRI_SERVICE_TYPE", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"50"));
            }
         }
      }
      if (sri_status_changed || operation == Utils.OPERATION_INSERT) {
         if (sri_status== null || EMPTY_STRING.equals(sri_status)) {
            throw new SparkBusinessException(new S2Message("NTIS_SERVICE_REQ_ITEMS", "SRI_STATUS", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }else{
            if (sri_status!= null && sri_status.length()>50) {
               throw new SparkBusinessException(new S2Message("NTIS_SERVICE_REQ_ITEMS", "SRI_STATUS", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"50"));
            }
         }
      }
      if (sri_status_date_changed || operation == Utils.OPERATION_INSERT) {
         if (sri_status_date== null) {
            throw new SparkBusinessException(new S2Message("NTIS_SERVICE_REQ_ITEMS", "SRI_STATUS_DATE", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }
      }
      if (sri_srv_id_changed || operation == Utils.OPERATION_INSERT) {
         if (sri_srv_id!= null && (""+sri_srv_id.intValue()).length()>10) {
            throw new SparkBusinessException(new S2Message("NTIS_SERVICE_REQ_ITEMS", "SRI_SRV_ID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"10"));
         }
      }
      if (sri_sr_id_changed || operation == Utils.OPERATION_INSERT) {
         if (sri_sr_id!= null && (""+sri_sr_id.intValue()).length()>10) {
            throw new SparkBusinessException(new S2Message("NTIS_SERVICE_REQ_ITEMS", "SRI_SR_ID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"10"));
         }
      }
      if (rec_version_changed || operation == Utils.OPERATION_INSERT) {
         if (rec_version!= null && (""+rec_version.intValue()).length()>6) {
            throw new SparkBusinessException(new S2Message("NTIS_SERVICE_REQ_ITEMS", "REC_VERSION", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"6"));
         }
      }
      if (rec_userid_changed || operation == Utils.OPERATION_INSERT) {
         if (rec_userid!= null && rec_userid.length()>128) {
            throw new SparkBusinessException(new S2Message("NTIS_SERVICE_REQ_ITEMS", "REC_USERID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"128"));
         }
      }
      if (c01_changed || operation == Utils.OPERATION_INSERT) {
         if (c01!= null && c01.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_SERVICE_REQ_ITEMS", "C01", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c02_changed || operation == Utils.OPERATION_INSERT) {
         if (c02!= null && c02.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_SERVICE_REQ_ITEMS", "C02", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c03_changed || operation == Utils.OPERATION_INSERT) {
         if (c03!= null && c03.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_SERVICE_REQ_ITEMS", "C03", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c04_changed || operation == Utils.OPERATION_INSERT) {
         if (c04!= null && c04.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_SERVICE_REQ_ITEMS", "C04", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c05_changed || operation == Utils.OPERATION_INSERT) {
         if (c05!= null && c05.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_SERVICE_REQ_ITEMS", "C05", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
   }
   ...
   public UpdateStatementPart constructUpdatePart(String userName) {
      ...
      String answer = "UPDATE NTIS_SERVICE_REQ_ITEMS SET ";
      boolean changedExists = false;      if (sri_service_type_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"SRI_SERVICE_TYPE = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(sri_service_type);
      }
      if (sri_status_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"SRI_STATUS = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(sri_status);
      }
      if (sri_status_date_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"SRI_STATUS_DATE = ? ";
         changedExists = true;
         updateStatementPart.addStatementTimestampParam(sri_status_date);
      }
      if (sri_registration_date_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"SRI_REGISTRATION_DATE = ? ";
         changedExists = true;
         updateStatementPart.addStatementTimestampParam(sri_registration_date);
      }
      if (sri_removal_date_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"SRI_REMOVAL_DATE = ? ";
         changedExists = true;
         updateStatementPart.addStatementTimestampParam(sri_removal_date);
      }
      if (sri_srv_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"SRI_SRV_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(sri_srv_id);
      }
      if (sri_sr_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"SRI_SR_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(sri_sr_id);
      }
      if (n01_changed) {
      ...
      answer = answer +" WHERE  SRI_ID = ? ";
      updateStatementPart.addStatementParam(sri_id);
      updateStatementPart.setStatementPart(answer);
      return updateStatementPart;
   }
   public String toString() {
      return "{\"NtisServiceReqItemsDAO\":{\"sri_id\": \""+getSri_id()+"\", \"sri_service_type\": \""+getSri_service_type()+"\", \"sri_status\": \""+getSri_status()+"\", \"sri_status_date\": \""+getSri_status_date()+"\", \"sri_registration_date\": \""+getSri_registration_date()+"\", \"sri_removal_date\": \""+getSri_removal_date()+"\", \"sri_srv_id\": \""+getSri_srv_id()+"\", \"sri_sr_id\": \""+getSri_sr_id()+"\", \"rec_version\": \""+getRec_version()+"\", \"rec_create_timestamp\": \""+getRec_create_timestamp()+"\", \"rec_userid\": \""+getRec_userid()+"\", \"rec_timestamp\": \""+getRec_timestamp()+"\", \"n01\": \""+getN01()+"\", \"n02\": \""+getN02()+"\", \"n03\": \""+getN03()+"\", \"n04\": \""+getN04()+"\", \"n05\": \""+getN05()+"\", \"c01\": \""+getC01()+"\", \"c02\": \""+getC02()+"\", \"c03\": \""+getC03()+"\", \"c04\": \""+getC04()+"\", \"c05\": \""+getC05()+"\", \"d01\": \""+getD01()+"\", \"d02\": \""+getD02()+"\", \"d03\": \""+getD03()+"\", \"d04\": \""+getD04()+"\", \"d05\": \""+getD05()+"\"}}";
   }

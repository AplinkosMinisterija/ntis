...
public class NtisFavoriteWastTreatOrgDAOGen extends SprBaseDAO{
   public static String IDENTIFIER="NTIS_FAVORITE_WAST_TREAT_ORGS.FWTO_ID";
   private Double fwto_id;
   private Double fwto_org_id;
   private Double fwto_wto_id;
   ...
   protected boolean fwto_id_changed;
   protected boolean fwto_org_id_changed;
   protected boolean fwto_wto_id_changed;
   ...
   public NtisFavoriteWastTreatOrgDAOGen() {
      markObjectAsInitial();
      setRecordLoaded(false);
      setForceUpdate(false);
   }
   public NtisFavoriteWastTreatOrgDAOGen(Double fwto_id, Double fwto_org_id, Double fwto_wto_id, Double rec_version, Date rec_create_timestamp, String rec_userid, Date rec_timestamp, Double n01, Double n02, Double n03, Double n04, Double n05, String c01, String c02, String c03, String c04, String c05, Date d01, Date d02, Date d03, Date d04, Date d05) {
      this.fwto_id = fwto_id;
      this.fwto_org_id = fwto_org_id;
      this.fwto_wto_id = fwto_wto_id;
   ...
   public void copyValues(NtisFavoriteWastTreatOrgDAOGen obj) {
      this.setFwto_id(obj.getFwto_id());
      this.setFwto_org_id(obj.getFwto_org_id());
      this.setFwto_wto_id(obj.getFwto_wto_id());
   ...
   protected void markObjectAsInitial() {
      this.fwto_id_changed = false;
      this.fwto_org_id_changed = false;
      this.fwto_wto_id_changed = false;
   ...
   public void setFwto_id(Double fwto_id) {
      if (this.isForceUpdate() || (this.fwto_id != null && !this.fwto_id.equals(fwto_id)) || (fwto_id != null && !fwto_id.equals(this.fwto_id))){
         this.fwto_id_changed = true; 
         this.record_changed = true;
         this.fwto_id = fwto_id;
      }
   }
   public Double getFwto_id() {
      return this.fwto_id;
   }
   public void setFwto_org_id(Double fwto_org_id) {
      if (this.isForceUpdate() || (this.fwto_org_id != null && !this.fwto_org_id.equals(fwto_org_id)) || (fwto_org_id != null && !fwto_org_id.equals(this.fwto_org_id))){
         this.fwto_org_id_changed = true; 
         this.record_changed = true;
         this.fwto_org_id = fwto_org_id;
      }
   }
   public Double getFwto_org_id() {
      return this.fwto_org_id;
   }
   public void setFwto_wto_id(Double fwto_wto_id) {
      if (this.isForceUpdate() || (this.fwto_wto_id != null && !this.fwto_wto_id.equals(fwto_wto_id)) || (fwto_wto_id != null && !fwto_wto_id.equals(this.fwto_wto_id))){
         this.fwto_wto_id_changed = true; 
         this.record_changed = true;
         this.fwto_wto_id = fwto_wto_id;
      }
   }
   public Double getFwto_wto_id() {
      return this.fwto_wto_id;
   }
   ...
   public Date getD05() {
    ...
    public void setRecordIdentifier(Object recIdentifier) {
        if (recIdentifier != null && !EMPTY_STRING.equals(recIdentifier)  && !"null".equalsIgnoreCase(recIdentifier.toString())){
            this.fwto_id = (Double)recIdentifier;
        }
    }
    @JsonIgnore
    ...
    public void validateObject(int operation, SprBaseDBServiceImpl<?> baseService) throws SparkBusinessException{
      if (fwto_org_id_changed || operation == Utils.OPERATION_INSERT) {
         if (fwto_org_id== null) {
            throw new SparkBusinessException(new S2Message("NTIS_FAVORITE_WAST_TREAT_ORGS", "FWTO_ORG_ID", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }else{
            if (fwto_org_id!= null && (""+fwto_org_id.intValue()).length()>10) {
               throw new SparkBusinessException(new S2Message("NTIS_FAVORITE_WAST_TREAT_ORGS", "FWTO_ORG_ID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"10"));
            }
         }
      }
      if (fwto_wto_id_changed || operation == Utils.OPERATION_INSERT) {
         if (fwto_wto_id== null) {
            throw new SparkBusinessException(new S2Message("NTIS_FAVORITE_WAST_TREAT_ORGS", "FWTO_WTO_ID", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }else{
            if (fwto_wto_id!= null && (""+fwto_wto_id.intValue()).length()>10) {
               throw new SparkBusinessException(new S2Message("NTIS_FAVORITE_WAST_TREAT_ORGS", "FWTO_WTO_ID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"10"));
            }
         }
      }
      if (rec_version_changed || operation == Utils.OPERATION_INSERT) {
         if (rec_version!= null && (""+rec_version.intValue()).length()>6) {
            throw new SparkBusinessException(new S2Message("NTIS_FAVORITE_WAST_TREAT_ORGS", "REC_VERSION", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"6"));
         }
      }
      if (rec_userid_changed || operation == Utils.OPERATION_INSERT) {
         if (rec_userid!= null && rec_userid.length()>128) {
            throw new SparkBusinessException(new S2Message("NTIS_FAVORITE_WAST_TREAT_ORGS", "REC_USERID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"128"));
         }
      }
      if (c01_changed || operation == Utils.OPERATION_INSERT) {
         if (c01!= null && c01.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_FAVORITE_WAST_TREAT_ORGS", "C01", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c02_changed || operation == Utils.OPERATION_INSERT) {
         if (c02!= null && c02.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_FAVORITE_WAST_TREAT_ORGS", "C02", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c03_changed || operation == Utils.OPERATION_INSERT) {
         if (c03!= null && c03.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_FAVORITE_WAST_TREAT_ORGS", "C03", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c04_changed || operation == Utils.OPERATION_INSERT) {
         if (c04!= null && c04.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_FAVORITE_WAST_TREAT_ORGS", "C04", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c05_changed || operation == Utils.OPERATION_INSERT) {
         if (c05!= null && c05.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_FAVORITE_WAST_TREAT_ORGS", "C05", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
   }
   ...
   public UpdateStatementPart constructUpdatePart(String userName) {
      ...
      String answer = "UPDATE NTIS_FAVORITE_WAST_TREAT_ORGS SET ";
      boolean changedExists = false;      if (fwto_org_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"FWTO_ORG_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(fwto_org_id);
      }
      if (fwto_wto_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"FWTO_WTO_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(fwto_wto_id);
      }
      if (n01_changed) {

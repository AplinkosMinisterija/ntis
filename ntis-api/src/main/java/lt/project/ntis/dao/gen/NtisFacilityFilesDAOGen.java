...
public class NtisFacilityFilesDAOGen extends SprBaseDAO{
   public static String IDENTIFIER="NTIS_FACILITY_FILES.FF_ID";
   private Double ff_id;
   private Double ff_fil_id;
   private Double ff_wtf_id;
   ...
   protected boolean ff_id_changed;
   protected boolean ff_fil_id_changed;
   protected boolean ff_wtf_id_changed;
   ...
   public NtisFacilityFilesDAOGen() {
      markObjectAsInitial();
      setRecordLoaded(false);
      setForceUpdate(false);
   }
   public NtisFacilityFilesDAOGen(Double ff_id, Double ff_fil_id, Double ff_wtf_id, Double rec_version, Date rec_create_timestamp, String rec_userid, Date rec_timestamp, Double n01, Double n02, Double n03, Double n04, Double n05, String c01, String c02, String c03, String c04, String c05, Date d01, Date d02, Date d03, Date d04, Date d05) {
      this.ff_id = ff_id;
      this.ff_fil_id = ff_fil_id;
      this.ff_wtf_id = ff_wtf_id;
   ...
   public void copyValues(NtisFacilityFilesDAOGen obj) {
      this.setFf_id(obj.getFf_id());
      this.setFf_fil_id(obj.getFf_fil_id());
      this.setFf_wtf_id(obj.getFf_wtf_id());
   ...
   protected void markObjectAsInitial() {
      this.ff_id_changed = false;
      this.ff_fil_id_changed = false;
      this.ff_wtf_id_changed = false;
   ...
   public void setFf_id(Double ff_id) {
      if (this.isForceUpdate() || (this.ff_id != null && !this.ff_id.equals(ff_id)) || (ff_id != null && !ff_id.equals(this.ff_id))){
         this.ff_id_changed = true; 
         this.record_changed = true;
         this.ff_id = ff_id;
      }
   }
   public Double getFf_id() {
      return this.ff_id;
   }
   public void setFf_fil_id(Double ff_fil_id) {
      if (this.isForceUpdate() || (this.ff_fil_id != null && !this.ff_fil_id.equals(ff_fil_id)) || (ff_fil_id != null && !ff_fil_id.equals(this.ff_fil_id))){
         this.ff_fil_id_changed = true; 
         this.record_changed = true;
         this.ff_fil_id = ff_fil_id;
      }
   }
   public Double getFf_fil_id() {
      return this.ff_fil_id;
   }
   public void setFf_wtf_id(Double ff_wtf_id) {
      if (this.isForceUpdate() || (this.ff_wtf_id != null && !this.ff_wtf_id.equals(ff_wtf_id)) || (ff_wtf_id != null && !ff_wtf_id.equals(this.ff_wtf_id))){
         this.ff_wtf_id_changed = true; 
         this.record_changed = true;
         this.ff_wtf_id = ff_wtf_id;
      }
   }
   public Double getFf_wtf_id() {
      return this.ff_wtf_id;
   }
   ...
   public Date getD05() {
    ...
    public void setRecordIdentifier(Object recIdentifier) {
        if (recIdentifier != null && !EMPTY_STRING.equals(recIdentifier)  && !"null".equalsIgnoreCase(recIdentifier.toString())){
            this.ff_id = (Double)recIdentifier;
        }
    }
    @JsonIgnore
    ...
    public void validateObject(int operation, SprBaseDBServiceImpl<?> baseService) throws SparkBusinessException{
      if (ff_fil_id_changed || operation == Utils.OPERATION_INSERT) {
         if (ff_fil_id== null) {
            throw new SparkBusinessException(new S2Message("NTIS_FACILITY_FILES", "FF_FIL_ID", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }else{
            if (ff_fil_id!= null && (""+ff_fil_id.intValue()).length()>10) {
               throw new SparkBusinessException(new S2Message("NTIS_FACILITY_FILES", "FF_FIL_ID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"10"));
            }
         }
      }
      if (ff_wtf_id_changed || operation == Utils.OPERATION_INSERT) {
         if (ff_wtf_id== null) {
            throw new SparkBusinessException(new S2Message("NTIS_FACILITY_FILES", "FF_WTF_ID", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }else{
            if (ff_wtf_id!= null && (""+ff_wtf_id.intValue()).length()>10) {
               throw new SparkBusinessException(new S2Message("NTIS_FACILITY_FILES", "FF_WTF_ID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"10"));
            }
         }
      }
      if (rec_version_changed || operation == Utils.OPERATION_INSERT) {
         if (rec_version!= null && (""+rec_version.intValue()).length()>6) {
            throw new SparkBusinessException(new S2Message("NTIS_FACILITY_FILES", "REC_VERSION", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"6"));
         }
      }
      if (rec_userid_changed || operation == Utils.OPERATION_INSERT) {
         if (rec_userid!= null && rec_userid.length()>128) {
            throw new SparkBusinessException(new S2Message("NTIS_FACILITY_FILES", "REC_USERID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"128"));
         }
      }
      if (c01_changed || operation == Utils.OPERATION_INSERT) {
         if (c01!= null && c01.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_FACILITY_FILES", "C01", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c02_changed || operation == Utils.OPERATION_INSERT) {
         if (c02!= null && c02.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_FACILITY_FILES", "C02", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c03_changed || operation == Utils.OPERATION_INSERT) {
         if (c03!= null && c03.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_FACILITY_FILES", "C03", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c04_changed || operation == Utils.OPERATION_INSERT) {
         if (c04!= null && c04.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_FACILITY_FILES", "C04", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c05_changed || operation == Utils.OPERATION_INSERT) {
         if (c05!= null && c05.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_FACILITY_FILES", "C05", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
   }
   ...
   public UpdateStatementPart constructUpdatePart(String userName) {
      ...
      String answer = "UPDATE NTIS_FACILITY_FILES SET ";
      boolean changedExists = false;      if (ff_fil_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"FF_FIL_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(ff_fil_id);
      }
      if (ff_wtf_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"FF_WTF_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(ff_wtf_id);
      }
      if (n01_changed) {
      ...
      answer = answer +" WHERE  FF_ID = ? ";
      updateStatementPart.addStatementParam(ff_id);
      updateStatementPart.setStatementPart(answer);
      return updateStatementPart;
   }
   public String toString() {
      return "{\"NtisFacilityFilesDAO\":{\"ff_id\": \""+getFf_id()+"\", \"ff_fil_id\": \""+getFf_fil_id()+"\", \"ff_wtf_id\": \""+getFf_wtf_id()+"\", \"rec_version\": \""+getRec_version()+"\", \"rec_create_timestamp\": \""+getRec_create_timestamp()+"\", \"rec_userid\": \""+getRec_userid()+"\", \"rec_timestamp\": \""+getRec_timestamp()+"\", \"n01\": \""+getN01()+"\", \"n02\": \""+getN02()+"\", \"n03\": \""+getN03()+"\", \"n04\": \""+getN04()+"\", \"n05\": \""+getN05()+"\", \"c01\": \""+getC01()+"\", \"c02\": \""+getC02()+"\", \"c03\": \""+getC03()+"\", \"c04\": \""+getC04()+"\", \"c05\": \""+getC05()+"\", \"d01\": \""+getD01()+"\", \"d02\": \""+getD02()+"\", \"d03\": \""+getD03()+"\", \"d04\": \""+getD04()+"\", \"d05\": \""+getD05()+"\"}}";
   }

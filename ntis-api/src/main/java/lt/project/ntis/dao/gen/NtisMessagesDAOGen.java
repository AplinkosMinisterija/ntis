...
public class NtisMessagesDAOGen extends SprBaseDAO{
   public static String IDENTIFIER="NTIS_MESSAGES.MES_ID";
   private Double mes_id;
   private String mes_subject;
   private String mes_description;
   private String mes_priority;
   private Date mes_created;
   private Double mes_cot_id;
   ...
   protected boolean mes_id_changed;
   protected boolean mes_subject_changed;
   protected boolean mes_description_changed;
   protected boolean mes_priority_changed;
   protected boolean mes_created_changed;
   protected boolean mes_cot_id_changed;
   ...
   public NtisMessagesDAOGen() {
      markObjectAsInitial();
      setRecordLoaded(false);
      setForceUpdate(false);
   }
   public NtisMessagesDAOGen(Double mes_id, String mes_subject, String mes_description, String mes_priority, Date mes_created, Double mes_cot_id, Double rec_version, Date rec_create_timestamp, String rec_userid, Date rec_timestamp, Double n01, Double n02, Double n03, Double n04, Double n05, String c01, String c02, String c03, String c04, String c05, Date d01, Date d02, Date d03, Date d04, Date d05) {
      this.mes_id = mes_id;
      this.mes_subject = mes_subject;
      this.mes_description = mes_description;
      this.mes_priority = mes_priority;
      this.mes_created = mes_created;
      this.mes_cot_id = mes_cot_id;
   ...
   public void copyValues(NtisMessagesDAOGen obj) {
      this.setMes_id(obj.getMes_id());
      this.setMes_subject(obj.getMes_subject());
      this.setMes_description(obj.getMes_description());
      this.setMes_priority(obj.getMes_priority());
      this.setMes_created(obj.getMes_created());
      this.setMes_cot_id(obj.getMes_cot_id());
   ...
   protected void markObjectAsInitial() {
      this.mes_id_changed = false;
      this.mes_subject_changed = false;
      this.mes_description_changed = false;
      this.mes_priority_changed = false;
      this.mes_created_changed = false;
      this.mes_cot_id_changed = false;
   ...
   public void setMes_id(Double mes_id) {
      if (this.isForceUpdate() || (this.mes_id != null && !this.mes_id.equals(mes_id)) || (mes_id != null && !mes_id.equals(this.mes_id))){
         this.mes_id_changed = true; 
         this.record_changed = true;
         this.mes_id = mes_id;
      }
   }
   public Double getMes_id() {
      return this.mes_id;
   }
   public void setMes_subject(String mes_subject) {
      if (this.isForceUpdate() || (this.mes_subject != null && !this.mes_subject.equals(mes_subject)) || (mes_subject != null && !mes_subject.equals(this.mes_subject))){
         this.mes_subject_changed = true; 
         this.record_changed = true;
         this.mes_subject = mes_subject;
      }
   }
   ...
   public void setMes_description(String mes_description) {
      if (this.isForceUpdate() || (this.mes_description != null && !this.mes_description.equals(mes_description)) || (mes_description != null && !mes_description.equals(this.mes_description))){
         this.mes_description_changed = true; 
         this.record_changed = true;
         this.mes_description = mes_description;
      }
   }
   public String getMes_description() {
      return this.mes_description;
   }
   public void setMes_priority(String mes_priority) {
      if (this.isForceUpdate() || (this.mes_priority != null && !this.mes_priority.equals(mes_priority)) || (mes_priority != null && !mes_priority.equals(this.mes_priority))){
         this.mes_priority_changed = true; 
         this.record_changed = true;
         this.mes_priority = mes_priority;
      }
   }
   public String getMes_priority() {
      return this.mes_priority;
   }
   public void setMes_created(Date mes_created) {
      if (this.isForceUpdate() || (this.mes_created != null && !this.mes_created.equals(mes_created)) || (mes_created != null && !mes_created.equals(this.mes_created))){
         this.mes_created_changed = true; 
         this.record_changed = true;
         this.mes_created = mes_created;
      }
   }
   public Date getMes_created() {
      return this.mes_created;
   }
   public void setMes_cot_id(Double mes_cot_id) {
      if (this.isForceUpdate() || (this.mes_cot_id != null && !this.mes_cot_id.equals(mes_cot_id)) || (mes_cot_id != null && !mes_cot_id.equals(this.mes_cot_id))){
         this.mes_cot_id_changed = true; 
         this.record_changed = true;
         this.mes_cot_id = mes_cot_id;
      }
   }
   public Double getMes_cot_id() {
      return this.mes_cot_id;
   }
   ...
   public Date getD05() {
    ...
    public void setRecordIdentifier(Object recIdentifier) {
        if (recIdentifier != null && !EMPTY_STRING.equals(recIdentifier)  && !"null".equalsIgnoreCase(recIdentifier.toString())){
            this.mes_id = (Double)recIdentifier;
        }
    }
    @JsonIgnore
    ...
    public void validateObject(int operation, SprBaseDBServiceImpl<?> baseService) throws SparkBusinessException{
      if (mes_subject_changed || operation == Utils.OPERATION_INSERT) {
         if (mes_subject== null || EMPTY_STRING.equals(mes_subject)) {
            throw new SparkBusinessException(new S2Message("NTIS_MESSAGES", "MES_SUBJECT", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }else{
            if (mes_subject!= null && mes_subject.length()>50) {
               throw new SparkBusinessException(new S2Message("NTIS_MESSAGES", "MES_SUBJECT", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"50"));
            }
         }
      }
      if (mes_description_changed || operation == Utils.OPERATION_INSERT) {
         if (mes_description== null || EMPTY_STRING.equals(mes_description)) {
            throw new SparkBusinessException(new S2Message("NTIS_MESSAGES", "MES_DESCRIPTION", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }else{
            if (mes_description!= null && mes_description.length()>200) {
               throw new SparkBusinessException(new S2Message("NTIS_MESSAGES", "MES_DESCRIPTION", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"200"));
            }
         }
      }
      if (mes_priority_changed || operation == Utils.OPERATION_INSERT) {
         if (mes_priority!= null && mes_priority.length()>20) {
            throw new SparkBusinessException(new S2Message("NTIS_MESSAGES", "MES_PRIORITY", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"20"));
         }
      }
      if (mes_created_changed || operation == Utils.OPERATION_INSERT) {
         if (mes_created== null) {
            throw new SparkBusinessException(new S2Message("NTIS_MESSAGES", "MES_CREATED", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }
      }
      if (mes_cot_id_changed || operation == Utils.OPERATION_INSERT) {
         if (mes_cot_id!= null && (""+mes_cot_id.intValue()).length()>10) {
            throw new SparkBusinessException(new S2Message("NTIS_MESSAGES", "MES_COT_ID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"10"));
         }
      }
      if (rec_version_changed || operation == Utils.OPERATION_INSERT) {
         if (rec_version!= null && (""+rec_version.intValue()).length()>6) {
            throw new SparkBusinessException(new S2Message("NTIS_MESSAGES", "REC_VERSION", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"6"));
         }
      }
      if (rec_userid_changed || operation == Utils.OPERATION_INSERT) {
         if (rec_userid!= null && rec_userid.length()>128) {
            throw new SparkBusinessException(new S2Message("NTIS_MESSAGES", "REC_USERID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"128"));
         }
      }
      if (c01_changed || operation == Utils.OPERATION_INSERT) {
         if (c01!= null && c01.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_MESSAGES", "C01", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c02_changed || operation == Utils.OPERATION_INSERT) {
         if (c02!= null && c02.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_MESSAGES", "C02", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c03_changed || operation == Utils.OPERATION_INSERT) {
         if (c03!= null && c03.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_MESSAGES", "C03", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c04_changed || operation == Utils.OPERATION_INSERT) {
         if (c04!= null && c04.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_MESSAGES", "C04", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c05_changed || operation == Utils.OPERATION_INSERT) {
         if (c05!= null && c05.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_MESSAGES", "C05", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
   }
   ...
   public UpdateStatementPart constructUpdatePart(String userName) {
      ...
      String answer = "UPDATE NTIS_MESSAGES SET ";
      boolean changedExists = false;      if (mes_subject_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"MES_SUBJECT = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(mes_subject);
      }
      if (mes_description_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"MES_DESCRIPTION = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(mes_description);
      }
      if (mes_priority_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"MES_PRIORITY = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(mes_priority);
      }
      if (mes_created_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"MES_CREATED = ? ";
         changedExists = true;
         updateStatementPart.addStatementTimestampParam(mes_created);
      }
      if (mes_cot_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"MES_COT_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(mes_cot_id);
      }
      if (n01_changed) {
      ...
      answer = answer +" WHERE  MES_ID = ? ";
      updateStatementPart.addStatementParam(mes_id);
      updateStatementPart.setStatementPart(answer);
      return updateStatementPart;
   }
   public String toString() {
      return "{\"NtisMessagesDAO\":{\"mes_id\": \""+getMes_id()+"\", \"mes_subject\": \""+getMes_subject()+"\", \"mes_description\": \""+getMes_description()+"\", \"mes_priority\": \""+getMes_priority()+"\", \"mes_created\": \""+getMes_created()+"\", \"mes_cot_id\": \""+getMes_cot_id()+"\", \"rec_version\": \""+getRec_version()+"\", \"rec_create_timestamp\": \""+getRec_create_timestamp()+"\", \"rec_userid\": \""+getRec_userid()+"\", \"rec_timestamp\": \""+getRec_timestamp()+"\", \"n01\": \""+getN01()+"\", \"n02\": \""+getN02()+"\", \"n03\": \""+getN03()+"\", \"n04\": \""+getN04()+"\", \"n05\": \""+getN05()+"\", \"c01\": \""+getC01()+"\", \"c02\": \""+getC02()+"\", \"c03\": \""+getC03()+"\", \"c04\": \""+getC04()+"\", \"c05\": \""+getC05()+"\", \"d01\": \""+getD01()+"\", \"d02\": \""+getD02()+"\", \"d03\": \""+getD03()+"\", \"d04\": \""+getD04()+"\", \"d05\": \""+getD05()+"\"}}";
   }

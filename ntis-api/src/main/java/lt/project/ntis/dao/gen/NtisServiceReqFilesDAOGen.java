...
public class NtisServiceReqFilesDAOGen extends SprBaseDAO{
   public static String IDENTIFIER="NTIS_SERVICE_REQ_FILES.SRF_ID";
   private Double srf_id;
   private Double srf_sr_id;
   private Double srf_fil_id;
   ...
   protected boolean srf_id_changed;
   protected boolean srf_sr_id_changed;
   protected boolean srf_fil_id_changed;
   ...
   public NtisServiceReqFilesDAOGen() {
      markObjectAsInitial();
      setRecordLoaded(false);
      setForceUpdate(false);
   }
   public NtisServiceReqFilesDAOGen(Double srf_id, Double srf_sr_id, Double srf_fil_id, Double rec_version, Date rec_create_timestamp, String rec_userid, Date rec_timestamp, Double n01, Double n02, Double n03, Double n04, Double n05, String c01, String c02, String c03, String c04, String c05, Date d01, Date d02, Date d03, Date d04, Date d05) {
      this.srf_id = srf_id;
      this.srf_sr_id = srf_sr_id;
      this.srf_fil_id = srf_fil_id;
   ...
   public void copyValues(NtisServiceReqFilesDAOGen obj) {
      this.setSrf_id(obj.getSrf_id());
      this.setSrf_sr_id(obj.getSrf_sr_id());
      this.setSrf_fil_id(obj.getSrf_fil_id());
   ...
   protected void markObjectAsInitial() {
      this.srf_id_changed = false;
      this.srf_sr_id_changed = false;
      this.srf_fil_id_changed = false;
   ...
   public void setSrf_id(Double srf_id) {
      if (this.isForceUpdate() || (this.srf_id != null && !this.srf_id.equals(srf_id)) || (srf_id != null && !srf_id.equals(this.srf_id))){
         this.srf_id_changed = true; 
         this.record_changed = true;
         this.srf_id = srf_id;
      }
   }
   public Double getSrf_id() {
      return this.srf_id;
   }
   public void setSrf_sr_id(Double srf_sr_id) {
      if (this.isForceUpdate() || (this.srf_sr_id != null && !this.srf_sr_id.equals(srf_sr_id)) || (srf_sr_id != null && !srf_sr_id.equals(this.srf_sr_id))){
         this.srf_sr_id_changed = true; 
         this.record_changed = true;
         this.srf_sr_id = srf_sr_id;
      }
   }
   public Double getSrf_sr_id() {
      return this.srf_sr_id;
   }
   public void setSrf_fil_id(Double srf_fil_id) {
      if (this.isForceUpdate() || (this.srf_fil_id != null && !this.srf_fil_id.equals(srf_fil_id)) || (srf_fil_id != null && !srf_fil_id.equals(this.srf_fil_id))){
         this.srf_fil_id_changed = true; 
         this.record_changed = true;
         this.srf_fil_id = srf_fil_id;
      }
   }
   public Double getSrf_fil_id() {
      return this.srf_fil_id;
   }
   ...
   public Date getD05() {
    ...
    public void setRecordIdentifier(Object recIdentifier) {
        if (recIdentifier != null && !EMPTY_STRING.equals(recIdentifier)  && !"null".equalsIgnoreCase(recIdentifier.toString())){
            this.srf_id = (Double)recIdentifier;
        }
    }
    @JsonIgnore
    ...
    public void validateObject(int operation, SprBaseDBServiceImpl<?> baseService) throws SparkBusinessException{
      if (srf_sr_id_changed || operation == Utils.OPERATION_INSERT) {
         if (srf_sr_id== null) {
            throw new SparkBusinessException(new S2Message("NTIS_SERVICE_REQ_FILES", "SRF_SR_ID", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }else{
            if (srf_sr_id!= null && (""+srf_sr_id.intValue()).length()>10) {
               throw new SparkBusinessException(new S2Message("NTIS_SERVICE_REQ_FILES", "SRF_SR_ID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"10"));
            }
         }
      }
      if (srf_fil_id_changed || operation == Utils.OPERATION_INSERT) {
         if (srf_fil_id== null) {
            throw new SparkBusinessException(new S2Message("NTIS_SERVICE_REQ_FILES", "SRF_FIL_ID", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }else{
            if (srf_fil_id!= null && (""+srf_fil_id.intValue()).length()>10) {
               throw new SparkBusinessException(new S2Message("NTIS_SERVICE_REQ_FILES", "SRF_FIL_ID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"10"));
            }
         }
      }
      if (rec_version_changed || operation == Utils.OPERATION_INSERT) {
         if (rec_version!= null && (""+rec_version.intValue()).length()>6) {
            throw new SparkBusinessException(new S2Message("NTIS_SERVICE_REQ_FILES", "REC_VERSION", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"6"));
         }
      }
      if (rec_userid_changed || operation == Utils.OPERATION_INSERT) {
         if (rec_userid!= null && rec_userid.length()>128) {
            throw new SparkBusinessException(new S2Message("NTIS_SERVICE_REQ_FILES", "REC_USERID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"128"));
         }
      }
      if (c01_changed || operation == Utils.OPERATION_INSERT) {
         if (c01!= null && c01.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_SERVICE_REQ_FILES", "C01", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c02_changed || operation == Utils.OPERATION_INSERT) {
         if (c02!= null && c02.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_SERVICE_REQ_FILES", "C02", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c03_changed || operation == Utils.OPERATION_INSERT) {
         if (c03!= null && c03.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_SERVICE_REQ_FILES", "C03", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c04_changed || operation == Utils.OPERATION_INSERT) {
         if (c04!= null && c04.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_SERVICE_REQ_FILES", "C04", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c05_changed || operation == Utils.OPERATION_INSERT) {
         if (c05!= null && c05.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_SERVICE_REQ_FILES", "C05", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
   }
   ...
   public UpdateStatementPart constructUpdatePart(String userName) {
      ...
      String answer = "UPDATE NTIS_SERVICE_REQ_FILES SET ";
      boolean changedExists = false;      if (srf_sr_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"SRF_SR_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(srf_sr_id);
      }
      if (srf_fil_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"SRF_FIL_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(srf_fil_id);
      }
      if (n01_changed) {
      ...
      answer = answer +" WHERE  SRF_ID = ? ";
      updateStatementPart.addStatementParam(srf_id);
      updateStatementPart.setStatementPart(answer);
      return updateStatementPart;
   }
   public String toString() {
      return "{\"NtisServiceReqFilesDAO\":{\"srf_id\": \""+getSrf_id()+"\", \"srf_sr_id\": \""+getSrf_sr_id()+"\", \"srf_fil_id\": \""+getSrf_fil_id()+"\", \"rec_version\": \""+getRec_version()+"\", \"rec_create_timestamp\": \""+getRec_create_timestamp()+"\", \"rec_userid\": \""+getRec_userid()+"\", \"rec_timestamp\": \""+getRec_timestamp()+"\", \"n01\": \""+getN01()+"\", \"n02\": \""+getN02()+"\", \"n03\": \""+getN03()+"\", \"n04\": \""+getN04()+"\", \"n05\": \""+getN05()+"\", \"c01\": \""+getC01()+"\", \"c02\": \""+getC02()+"\", \"c03\": \""+getC03()+"\", \"c04\": \""+getC04()+"\", \"c05\": \""+getC05()+"\", \"d01\": \""+getD01()+"\", \"d02\": \""+getD02()+"\", \"d03\": \""+getD03()+"\", \"d04\": \""+getD04()+"\", \"d05\": \""+getD05()+"\"}}";
   }

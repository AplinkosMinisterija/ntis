...
public class NtisContractServicesDAOGen extends SprBaseDAO{
   public static String IDENTIFIER="NTIS_CONTRACT_SERVICES.CS_ID";
   private Double cs_id;
   private Double cs_price;
   private Double cs_srv_id;
   private Double cs_cot_id;
   ...
   protected boolean cs_id_changed;
   protected boolean cs_price_changed;
   protected boolean cs_srv_id_changed;
   protected boolean cs_cot_id_changed;
   ...
   public NtisContractServicesDAOGen() {
      markObjectAsInitial();
      setRecordLoaded(false);
      setForceUpdate(false);
   }
   public NtisContractServicesDAOGen(Double cs_id, Double cs_price, Double cs_srv_id, Double cs_cot_id, Double rec_version, Date rec_create_timestamp, String rec_userid, Date rec_timestamp, Double n01, Double n02, Double n03, Double n04, Double n05, String c01, String c02, String c03, String c04, String c05, Date d01, Date d02, Date d03, Date d04, Date d05) {
      this.cs_id = cs_id;
      this.cs_price = cs_price;
      this.cs_srv_id = cs_srv_id;
      this.cs_cot_id = cs_cot_id;
   ...
   public void copyValues(NtisContractServicesDAOGen obj) {
      this.setCs_id(obj.getCs_id());
      this.setCs_price(obj.getCs_price());
      this.setCs_srv_id(obj.getCs_srv_id());
      this.setCs_cot_id(obj.getCs_cot_id());
   ...
   protected void markObjectAsInitial() {
      this.cs_id_changed = false;
      this.cs_price_changed = false;
      this.cs_srv_id_changed = false;
      this.cs_cot_id_changed = false;
   ...
   public void setCs_id(Double cs_id) {
      if (this.isForceUpdate() || (this.cs_id != null && !this.cs_id.equals(cs_id)) || (cs_id != null && !cs_id.equals(this.cs_id))){
         this.cs_id_changed = true; 
   ...
   public void setCs_price(Double cs_price) {
      if (this.isForceUpdate() || (this.cs_price != null && !this.cs_price.equals(cs_price)) || (cs_price != null && !cs_price.equals(this.cs_price))){
         this.cs_price_changed = true; 
         this.record_changed = true;
         this.cs_price = cs_price;
      }
   }
   ...
   public void setCs_srv_id(Double cs_srv_id) {
      if (this.isForceUpdate() || (this.cs_srv_id != null && !this.cs_srv_id.equals(cs_srv_id)) || (cs_srv_id != null && !cs_srv_id.equals(this.cs_srv_id))){
         this.cs_srv_id_changed = true; 
         this.record_changed = true;
         this.cs_srv_id = cs_srv_id;
      }
   }
   public Double getCs_srv_id() {
      return this.cs_srv_id;
   }
   public void setCs_cot_id(Double cs_cot_id) {
      if (this.isForceUpdate() || (this.cs_cot_id != null && !this.cs_cot_id.equals(cs_cot_id)) || (cs_cot_id != null && !cs_cot_id.equals(this.cs_cot_id))){
         this.cs_cot_id_changed = true; 
         this.record_changed = true;
         this.cs_cot_id = cs_cot_id;
      }
   }
   public Double getCs_cot_id() {
      return this.cs_cot_id;
   }
   ...
   public Date getD05() {
    ...
    public void setRecordIdentifier(Object recIdentifier) {
        if (recIdentifier != null && !EMPTY_STRING.equals(recIdentifier)  && !"null".equalsIgnoreCase(recIdentifier.toString())){
            this.cs_id = (Double)recIdentifier;
        }
    }
    @JsonIgnore
    ...
    public void validateObject(int operation, SprBaseDBServiceImpl<?> baseService) throws SparkBusinessException{
      if (cs_price_changed || operation == Utils.OPERATION_INSERT) {
         if (cs_price!= null && (""+cs_price.intValue()).length()>12) {
            throw new SparkBusinessException(new S2Message("NTIS_CONTRACT_SERVICES", "CS_PRICE", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"12"));
         }
      }
      if (cs_srv_id_changed || operation == Utils.OPERATION_INSERT) {
         if (cs_srv_id== null) {
            throw new SparkBusinessException(new S2Message("NTIS_CONTRACT_SERVICES", "CS_SRV_ID", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }else{
            if (cs_srv_id!= null && (""+cs_srv_id.intValue()).length()>10) {
               throw new SparkBusinessException(new S2Message("NTIS_CONTRACT_SERVICES", "CS_SRV_ID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"10"));
            }
         }
      }
      if (cs_cot_id_changed || operation == Utils.OPERATION_INSERT) {
         if (cs_cot_id== null) {
            throw new SparkBusinessException(new S2Message("NTIS_CONTRACT_SERVICES", "CS_COT_ID", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }else{
            if (cs_cot_id!= null && (""+cs_cot_id.intValue()).length()>10) {
               throw new SparkBusinessException(new S2Message("NTIS_CONTRACT_SERVICES", "CS_COT_ID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"10"));
            }
         }
      }
      if (rec_version_changed || operation == Utils.OPERATION_INSERT) {
         if (rec_version!= null && (""+rec_version.intValue()).length()>6) {
            throw new SparkBusinessException(new S2Message("NTIS_CONTRACT_SERVICES", "REC_VERSION", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"6"));
         }
      }
      if (rec_userid_changed || operation == Utils.OPERATION_INSERT) {
         if (rec_userid!= null && rec_userid.length()>128) {
            throw new SparkBusinessException(new S2Message("NTIS_CONTRACT_SERVICES", "REC_USERID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"128"));
         }
      }
      if (c01_changed || operation == Utils.OPERATION_INSERT) {
         if (c01!= null && c01.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_CONTRACT_SERVICES", "C01", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c02_changed || operation == Utils.OPERATION_INSERT) {
         if (c02!= null && c02.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_CONTRACT_SERVICES", "C02", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c03_changed || operation == Utils.OPERATION_INSERT) {
         if (c03!= null && c03.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_CONTRACT_SERVICES", "C03", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c04_changed || operation == Utils.OPERATION_INSERT) {
         if (c04!= null && c04.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_CONTRACT_SERVICES", "C04", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c05_changed || operation == Utils.OPERATION_INSERT) {
         if (c05!= null && c05.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_CONTRACT_SERVICES", "C05", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
   }
   ...
   public UpdateStatementPart constructUpdatePart(String userName) {
      ...
      String answer = "UPDATE NTIS_CONTRACT_SERVICES SET ";
      boolean changedExists = false;      if (cs_price_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"CS_PRICE = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(cs_price);
      }
      if (cs_srv_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"CS_SRV_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(cs_srv_id);
      }
      if (cs_cot_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"CS_COT_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(cs_cot_id);
      }
      if (n01_changed) {

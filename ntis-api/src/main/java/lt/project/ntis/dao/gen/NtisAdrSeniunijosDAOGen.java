...
public class NtisAdrSeniunijosDAOGen extends SprBaseDAO{
   public static String IDENTIFIER="NTIS_ADR_SENIUNIJOS.SEN_ID";
   private Double sen_id;
   private String sen_code;
   private String sen_name;
   private String sen_municipality_code;
   private Date sen_date_from;
   private Date sen_date_to;
   ...
   protected boolean sen_id_changed;
   protected boolean sen_code_changed;
   protected boolean sen_name_changed;
   protected boolean sen_municipality_code_changed;
   protected boolean sen_date_from_changed;
   protected boolean sen_date_to_changed;
   ...
   public NtisAdrSeniunijosDAOGen() {
      markObjectAsInitial();
      setRecordLoaded(false);
      setForceUpdate(false);
   }
   public NtisAdrSeniunijosDAOGen(Double sen_id, String sen_code, String sen_name, String sen_municipality_code, Date sen_date_from, Date sen_date_to, Double rec_version, Date rec_create_timestamp, String rec_userid, Date rec_timestamp, Double n01, Double n02, Double n03, Double n04, Double n05, String c01, String c02, String c03, String c04, String c05, Date d01, Date d02, Date d03, Date d04, Date d05) {
      this.sen_id = sen_id;
      this.sen_code = sen_code;
      this.sen_name = sen_name;
      this.sen_municipality_code = sen_municipality_code;
      this.sen_date_from = sen_date_from;
      this.sen_date_to = sen_date_to;
   ...
   public void copyValues(NtisAdrSeniunijosDAOGen obj) {
      this.setSen_id(obj.getSen_id());
      this.setSen_code(obj.getSen_code());
      this.setSen_name(obj.getSen_name());
      this.setSen_municipality_code(obj.getSen_municipality_code());
      this.setSen_date_from(obj.getSen_date_from());
      this.setSen_date_to(obj.getSen_date_to());
   ...
   protected void markObjectAsInitial() {
      this.sen_id_changed = false;
      this.sen_code_changed = false;
      this.sen_name_changed = false;
      this.sen_municipality_code_changed = false;
      this.sen_date_from_changed = false;
      this.sen_date_to_changed = false;
   ...
   public void setSen_id(Double sen_id) {
      if (this.isForceUpdate() || (this.sen_id != null && !this.sen_id.equals(sen_id)) || (sen_id != null && !sen_id.equals(this.sen_id))){
         this.sen_id_changed = true; 
         this.record_changed = true;
         this.sen_id = sen_id;
      }
   }
   public Double getSen_id() {
      return this.sen_id;
   }
   public void setSen_code(String sen_code) {
      if (this.isForceUpdate() || (this.sen_code != null && !this.sen_code.equals(sen_code)) || (sen_code != null && !sen_code.equals(this.sen_code))){
         this.sen_code_changed = true; 
         this.record_changed = true;
         this.sen_code = sen_code;
      }
   }
   public String getSen_code() {
      return this.sen_code;
   }
   public void setSen_name(String sen_name) {
      if (this.isForceUpdate() || (this.sen_name != null && !this.sen_name.equals(sen_name)) || (sen_name != null && !sen_name.equals(this.sen_name))){
         this.sen_name_changed = true; 
         this.record_changed = true;
         this.sen_name = sen_name;
      }
   }
   ...
   public void setSen_municipality_code(String sen_municipality_code) {
      if (this.isForceUpdate() || (this.sen_municipality_code != null && !this.sen_municipality_code.equals(sen_municipality_code)) || (sen_municipality_code != null && !sen_municipality_code.equals(this.sen_municipality_code))){
         this.sen_municipality_code_changed = true; 
         this.record_changed = true;
         this.sen_municipality_code = sen_municipality_code;
      }
   }
   public String getSen_municipality_code() {
      return this.sen_municipality_code;
   }
   public void setSen_date_from(Date sen_date_from) {
      if (this.isForceUpdate() || (this.sen_date_from != null && !this.sen_date_from.equals(sen_date_from)) || (sen_date_from != null && !sen_date_from.equals(this.sen_date_from))){
         this.sen_date_from_changed = true; 
         this.record_changed = true;
         this.sen_date_from = sen_date_from;
      }
   }
   public Date getSen_date_from() {
      return this.sen_date_from;
   }
   public void setSen_date_to(Date sen_date_to) {
      if (this.isForceUpdate() || (this.sen_date_to != null && !this.sen_date_to.equals(sen_date_to)) || (sen_date_to != null && !sen_date_to.equals(this.sen_date_to))){
         this.sen_date_to_changed = true; 
         this.record_changed = true;
         this.sen_date_to = sen_date_to;
      }
   }
   public Date getSen_date_to() {
      return this.sen_date_to;
   }
   ...
   public Date getD05() {
    ...
    public void setRecordIdentifier(Object recIdentifier) {
        if (recIdentifier != null && !EMPTY_STRING.equals(recIdentifier)  && !"null".equalsIgnoreCase(recIdentifier.toString())){
            this.sen_id = (Double)recIdentifier;
        }
    }
    @JsonIgnore
    ...
    public void validateObject(int operation, SprBaseDBServiceImpl<?> baseService) throws SparkBusinessException{
      if (sen_code_changed || operation == Utils.OPERATION_INSERT) {
         if (sen_code== null || EMPTY_STRING.equals(sen_code)) {
            throw new SparkBusinessException(new S2Message("NTIS_ADR_SENIUNIJOS", "SEN_CODE", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }else{
            if (sen_code!= null && sen_code.length()>50) {
               throw new SparkBusinessException(new S2Message("NTIS_ADR_SENIUNIJOS", "SEN_CODE", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"50"));
            }
         }
      }
      if (sen_name_changed || operation == Utils.OPERATION_INSERT) {
         if (sen_name== null || EMPTY_STRING.equals(sen_name)) {
            throw new SparkBusinessException(new S2Message("NTIS_ADR_SENIUNIJOS", "SEN_NAME", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }else{
            if (sen_name!= null && sen_name.length()>200) {
               throw new SparkBusinessException(new S2Message("NTIS_ADR_SENIUNIJOS", "SEN_NAME", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"200"));
            }
         }
      }
      if (sen_municipality_code_changed || operation == Utils.OPERATION_INSERT) {
         if (sen_municipality_code== null || EMPTY_STRING.equals(sen_municipality_code)) {
            throw new SparkBusinessException(new S2Message("NTIS_ADR_SENIUNIJOS", "SEN_MUNICIPALITY_CODE", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }else{
            if (sen_municipality_code!= null && sen_municipality_code.length()>50) {
               throw new SparkBusinessException(new S2Message("NTIS_ADR_SENIUNIJOS", "SEN_MUNICIPALITY_CODE", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"50"));
            }
         }
      }
      if (sen_date_from_changed || operation == Utils.OPERATION_INSERT) {
         if (sen_date_from== null) {
            throw new SparkBusinessException(new S2Message("NTIS_ADR_SENIUNIJOS", "SEN_DATE_FROM", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }
      }
      if (rec_version_changed || operation == Utils.OPERATION_INSERT) {
         if (rec_version!= null && (""+rec_version.intValue()).length()>6) {
            throw new SparkBusinessException(new S2Message("NTIS_ADR_SENIUNIJOS", "REC_VERSION", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"6"));
         }
      }
      if (rec_userid_changed || operation == Utils.OPERATION_INSERT) {
         if (rec_userid!= null && rec_userid.length()>128) {
            throw new SparkBusinessException(new S2Message("NTIS_ADR_SENIUNIJOS", "REC_USERID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"128"));
         }
      }
      if (c01_changed || operation == Utils.OPERATION_INSERT) {
         if (c01!= null && c01.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_ADR_SENIUNIJOS", "C01", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c02_changed || operation == Utils.OPERATION_INSERT) {
         if (c02!= null && c02.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_ADR_SENIUNIJOS", "C02", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c03_changed || operation == Utils.OPERATION_INSERT) {
         if (c03!= null && c03.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_ADR_SENIUNIJOS", "C03", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c04_changed || operation == Utils.OPERATION_INSERT) {
         if (c04!= null && c04.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_ADR_SENIUNIJOS", "C04", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c05_changed || operation == Utils.OPERATION_INSERT) {
         if (c05!= null && c05.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_ADR_SENIUNIJOS", "C05", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
   }
   ...
   public UpdateStatementPart constructUpdatePart(String userName) {
      ...
      String answer = "UPDATE NTIS_ADR_SENIUNIJOS SET ";
      boolean changedExists = false;      if (sen_code_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"SEN_CODE = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(sen_code);
      }
      if (sen_name_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"SEN_NAME = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(sen_name);
      }
      if (sen_municipality_code_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"SEN_MUNICIPALITY_CODE = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(sen_municipality_code);
      }
      if (sen_date_from_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"SEN_DATE_FROM = ? ";
         changedExists = true;
         updateStatementPart.addStatementTimestampParam(sen_date_from);
      }
      if (sen_date_to_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"SEN_DATE_TO = ? ";
         changedExists = true;
         updateStatementPart.addStatementTimestampParam(sen_date_to);
      }
      if (n01_changed) {
      ...
      answer = answer +" WHERE  SEN_ID = ? ";
      updateStatementPart.addStatementParam(sen_id);
      updateStatementPart.setStatementPart(answer);
      return updateStatementPart;
   }
   public String toString() {
      return "{\"NtisAdrSeniunijosDAO\":{\"sen_id\": \""+getSen_id()+"\", \"sen_code\": \""+getSen_code()+"\", \"sen_name\": \""+getSen_name()+"\", \"sen_municipality_code\": \""+getSen_municipality_code()+"\", \"sen_date_from\": \""+getSen_date_from()+"\", \"sen_date_to\": \""+getSen_date_to()+"\", \"rec_version\": \""+getRec_version()+"\", \"rec_create_timestamp\": \""+getRec_create_timestamp()+"\", \"rec_userid\": \""+getRec_userid()+"\", \"rec_timestamp\": \""+getRec_timestamp()+"\", \"n01\": \""+getN01()+"\", \"n02\": \""+getN02()+"\", \"n03\": \""+getN03()+"\", \"n04\": \""+getN04()+"\", \"n05\": \""+getN05()+"\", \"c01\": \""+getC01()+"\", \"c02\": \""+getC02()+"\", \"c03\": \""+getC03()+"\", \"c04\": \""+getC04()+"\", \"c05\": \""+getC05()+"\", \"d01\": \""+getD01()+"\", \"d02\": \""+getD02()+"\", \"d03\": \""+getD03()+"\", \"d04\": \""+getD04()+"\", \"d05\": \""+getD05()+"\"}}";
   }

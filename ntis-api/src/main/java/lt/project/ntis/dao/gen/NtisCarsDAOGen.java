...
public class NtisCarsDAOGen extends SprBaseDAO{
   ...
   protected boolean cr_type_changed;
   ...
   public void copyValues(NtisCarsDAOGen obj) {
      ...
      this.setCr_type(obj.getCr_type());
   }
   protected void markObjectAsInitial() {
      ...
      this.cr_type_changed = false;
      this.record_changed = false;
   }
   public void setCr_id(Double cr_id) {
      if (this.isForceUpdate() || 
               (this.cr_id != null && !this.cr_id.equals(cr_id))  ||
               (cr_id != null && !cr_id.equals(this.cr_id)) ){
   ...
   public void setCr_reg_no(String cr_reg_no) {
      if (this.isForceUpdate() || 
               (this.cr_reg_no != null && !this.cr_reg_no.equals(cr_reg_no))  ||
               (cr_reg_no != null && !cr_reg_no.equals(this.cr_reg_no)) ){
   ...
   public void setCr_model(String cr_model) {
      if (this.isForceUpdate() || 
               (this.cr_model != null && !this.cr_model.equals(cr_model))  ||
               (cr_model != null && !cr_model.equals(this.cr_model)) ){
   ...
   public void setCr_capacity(Double cr_capacity) {
      if (this.isForceUpdate() || 
               (this.cr_capacity != null && !this.cr_capacity.equals(cr_capacity))  ||
               (cr_capacity != null && !cr_capacity.equals(this.cr_capacity)) ){
   ...
   public void setCr_tube_length(Double cr_tube_length) {
      if (this.isForceUpdate() || 
               (this.cr_tube_length != null && !this.cr_tube_length.equals(cr_tube_length))  ||
               (cr_tube_length != null && !cr_tube_length.equals(this.cr_tube_length)) ){
   ...
   public void setCr_date_from(Date cr_date_from) {
      if (this.isForceUpdate() || 
               (this.cr_date_from != null && (cr_date_from == null ||this.cr_date_from.compareTo(cr_date_from) != 0 )) ||
               (cr_date_from != null && (this.cr_date_from == null ||cr_date_from.compareTo(this.cr_date_from) != 0 ))){
   ...
   public void setCr_date_to(Date cr_date_to) {
      if (this.isForceUpdate() || 
               (this.cr_date_to != null && (cr_date_to == null ||this.cr_date_to.compareTo(cr_date_to) != 0 )) ||
               (cr_date_to != null && (this.cr_date_to == null ||cr_date_to.compareTo(this.cr_date_to) != 0 ))){
   ...
   public void setCr_org_id(Double cr_org_id) {
      if (this.isForceUpdate() || 
               (this.cr_org_id != null && !this.cr_org_id.equals(cr_org_id))  ||
               (cr_org_id != null && !cr_org_id.equals(this.cr_org_id)) ){
   ...
   public void setCr_type(String cr_type) {
      if (this.isForceUpdate() || 
               (this.cr_type != null && !this.cr_type.equals(cr_type))  ||
               (cr_type != null && !cr_type.equals(this.cr_type)) ){
         this.cr_type_changed = true; 
         this.record_changed = true;
         this.cr_type = cr_type;
      }
   }
    ...
    public void validateObject(int operation, SprBaseDBServiceImpl<?> baseService) throws SparkBusinessException{
      ...
      if (cr_capacity_changed || operation == Utils.OPERATION_INSERT) {
         if (cr_capacity== null) {
            ...
            if (cr_capacity!= null && cr_capacity.toString().length()>12) {
      ...
      if (cr_type_changed || operation == Utils.OPERATION_INSERT) {
         if (cr_type!= null && cr_type.length()>100) {
            throw new SparkBusinessException(new S2Message("NTIS_CARS", "CR_TYPE", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"100"));
         }
      }
   }
   ...
   public UpdateStatementPart constructUpdatePart(String userName) {
      ...
      if (cr_type_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"CR_TYPE = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(cr_type);
      }

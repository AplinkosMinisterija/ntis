...
public class NtisFavoriteSrvProvidersDAOGen extends SprBaseDAO{
   public static String IDENTIFIER="NTIS_FAVORITE_SRV_PROVIDERS.FSP_ID";
   private Double fsp_id;
   private Double fsp_org_id;
   private Double fsp_org_id_favorite;
   ...
   protected boolean fsp_id_changed;
   protected boolean fsp_org_id_changed;
   protected boolean fsp_org_id_favorite_changed;
   ...
   public NtisFavoriteSrvProvidersDAOGen() {
      markObjectAsInitial();
      setRecordLoaded(false);
      setForceUpdate(false);
   }
   public NtisFavoriteSrvProvidersDAOGen(Double fsp_id, Double fsp_org_id, Double fsp_org_id_favorite, Double rec_version, Date rec_create_timestamp, String rec_userid, Date rec_timestamp, Double n01, Double n02, Double n03, Double n04, Double n05, String c01, String c02, String c03, String c04, String c05, Date d01, Date d02, Date d03, Date d04, Date d05) {
      this.fsp_id = fsp_id;
      this.fsp_org_id = fsp_org_id;
      this.fsp_org_id_favorite = fsp_org_id_favorite;
   ...
   public void copyValues(NtisFavoriteSrvProvidersDAOGen obj) {
      this.setFsp_id(obj.getFsp_id());
      this.setFsp_org_id(obj.getFsp_org_id());
      this.setFsp_org_id_favorite(obj.getFsp_org_id_favorite());
   ...
   protected void markObjectAsInitial() {
      this.fsp_id_changed = false;
      this.fsp_org_id_changed = false;
      this.fsp_org_id_favorite_changed = false;
   ...
   public void setFsp_id(Double fsp_id) {
      if (this.isForceUpdate() || (this.fsp_id != null && !this.fsp_id.equals(fsp_id)) || (fsp_id != null && !fsp_id.equals(this.fsp_id))){
         this.fsp_id_changed = true; 
         this.record_changed = true;
         this.fsp_id = fsp_id;
      }
   }
   public Double getFsp_id() {
      return this.fsp_id;
   }
   public void setFsp_org_id(Double fsp_org_id) {
      if (this.isForceUpdate() || (this.fsp_org_id != null && !this.fsp_org_id.equals(fsp_org_id)) || (fsp_org_id != null && !fsp_org_id.equals(this.fsp_org_id))){
         this.fsp_org_id_changed = true; 
         this.record_changed = true;
         this.fsp_org_id = fsp_org_id;
      }
   }
   public Double getFsp_org_id() {
      return this.fsp_org_id;
   }
   public void setFsp_org_id_favorite(Double fsp_org_id_favorite) {
      if (this.isForceUpdate() || (this.fsp_org_id_favorite != null && !this.fsp_org_id_favorite.equals(fsp_org_id_favorite)) || (fsp_org_id_favorite != null && !fsp_org_id_favorite.equals(this.fsp_org_id_favorite))){
         this.fsp_org_id_favorite_changed = true; 
         this.record_changed = true;
         this.fsp_org_id_favorite = fsp_org_id_favorite;
      }
   }
   public Double getFsp_org_id_favorite() {
      return this.fsp_org_id_favorite;
   }
   ...
   public Date getD05() {
    ...
    public void setRecordIdentifier(Object recIdentifier) {
        if (recIdentifier != null && !EMPTY_STRING.equals(recIdentifier)  && !"null".equalsIgnoreCase(recIdentifier.toString())){
            this.fsp_id = (Double)recIdentifier;
        }
    }
    @JsonIgnore
    ...
    public void validateObject(int operation, SprBaseDBServiceImpl<?> baseService) throws SparkBusinessException{
      if (fsp_org_id_changed || operation == Utils.OPERATION_INSERT) {
         if (fsp_org_id!= null && (""+fsp_org_id.intValue()).length()>10) {
            throw new SparkBusinessException(new S2Message("NTIS_FAVORITE_SRV_PROVIDERS", "FSP_ORG_ID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"10"));
         }
      }
      if (fsp_org_id_favorite_changed || operation == Utils.OPERATION_INSERT) {
         if (fsp_org_id_favorite!= null && (""+fsp_org_id_favorite.intValue()).length()>10) {
            throw new SparkBusinessException(new S2Message("NTIS_FAVORITE_SRV_PROVIDERS", "FSP_ORG_ID_FAVORITE", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"10"));
         }
      }
      if (rec_version_changed || operation == Utils.OPERATION_INSERT) {
         if (rec_version!= null && (""+rec_version.intValue()).length()>6) {
            throw new SparkBusinessException(new S2Message("NTIS_FAVORITE_SRV_PROVIDERS", "REC_VERSION", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"6"));
         }
      }
      if (rec_userid_changed || operation == Utils.OPERATION_INSERT) {
         if (rec_userid!= null && rec_userid.length()>128) {
            throw new SparkBusinessException(new S2Message("NTIS_FAVORITE_SRV_PROVIDERS", "REC_USERID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"128"));
         }
      }
      if (c01_changed || operation == Utils.OPERATION_INSERT) {
         if (c01!= null && c01.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_FAVORITE_SRV_PROVIDERS", "C01", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c02_changed || operation == Utils.OPERATION_INSERT) {
         if (c02!= null && c02.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_FAVORITE_SRV_PROVIDERS", "C02", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c03_changed || operation == Utils.OPERATION_INSERT) {
         if (c03!= null && c03.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_FAVORITE_SRV_PROVIDERS", "C03", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c04_changed || operation == Utils.OPERATION_INSERT) {
         if (c04!= null && c04.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_FAVORITE_SRV_PROVIDERS", "C04", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c05_changed || operation == Utils.OPERATION_INSERT) {
         if (c05!= null && c05.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_FAVORITE_SRV_PROVIDERS", "C05", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
   }
   ...
   public UpdateStatementPart constructUpdatePart(String userName) {
      ...
      String answer = "UPDATE NTIS_FAVORITE_SRV_PROVIDERS SET ";
      boolean changedExists = false;      if (fsp_org_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"FSP_ORG_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(fsp_org_id);
      }
      if (fsp_org_id_favorite_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"FSP_ORG_ID_FAVORITE = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(fsp_org_id_favorite);
      }
      if (n01_changed) {
      ...
      answer = answer +" WHERE  FSP_ID = ? ";
      updateStatementPart.addStatementParam(fsp_id);
      updateStatementPart.setStatementPart(answer);
      return updateStatementPart;
   }
   public String toString() {
      return "{\"NtisFavoriteSrvProvidersDAO\":{\"fsp_id\": \""+getFsp_id()+"\", \"fsp_org_id\": \""+getFsp_org_id()+"\", \"fsp_org_id_favorite\": \""+getFsp_org_id_favorite()+"\", \"rec_version\": \""+getRec_version()+"\", \"rec_create_timestamp\": \""+getRec_create_timestamp()+"\", \"rec_userid\": \""+getRec_userid()+"\", \"rec_timestamp\": \""+getRec_timestamp()+"\", \"n01\": \""+getN01()+"\", \"n02\": \""+getN02()+"\", \"n03\": \""+getN03()+"\", \"n04\": \""+getN04()+"\", \"n05\": \""+getN05()+"\", \"c01\": \""+getC01()+"\", \"c02\": \""+getC02()+"\", \"c03\": \""+getC03()+"\", \"c04\": \""+getC04()+"\", \"c05\": \""+getC05()+"\", \"d01\": \""+getD01()+"\", \"d02\": \""+getD02()+"\", \"d03\": \""+getD03()+"\", \"d04\": \""+getD04()+"\", \"d05\": \""+getD05()+"\"}}";
   }

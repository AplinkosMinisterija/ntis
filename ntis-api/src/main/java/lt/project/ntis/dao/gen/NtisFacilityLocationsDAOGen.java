...
public class NtisFacilityLocationsDAOGen extends SprBaseDAO{
   public static String IDENTIFIER="NTIS_FACILITY_LOCATIONS.FL_ID";
   private Double fl_id;
   private Double fl_coordinate_latitude;
   private Double fl_coordinate_longitude;
   private Double fl_ad_id;
   private Double fl_wtf_id;
   ...
   protected boolean fl_id_changed;
   protected boolean fl_coordinate_latitude_changed;
   protected boolean fl_coordinate_longitude_changed;
   protected boolean fl_ad_id_changed;
   protected boolean fl_wtf_id_changed;
   ...
   public NtisFacilityLocationsDAOGen() {
      markObjectAsInitial();
      setRecordLoaded(false);
      setForceUpdate(false);
   }
   public NtisFacilityLocationsDAOGen(Double fl_id, Double fl_coordinate_latitude, Double fl_coordinate_longitude, Double fl_ad_id, Double fl_wtf_id, Double rec_version, Date rec_create_timestamp, String rec_userid, Date rec_timestamp, Double n01, Double n02, Double n03, Double n04, Double n05, String c01, String c02, String c03, String c04, String c05, Date d01, Date d02, Date d03, Date d04, Date d05) {
      this.fl_id = fl_id;
      this.fl_coordinate_latitude = fl_coordinate_latitude;
      this.fl_coordinate_longitude = fl_coordinate_longitude;
      this.fl_ad_id = fl_ad_id;
      this.fl_wtf_id = fl_wtf_id;
   ...
   public void copyValues(NtisFacilityLocationsDAOGen obj) {
      this.setFl_id(obj.getFl_id());
      this.setFl_coordinate_latitude(obj.getFl_coordinate_latitude());
      this.setFl_coordinate_longitude(obj.getFl_coordinate_longitude());
      this.setFl_ad_id(obj.getFl_ad_id());
      this.setFl_wtf_id(obj.getFl_wtf_id());
   ...
   protected void markObjectAsInitial() {
      this.fl_id_changed = false;
      this.fl_coordinate_latitude_changed = false;
      this.fl_coordinate_longitude_changed = false;
      this.fl_ad_id_changed = false;
      this.fl_wtf_id_changed = false;
   ...
   public void setFl_id(Double fl_id) {
      if (this.isForceUpdate() || (this.fl_id != null && !this.fl_id.equals(fl_id)) || (fl_id != null && !fl_id.equals(this.fl_id))){
         this.fl_id_changed = true; 
         this.record_changed = true;
         this.fl_id = fl_id;
      }
   }
   public Double getFl_id() {
      return this.fl_id;
   }
   public void setFl_coordinate_latitude(Double fl_coordinate_latitude) {
      if (this.isForceUpdate() || (this.fl_coordinate_latitude != null && !this.fl_coordinate_latitude.equals(fl_coordinate_latitude)) || (fl_coordinate_latitude != null && !fl_coordinate_latitude.equals(this.fl_coordinate_latitude))){
         this.fl_coordinate_latitude_changed = true; 
         this.record_changed = true;
         this.fl_coordinate_latitude = fl_coordinate_latitude;
      }
   }
   public Double getFl_coordinate_latitude() {
      return this.fl_coordinate_latitude;
   }
   public void setFl_coordinate_longitude(Double fl_coordinate_longitude) {
      if (this.isForceUpdate() || (this.fl_coordinate_longitude != null && !this.fl_coordinate_longitude.equals(fl_coordinate_longitude)) || (fl_coordinate_longitude != null && !fl_coordinate_longitude.equals(this.fl_coordinate_longitude))){
         this.fl_coordinate_longitude_changed = true; 
         this.record_changed = true;
         this.fl_coordinate_longitude = fl_coordinate_longitude;
      }
   }
   public Double getFl_coordinate_longitude() {
      return this.fl_coordinate_longitude;
   }
   public void setFl_ad_id(Double fl_ad_id) {
      if (this.isForceUpdate() || (this.fl_ad_id != null && !this.fl_ad_id.equals(fl_ad_id)) || (fl_ad_id != null && !fl_ad_id.equals(this.fl_ad_id))){
         this.fl_ad_id_changed = true; 
         this.record_changed = true;
         this.fl_ad_id = fl_ad_id;
      }
   }
   public Double getFl_ad_id() {
      return this.fl_ad_id;
   }
   public void setFl_wtf_id(Double fl_wtf_id) {
      if (this.isForceUpdate() || (this.fl_wtf_id != null && !this.fl_wtf_id.equals(fl_wtf_id)) || (fl_wtf_id != null && !fl_wtf_id.equals(this.fl_wtf_id))){
         this.fl_wtf_id_changed = true; 
         this.record_changed = true;
         this.fl_wtf_id = fl_wtf_id;
      }
   }
   public Double getFl_wtf_id() {
      return this.fl_wtf_id;
   }
   ...
   public Date getD05() {
    ...
    public void setRecordIdentifier(Object recIdentifier) {
        if (recIdentifier != null && !EMPTY_STRING.equals(recIdentifier)  && !"null".equalsIgnoreCase(recIdentifier.toString())){
            this.fl_id = (Double)recIdentifier;
        }
    }
    @JsonIgnore
    ...
    public void validateObject(int operation, SprBaseDBServiceImpl<?> baseService) throws SparkBusinessException{
      if (fl_coordinate_latitude_changed || operation == Utils.OPERATION_INSERT) {
         if (fl_coordinate_latitude== null) {
            throw new SparkBusinessException(new S2Message("NTIS_FACILITY_LOCATIONS", "FL_COORDINATE_LATITUDE", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }else{
            if (fl_coordinate_latitude!= null && (""+fl_coordinate_latitude.intValue()).length()>12) {
               throw new SparkBusinessException(new S2Message("NTIS_FACILITY_LOCATIONS", "FL_COORDINATE_LATITUDE", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"12"));
            }
         }
      }
      if (fl_coordinate_longitude_changed || operation == Utils.OPERATION_INSERT) {
         if (fl_coordinate_longitude== null) {
            throw new SparkBusinessException(new S2Message("NTIS_FACILITY_LOCATIONS", "FL_COORDINATE_LONGITUDE", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }else{
            if (fl_coordinate_longitude!= null && (""+fl_coordinate_longitude.intValue()).length()>12) {
               throw new SparkBusinessException(new S2Message("NTIS_FACILITY_LOCATIONS", "FL_COORDINATE_LONGITUDE", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"12"));
            }
         }
      }
      if (fl_ad_id_changed || operation == Utils.OPERATION_INSERT) {
         if (fl_ad_id!= null && (""+fl_ad_id.intValue()).length()>10) {
            throw new SparkBusinessException(new S2Message("NTIS_FACILITY_LOCATIONS", "FL_AD_ID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"10"));
         }
      }
      if (fl_wtf_id_changed || operation == Utils.OPERATION_INSERT) {
         if (fl_wtf_id== null) {
            throw new SparkBusinessException(new S2Message("NTIS_FACILITY_LOCATIONS", "FL_WTF_ID", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }else{
            if (fl_wtf_id!= null && (""+fl_wtf_id.intValue()).length()>10) {
               throw new SparkBusinessException(new S2Message("NTIS_FACILITY_LOCATIONS", "FL_WTF_ID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"10"));
            }
         }
      }
      if (rec_version_changed || operation == Utils.OPERATION_INSERT) {
         if (rec_version!= null && (""+rec_version.intValue()).length()>6) {
            throw new SparkBusinessException(new S2Message("NTIS_FACILITY_LOCATIONS", "REC_VERSION", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"6"));
         }
      }
      if (rec_userid_changed || operation == Utils.OPERATION_INSERT) {
         if (rec_userid!= null && rec_userid.length()>128) {
            throw new SparkBusinessException(new S2Message("NTIS_FACILITY_LOCATIONS", "REC_USERID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"128"));
         }
      }
      if (c01_changed || operation == Utils.OPERATION_INSERT) {
         if (c01!= null && c01.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_FACILITY_LOCATIONS", "C01", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c02_changed || operation == Utils.OPERATION_INSERT) {
         if (c02!= null && c02.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_FACILITY_LOCATIONS", "C02", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c03_changed || operation == Utils.OPERATION_INSERT) {
         if (c03!= null && c03.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_FACILITY_LOCATIONS", "C03", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c04_changed || operation == Utils.OPERATION_INSERT) {
         if (c04!= null && c04.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_FACILITY_LOCATIONS", "C04", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c05_changed || operation == Utils.OPERATION_INSERT) {
         if (c05!= null && c05.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_FACILITY_LOCATIONS", "C05", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
   }
   ...
   public UpdateStatementPart constructUpdatePart(String userName) {
      ...
      String answer = "UPDATE NTIS_FACILITY_LOCATIONS SET ";
      boolean changedExists = false;      if (fl_coordinate_latitude_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"FL_COORDINATE_LATITUDE = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(fl_coordinate_latitude);
      }
      if (fl_coordinate_longitude_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"FL_COORDINATE_LONGITUDE = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(fl_coordinate_longitude);
      }
      if (fl_ad_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"FL_AD_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(fl_ad_id);
      }
      if (fl_wtf_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"FL_WTF_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(fl_wtf_id);
      }
      if (n01_changed) {
      ...
      answer = answer +" WHERE  FL_ID = ? ";
      updateStatementPart.addStatementParam(fl_id);
      updateStatementPart.setStatementPart(answer);
      return updateStatementPart;
   }
   public String toString() {
      return "{\"NtisFacilityLocationsDAO\":{\"fl_id\": \""+getFl_id()+"\", \"fl_coordinate_latitude\": \""+getFl_coordinate_latitude()+"\", \"fl_coordinate_longitude\": \""+getFl_coordinate_longitude()+"\", \"fl_ad_id\": \""+getFl_ad_id()+"\", \"fl_wtf_id\": \""+getFl_wtf_id()+"\", \"rec_version\": \""+getRec_version()+"\", \"rec_create_timestamp\": \""+getRec_create_timestamp()+"\", \"rec_userid\": \""+getRec_userid()+"\", \"rec_timestamp\": \""+getRec_timestamp()+"\", \"n01\": \""+getN01()+"\", \"n02\": \""+getN02()+"\", \"n03\": \""+getN03()+"\", \"n04\": \""+getN04()+"\", \"n05\": \""+getN05()+"\", \"c01\": \""+getC01()+"\", \"c02\": \""+getC02()+"\", \"c03\": \""+getC03()+"\", \"c04\": \""+getC04()+"\", \"c05\": \""+getC05()+"\", \"d01\": \""+getD01()+"\", \"d02\": \""+getD02()+"\", \"d03\": \""+getD03()+"\", \"d04\": \""+getD04()+"\", \"d05\": \""+getD05()+"\"}}";
   }

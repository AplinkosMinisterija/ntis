...
public class NtisUsedSludgesDAOGen extends SprBaseDAO{
   public static String IDENTIFIER="NTIS_USED_SLUDGES.US_ID";
   private Double us_id;
   private Double us_wtf_id;
   private Double us_wd_id;
   ...
   protected boolean us_id_changed;
   protected boolean us_wtf_id_changed;
   protected boolean us_wd_id_changed;
   ...
   public NtisUsedSludgesDAOGen() {
      markObjectAsInitial();
      setRecordLoaded(false);
      setForceUpdate(false);
   }
   public NtisUsedSludgesDAOGen(Double us_id, Double us_wtf_id, Double us_wd_id, Double rec_version, Date rec_create_timestamp, String rec_userid, Date rec_timestamp, Double n01, Double n02, Double n03, Double n04, Double n05, String c01, String c02, String c03, String c04, String c05, Date d01, Date d02, Date d03, Date d04, Date d05) {
      this.us_id = us_id;
      this.us_wtf_id = us_wtf_id;
   ...
   public void copyValues(NtisUsedSludgesDAOGen obj) {
      this.setUs_id(obj.getUs_id());
      this.setUs_wtf_id(obj.getUs_wtf_id());
      this.setUs_wd_id(obj.getUs_wd_id());
   ...
   protected void markObjectAsInitial() {
      this.us_id_changed = false;
      this.us_wtf_id_changed = false;
      this.us_wd_id_changed = false;
   ...
   public void setUs_id(Double us_id) {
      if (this.isForceUpdate() || (this.us_id != null && !this.us_id.equals(us_id)) || (us_id != null && !us_id.equals(this.us_id))){
         this.us_id_changed = true; 
         this.record_changed = true;
         this.us_id = us_id;
      }
   }
   public Double getUs_id() {
      return this.us_id;
   }
   public void setUs_wtf_id(Double us_wtf_id) {
      if (this.isForceUpdate() || (this.us_wtf_id != null && !this.us_wtf_id.equals(us_wtf_id)) || (us_wtf_id != null && !us_wtf_id.equals(this.us_wtf_id))){
         this.us_wtf_id_changed = true; 
         this.record_changed = true;
         this.us_wtf_id = us_wtf_id;
      }
   }
   public Double getUs_wtf_id() {
      return this.us_wtf_id;
   }
   public void setUs_wd_id(Double us_wd_id) {
      if (this.isForceUpdate() || (this.us_wd_id != null && !this.us_wd_id.equals(us_wd_id)) || (us_wd_id != null && !us_wd_id.equals(this.us_wd_id))){
         this.us_wd_id_changed = true; 
         this.record_changed = true;
         this.us_wd_id = us_wd_id;
      }
   }
   public Double getUs_wd_id() {
      return this.us_wd_id;
   }
   ...
   public Date getD05() {
    ...
    public void setRecordIdentifier(Object recIdentifier) {
        if (recIdentifier != null && !EMPTY_STRING.equals(recIdentifier)  && !"null".equalsIgnoreCase(recIdentifier.toString())){
            this.us_id = (Double)recIdentifier;
        }
    }
    @JsonIgnore
    ...
    public void validateObject(int operation, SprBaseDBServiceImpl<?> baseService) throws SparkBusinessException{
      if (us_wtf_id_changed || operation == Utils.OPERATION_INSERT) {
         if (us_wtf_id!= null && (""+us_wtf_id.intValue()).length()>10) {
            throw new SparkBusinessException(new S2Message("NTIS_USED_SLUDGES", "US_WTF_ID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"10"));
         }
      }
      if (us_wd_id_changed || operation == Utils.OPERATION_INSERT) {
         if (us_wd_id!= null && (""+us_wd_id.intValue()).length()>10) {
            throw new SparkBusinessException(new S2Message("NTIS_USED_SLUDGES", "US_WD_ID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"10"));
         }
      }
      if (rec_version_changed || operation == Utils.OPERATION_INSERT) {
         if (rec_version!= null && (""+rec_version.intValue()).length()>6) {
            throw new SparkBusinessException(new S2Message("NTIS_USED_SLUDGES", "REC_VERSION", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"6"));
         }
      }
      if (rec_userid_changed || operation == Utils.OPERATION_INSERT) {
         if (rec_userid!= null && rec_userid.length()>128) {
            throw new SparkBusinessException(new S2Message("NTIS_USED_SLUDGES", "REC_USERID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"128"));
         }
      }
      if (c01_changed || operation == Utils.OPERATION_INSERT) {
         if (c01!= null && c01.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_USED_SLUDGES", "C01", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c02_changed || operation == Utils.OPERATION_INSERT) {
         if (c02!= null && c02.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_USED_SLUDGES", "C02", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c03_changed || operation == Utils.OPERATION_INSERT) {
         if (c03!= null && c03.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_USED_SLUDGES", "C03", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c04_changed || operation == Utils.OPERATION_INSERT) {
         if (c04!= null && c04.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_USED_SLUDGES", "C04", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
      if (c05_changed || operation == Utils.OPERATION_INSERT) {
         if (c05!= null && c05.length()>2147483647) {
            throw new SparkBusinessException(new S2Message("NTIS_USED_SLUDGES", "C05", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2147483647"));
         }
      }
   }
   ...
   public UpdateStatementPart constructUpdatePart(String userName) {
      ...
      String answer = "UPDATE NTIS_USED_SLUDGES SET ";
      boolean changedExists = false;      if (us_wtf_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"US_WTF_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(us_wtf_id);
      }
      if (us_wd_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"US_WD_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(us_wd_id);
      }
      if (n01_changed) {
      ...
      answer = answer +" WHERE  US_ID = ? ";
      updateStatementPart.addStatementParam(us_id);
      updateStatementPart.setStatementPart(answer);
      return updateStatementPart;
   }
   public String toString() {
      return "{\"NtisUsedSludgesDAO\":{\"us_id\": \""+getUs_id()+"\", \"us_wtf_id\": \""+getUs_wtf_id()+"\", \"us_wd_id\": \""+getUs_wd_id()+"\", \"rec_version\": \""+getRec_version()+"\", \"rec_create_timestamp\": \""+getRec_create_timestamp()+"\", \"rec_userid\": \""+getRec_userid()+"\", \"rec_timestamp\": \""+getRec_timestamp()+"\", \"n01\": \""+getN01()+"\", \"n02\": \""+getN02()+"\", \"n03\": \""+getN03()+"\", \"n04\": \""+getN04()+"\", \"n05\": \""+getN05()+"\", \"c01\": \""+getC01()+"\", \"c02\": \""+getC02()+"\", \"c03\": \""+getC03()+"\", \"c04\": \""+getC04()+"\", \"c05\": \""+getC05()+"\", \"d01\": \""+getD01()+"\", \"d02\": \""+getD02()+"\", \"d03\": \""+getD03()+"\", \"d04\": \""+getD04()+"\", \"d05\": \""+getD05()+"\"}}";
   }

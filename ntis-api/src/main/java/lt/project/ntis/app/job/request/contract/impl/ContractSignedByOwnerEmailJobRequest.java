...
@Component("CONTRACT_SIGNED_BY_OWNER")
public class ContractSignedByOwnerEmailJobRequest extends JobRequestImpl {

    @SuppressWarnings("unused")
    private static final Logger log = LoggerFactory.getLogger(ContractSignedByOwnerEmailJobRequest.class);
    ...
    public static final String CODE = "CONTRACT_SIGNED_BY_OWNER";

    public static final String NAME = "Template for contract signed by owner email";

    public static final String DESCRIPTION = "Template for contract signed by owner email";

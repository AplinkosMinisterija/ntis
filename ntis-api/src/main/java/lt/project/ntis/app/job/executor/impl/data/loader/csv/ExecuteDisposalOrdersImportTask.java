...
@Service("CSV_POSTGRE_DISPOSAL_ORDERS_LOADER")
public class ExecuteDisposalOrdersImportTask extends BaseRequestLogicExecutor {

    private static final Logger log = LoggerFactory.getLogger(ExecuteDisposalOrdersImportTask.class);
    ...
    public void executeSpecificLogic(Connection conn, String scriptName, SprJobRequestsDAO request) throws Exception {
        ...
        Map<String, String> params = ntisDisposalOrdersImportLoaderJobRequest.loadJobRequestParams(conn, request.getJrq_id());
        ...
        try (Connection postgreConn = postgreDataSource.getConnection()) {
            ...
            if (params.containsKey(NtisDisposalOrdersImportLoaderJobRequest.SOURCE_FILE_ENCODING)) {
                encodingStr = params.get(NtisDisposalOrdersImportLoaderJobRequest.SOURCE_FILE_ENCODING);

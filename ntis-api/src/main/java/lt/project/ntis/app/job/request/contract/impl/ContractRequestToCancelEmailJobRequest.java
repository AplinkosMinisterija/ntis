...
@Component("CONTRACT_REQUEST_CANCELLATION")
public class ContractRequestToCancelEmailJobRequest extends JobRequestImpl {

    @SuppressWarnings("unused")
    private static final Logger log = LoggerFactory.getLogger(ContractRequestToCancelEmailJobRequest.class);
    ...
    public static final String CODE = "CONTRACT_REQUEST_CANCELLATION";

    public static final String NAME = "Template for requested contract cancellation email";

    public static final String DESCRIPTION = "Template for requested contract cancellation email";

...
@Component("CONTRACT_CANCELLATION_INITIATED")
public class ContractCancellationInitiatedEmailJobRequest extends JobRequestImpl {

    @SuppressWarnings("unused")
    private static final Logger log = LoggerFactory.getLogger(ContractCancellationInitiatedEmailJobRequest.class);
    ...
    public static final String CODE = "CONTRACT_CANCELLATION_INITIATED";

    public static final String NAME = "Template for initiated contract cancellation email";

    public static final String DESCRIPTION = "Template for initiated contract cancellation email";

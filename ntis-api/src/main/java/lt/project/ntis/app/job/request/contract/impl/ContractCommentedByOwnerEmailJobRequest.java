...
@Component("CONTRACT_COMMENT_OWNER")
public class ContractCommentedByOwnerEmailJobRequest extends JobRequestImpl {

    @SuppressWarnings("unused")
    private static final Logger log = LoggerFactory.getLogger(ContractCommentedByOwnerEmailJobRequest.class);
    ...
    public static final String CODE = "CONTRACT_COMMENT_OWNER";

    public static final String NAME = "Template for contract commented by owner email";

    public static final String DESCRIPTION = "Template for contract commented by owner email";

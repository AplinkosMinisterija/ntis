...
@Component("CONTRACT_PREPARED")
public class ContractPreparedEmailJobRequest extends JobRequestImpl {

    @SuppressWarnings("unused")
    private static final Logger log = LoggerFactory.getLogger(ContractPreparedEmailJobRequest.class);
    ...
    public static final String CODE = "CONTRACT_PREPARED";

    public static final String NAME = "Template for contract prepared by provider email";

    public static final String DESCRIPTION = "Template for contract prepared by provider email";

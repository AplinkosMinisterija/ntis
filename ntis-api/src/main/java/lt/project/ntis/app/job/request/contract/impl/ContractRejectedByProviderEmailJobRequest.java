...
@Component("CONTRACT_REJECTED_BY_PROVIDER")
public class ContractRejectedByProviderEmailJobRequest extends JobRequestImpl {

    @SuppressWarnings("unused")
    private static final Logger log = LoggerFactory.getLogger(ContractRejectedByProviderEmailJobRequest.class);
    ...
    public static final String CODE = "CONTRACT_REJECTED_BY_PROVIDER";

    public static final String NAME = "Template for contract rejected by provider email";

    public static final String DESCRIPTION = "Template for contract rejected by provider email";

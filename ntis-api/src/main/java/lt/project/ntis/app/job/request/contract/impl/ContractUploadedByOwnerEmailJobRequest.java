...
@Component("CONTRACT_UPLOADED_OWNER")
public class ContractUploadedByOwnerEmailJobRequest extends JobRequestImpl {

    @SuppressWarnings("unused")
    private static final Logger log = LoggerFactory.getLogger(ContractUploadedByOwnerEmailJobRequest.class);
    ...
    public static final String CODE = "CONTRACT_UPLOADED_OWNER";

    public static final String NAME = "Template for contract uploaded by owner email";

    public static final String DESCRIPTION = "Template for contract uploaded by owner email";

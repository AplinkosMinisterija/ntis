...
@Component("CONTRACT_COMMENTED_PROVIDER")
public class ContractCommentedByProviderEmailJobRequest extends JobRequestImpl {

    @SuppressWarnings("unused")
    private static final Logger log = LoggerFactory.getLogger(ContractCommentedByProviderEmailJobRequest.class);
    ...
    public static final String CODE = "CONTRACT_COMMENT_PROVIDER";

    public static final String NAME = "Template for contract comment responded by provider email";

    public static final String DESCRIPTION = "Template for contract comment responded by provider email";

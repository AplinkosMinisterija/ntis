...
@Component("CONTRACT_REQUESTED_OWNER")
public class ContractRequestedByOwnerEmailJobRequest extends JobRequestImpl {

    @SuppressWarnings("unused")
    private static final Logger log = LoggerFactory.getLogger(ContractRequestedByOwnerEmailJobRequest.class);
    ...
    public static final String CODE = "CONTRACT_REQUESTED_OWNER";

    public static final String NAME = "Template for contract requested by owner email";

    public static final String DESCRIPTION = "Template for contract requested by owner email";

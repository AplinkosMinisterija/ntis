...
@Component("NTIS_RESEARCH_ORDERS_LOADER")
public class NtisResearchOrdersImportLoaderJobRequest extends JobRequestImpl {

    public static final String CODE = "NTIS_RESEARCH_ORDERS_LOADER";

    public static final String NAME = "Laboratorinių tyrimų užsakymų užkrovimas";

    public static final String DESCRIPTION = "Paslaugų teikimo įmonių laboratorinių tyrimų užsakymų duomenų užkrovimas";

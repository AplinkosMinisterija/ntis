...
@Component("SRV_REQ_REJECTED")
public class SrvReqRejectedEmailJobRequest extends JobRequestImpl {

    @SuppressWarnings("unused")
    private static final Logger log = LoggerFactory.getLogger(SrvReqRejectedEmailJobRequest.class);
    ...
    public static final String CODE = "SRV_REQ_REJECTED";

    public static final String NAME = "Template for rejected service request email";

    public static final String DESCRIPTION = "Template for rejected service request email";

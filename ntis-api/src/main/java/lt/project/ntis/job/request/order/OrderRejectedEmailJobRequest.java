...
@Component("ORDER_REJECTED")
public class OrderRejectedEmailJobRequest extends JobRequestImpl {

    @SuppressWarnings("unused")
    private static final Logger log = LoggerFactory.getLogger(OrderRejectedEmailJobRequest.class);
    ...
    public static final String CODE = "ORDER_REJECTED";

    public static final String NAME = "Template for rejected order email";

    public static final String DESCRIPTION = "Template for rejected order email";

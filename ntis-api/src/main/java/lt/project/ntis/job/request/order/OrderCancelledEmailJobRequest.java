...
public class OrderCancelledEmailJobRequest extends JobRequestImpl {

    @SuppressWarnings("unused")
    private static final Logger log = LoggerFactory.getLogger(OrderCancelledEmailJobRequest.class);
    ...
    public static final String ORDER_CANCEL_DATE = "orderCancelDate";

    public static final String CLIENT_NAME = "clientName";

    public static final String CODE = "ORDER_CANCELLED";

    public static final String NAME = "Template for cancelled order email";

    public static final String DESCRIPTION = "Template for cancelled order email";

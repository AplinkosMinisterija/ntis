...
@Component("SRV_REQ_SUBMITTED_SYS")
public class SrvReqSubmittedSysEmailJobRequest extends JobRequestImpl {

    @SuppressWarnings("unused")
    private static final Logger log = LoggerFactory.getLogger(SrvReqSubmittedSysEmailJobRequest.class);
    ...
    public static final String SERVICE_ORG = "serviceOrg";

    public static final String CODE = "SRV_REQ_SUBMITTED_SYS";

    public static final String NAME = "Template for submitted service request email for system admin";

    public static final String DESCRIPTION = "Template for submitted service request email for system admin";

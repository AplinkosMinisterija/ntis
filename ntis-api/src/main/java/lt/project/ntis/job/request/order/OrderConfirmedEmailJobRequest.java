...
public class OrderConfirmedEmailJobRequest extends JobRequestImpl {

    @SuppressWarnings("unused")
    private static final Logger log = LoggerFactory.getLogger(OrderConfirmedEmailJobRequest.class);
    ...
    public static final String CODE = "ORDER_CONFIRMED";

    public static final String NAME = "Template for confirmed order email";

    public static final String DESCRIPTION = "Template for confirmed order email";

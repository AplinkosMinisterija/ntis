...
@Component("DELIVERY_CONFIRMED")
public class DeliveryConfirmedEmailJobRequest extends JobRequestImpl {
    ...
    public static final String CODE = "DELIVERY_CONFIRMED";

    public static final String NAME = "Template for confirmed delivery email";

    public static final String DESCRIPTION = "Template for confirmed delivery email";

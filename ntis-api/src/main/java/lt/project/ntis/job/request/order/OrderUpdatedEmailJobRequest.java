...
@Component("ORDER_UPDATED")
public class OrderUpdatedEmailJobRequest extends JobRequestImpl {

    @SuppressWarnings("unused")
    private static final Logger log = LoggerFactory.getLogger(OrderUpdatedEmailJobRequest.class);
    ...
    public static final String CODE = "ORDER_UPDATED";

    public static final String NAME = "Template for updated order email";

    public static final String DESCRIPTION = "Template for updated order email";

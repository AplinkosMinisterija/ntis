...
@Component("AGGLO_CONFIRMED_EMAIL")
public class AggloConfirmedEmailJobRequest extends JobRequestImpl {
    ...
    public static final String CODE = "AGGLO_CONFIRMED_EMAIL";

    public static final String NAME = "Template for confirmed agglomeration";

    public static final String DESCRIPTION = "Template for confirmed agglomeration";

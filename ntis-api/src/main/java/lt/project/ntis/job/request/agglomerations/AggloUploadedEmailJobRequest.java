...
@Component("AGGLO_UPLOADED_EMAIL")
public class AggloUploadedEmailJobRequest extends JobRequestImpl {
    ...
    public static final String CODE = "AGGLO_UPLOADED_EMAIL";

    public static final String NAME = "Template for uploaded agglomeration";

    public static final String DESCRIPTION = "Template for uploaded agglomeration";

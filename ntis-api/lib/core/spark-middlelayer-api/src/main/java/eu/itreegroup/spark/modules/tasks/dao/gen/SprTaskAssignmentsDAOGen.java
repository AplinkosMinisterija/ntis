...
public class SprTaskAssignmentsDAOGen extends SprBaseDAO{
   public static String IDENTIFIER="SPR_TASK_ASSIGNMENTS.TAT_ID";
   private Double tat_id;
   private Double tat_usr_id;
   private Double tat_org_id;
   private Double tat_rol_id;
   private Double tat_ins_id;
   private Double tat_tas_id;
   private Date tat_date_from;
   private Date tat_date_to;
   ...
   protected boolean tat_id_changed;
   protected boolean tat_usr_id_changed;
   protected boolean tat_org_id_changed;
   protected boolean tat_rol_id_changed;
   protected boolean tat_ins_id_changed;
   protected boolean tat_tas_id_changed;
   protected boolean tat_date_from_changed;
   protected boolean tat_date_to_changed;
   ...
   public SprTaskAssignmentsDAOGen() {
      markObjectAsInitial();
      setRecordLoaded(false);
      setForceUpdate(false);
   }
   public SprTaskAssignmentsDAOGen(Double tat_id, Double tat_usr_id, Double tat_org_id, Double tat_rol_id, Double tat_ins_id, Double tat_tas_id, Date tat_date_from, Date tat_date_to, Double rec_version, Date rec_create_timestamp, String rec_userid, Date rec_timestamp, Double n01, Double n02, Double n03, Double n04, Double n05, String c01, String c02, String c03, String c04, String c05, Date d01, Date d02, Date d03, Date d04, Date d05) {
      this.tat_id = tat_id;
      this.tat_usr_id = tat_usr_id;
      this.tat_org_id = tat_org_id;
      this.tat_rol_id = tat_rol_id;
      this.tat_ins_id = tat_ins_id;
      this.tat_tas_id = tat_tas_id;
      this.tat_date_from = tat_date_from;
      this.tat_date_to = tat_date_to;
   ...
   public void copyValues(SprTaskAssignmentsDAOGen obj) {
      this.setTat_id(obj.getTat_id());
      this.setTat_usr_id(obj.getTat_usr_id());
      this.setTat_org_id(obj.getTat_org_id());
      this.setTat_rol_id(obj.getTat_rol_id());
      this.setTat_ins_id(obj.getTat_ins_id());
      this.setTat_tas_id(obj.getTat_tas_id());
      this.setTat_date_from(obj.getTat_date_from());
      this.setTat_date_to(obj.getTat_date_to());
   ...
   protected void markObjectAsInitial() {
      this.tat_id_changed = false;
      this.tat_usr_id_changed = false;
      this.tat_org_id_changed = false;
      this.tat_rol_id_changed = false;
      this.tat_ins_id_changed = false;
      this.tat_tas_id_changed = false;
      this.tat_date_from_changed = false;
      this.tat_date_to_changed = false;
   ...
   public void setTat_id(Double tat_id) {
      if (this.isForceUpdate() || 
               (this.tat_id != null && !this.tat_id.equals(tat_id))  ||
               (tat_id != null && !tat_id.equals(this.tat_id)) ){
         this.tat_id_changed = true; 
         this.record_changed = true;
         this.tat_id = tat_id;
      }
   }
   public Double getTat_id() {
      return this.tat_id;
   }
   public void setTat_usr_id(Double tat_usr_id) {
      if (this.isForceUpdate() || 
               (this.tat_usr_id != null && !this.tat_usr_id.equals(tat_usr_id))  ||
               (tat_usr_id != null && !tat_usr_id.equals(this.tat_usr_id)) ){
         this.tat_usr_id_changed = true; 
         this.record_changed = true;
         this.tat_usr_id = tat_usr_id;
      }
   }
   public Double getTat_usr_id() {
      return this.tat_usr_id;
   }
   public void setTat_org_id(Double tat_org_id) {
      if (this.isForceUpdate() || 
               (this.tat_org_id != null && !this.tat_org_id.equals(tat_org_id))  ||
               (tat_org_id != null && !tat_org_id.equals(this.tat_org_id)) ){
         this.tat_org_id_changed = true; 
         this.record_changed = true;
         this.tat_org_id = tat_org_id;
      }
   }
   public Double getTat_org_id() {
      return this.tat_org_id;
   }
   public void setTat_rol_id(Double tat_rol_id) {
      if (this.isForceUpdate() || 
               (this.tat_rol_id != null && !this.tat_rol_id.equals(tat_rol_id))  ||
               (tat_rol_id != null && !tat_rol_id.equals(this.tat_rol_id)) ){
         this.tat_rol_id_changed = true; 
         this.record_changed = true;
         this.tat_rol_id = tat_rol_id;
      }
   }
   public Double getTat_rol_id() {
      return this.tat_rol_id;
   }
   public void setTat_ins_id(Double tat_ins_id) {
      if (this.isForceUpdate() || 
               (this.tat_ins_id != null && !this.tat_ins_id.equals(tat_ins_id))  ||
               (tat_ins_id != null && !tat_ins_id.equals(this.tat_ins_id)) ){
         this.tat_ins_id_changed = true; 
         this.record_changed = true;
         this.tat_ins_id = tat_ins_id;
      }
   }
   public Double getTat_ins_id() {
      return this.tat_ins_id;
   }
   public void setTat_tas_id(Double tat_tas_id) {
      if (this.isForceUpdate() || 
               (this.tat_tas_id != null && !this.tat_tas_id.equals(tat_tas_id))  ||
               (tat_tas_id != null && !tat_tas_id.equals(this.tat_tas_id)) ){
         this.tat_tas_id_changed = true; 
         this.record_changed = true;
         this.tat_tas_id = tat_tas_id;
      }
   }
   public Double getTat_tas_id() {
      return this.tat_tas_id;
   }
   public void setTat_date_from(Date tat_date_from) {
      if (this.isForceUpdate() || 
               (this.tat_date_from != null && (tat_date_from == null ||this.tat_date_from.compareTo(tat_date_from) != 0 )) ||
               (tat_date_from != null && (this.tat_date_from == null ||tat_date_from.compareTo(this.tat_date_from) != 0 ))){
         this.tat_date_from_changed = true; 
         this.record_changed = true;
         this.tat_date_from = tat_date_from;
      }
   }
   public Date getTat_date_from() {
      return this.tat_date_from;
   }
   public void setTat_date_to(Date tat_date_to) {
      if (this.isForceUpdate() || 
               (this.tat_date_to != null && (tat_date_to == null ||this.tat_date_to.compareTo(tat_date_to) != 0 )) ||
               (tat_date_to != null && (this.tat_date_to == null ||tat_date_to.compareTo(this.tat_date_to) != 0 ))){
         this.tat_date_to_changed = true; 
         this.record_changed = true;
         this.tat_date_to = tat_date_to;
      }
   }
   public Date getTat_date_to() {
      return this.tat_date_to;
   }
   ...
   public Date getD05() {
    ...
    public void setRecordIdentifier(Object recIdentifier) {
        if (recIdentifier != null && !EMPTY_STRING.equals(recIdentifier)  && !"null".equalsIgnoreCase(recIdentifier.toString())){
            this.tat_id = (Double)recIdentifier;
        }
    }
    @JsonIgnore
    ...
    public void validateObject(int operation, SprBaseDBServiceImpl<?> baseService) throws SparkBusinessException{
      if (tat_usr_id_changed || operation == Utils.OPERATION_INSERT) {
         if (tat_usr_id== null) {
            throw new SparkBusinessException(new S2Message("SPR_TASK_ASSIGNMENTS", "TAT_USR_ID", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }else{
            if (tat_usr_id!= null && (""+tat_usr_id.intValue()).length()>12) {
               throw new SparkBusinessException(new S2Message("SPR_TASK_ASSIGNMENTS", "TAT_USR_ID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"12"));
            }
         }
      }
      if (tat_org_id_changed || operation == Utils.OPERATION_INSERT) {
         if (tat_org_id!= null && (""+tat_org_id.intValue()).length()>12) {
            throw new SparkBusinessException(new S2Message("SPR_TASK_ASSIGNMENTS", "TAT_ORG_ID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"12"));
         }
      }
      if (tat_rol_id_changed || operation == Utils.OPERATION_INSERT) {
         if (tat_rol_id!= null && (""+tat_rol_id.intValue()).length()>12) {
            throw new SparkBusinessException(new S2Message("SPR_TASK_ASSIGNMENTS", "TAT_ROL_ID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"12"));
         }
      }
      if (tat_ins_id_changed || operation == Utils.OPERATION_INSERT) {
         if (tat_ins_id!= null && (""+tat_ins_id.intValue()).length()>12) {
            throw new SparkBusinessException(new S2Message("SPR_TASK_ASSIGNMENTS", "TAT_INS_ID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"12"));
         }
      }
      if (tat_tas_id_changed || operation == Utils.OPERATION_INSERT) {
         if (tat_tas_id== null) {
            throw new SparkBusinessException(new S2Message("SPR_TASK_ASSIGNMENTS", "TAT_TAS_ID", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }else{
            if (tat_tas_id!= null && (""+tat_tas_id.intValue()).length()>12) {
               throw new SparkBusinessException(new S2Message("SPR_TASK_ASSIGNMENTS", "TAT_TAS_ID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"12"));
            }
         }
      }
      if (tat_date_from_changed || operation == Utils.OPERATION_INSERT) {
         if (tat_date_from== null) {
            throw new SparkBusinessException(new S2Message("SPR_TASK_ASSIGNMENTS", "TAT_DATE_FROM", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }
      }
      if (rec_version_changed || operation == Utils.OPERATION_INSERT) {
         if (rec_version!= null && (""+rec_version.intValue()).length()>6) {
            throw new SparkBusinessException(new S2Message("SPR_TASK_ASSIGNMENTS", "REC_VERSION", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"6"));
         }
      }
      if (rec_userid_changed || operation == Utils.OPERATION_INSERT) {
         if (rec_userid!= null && rec_userid.length()>128) {
            throw new SparkBusinessException(new S2Message("SPR_TASK_ASSIGNMENTS", "REC_USERID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"128"));
         }
      }
      if (c01_changed || operation == Utils.OPERATION_INSERT) {
         if (c01!= null && c01.length()>2000) {
            throw new SparkBusinessException(new S2Message("SPR_TASK_ASSIGNMENTS", "C01", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2000"));
         }
      }
      if (c02_changed || operation == Utils.OPERATION_INSERT) {
         if (c02!= null && c02.length()>2000) {
            throw new SparkBusinessException(new S2Message("SPR_TASK_ASSIGNMENTS", "C02", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2000"));
         }
      }
      if (c03_changed || operation == Utils.OPERATION_INSERT) {
         if (c03!= null && c03.length()>2000) {
            throw new SparkBusinessException(new S2Message("SPR_TASK_ASSIGNMENTS", "C03", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2000"));
         }
      }
      if (c04_changed || operation == Utils.OPERATION_INSERT) {
         if (c04!= null && c04.length()>2000) {
            throw new SparkBusinessException(new S2Message("SPR_TASK_ASSIGNMENTS", "C04", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2000"));
         }
      }
      if (c05_changed || operation == Utils.OPERATION_INSERT) {
         if (c05!= null && c05.length()>2000) {
            throw new SparkBusinessException(new S2Message("SPR_TASK_ASSIGNMENTS", "C05", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2000"));
         }
      }
   }
   ...
   public UpdateStatementPart constructUpdatePart(String userName) {
      ...
      String answer = "UPDATE SPR_TASK_ASSIGNMENTS SET ";
      boolean changedExists = false;      if (tat_usr_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"TAT_USR_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(tat_usr_id);
      }
      if (tat_org_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"TAT_ORG_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(tat_org_id);
      }
      if (tat_rol_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"TAT_ROL_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(tat_rol_id);
      }
      if (tat_ins_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"TAT_INS_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(tat_ins_id);
      }
      if (tat_tas_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"TAT_TAS_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(tat_tas_id);
      }
      if (tat_date_from_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"TAT_DATE_FROM = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(tat_date_from);
      }
      if (tat_date_to_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"TAT_DATE_TO = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(tat_date_to);
      }
      if (n01_changed) {
      ...
      answer = answer +" WHERE  TAT_ID = ? ";
      updateStatementPart.addStatementParam(tat_id);
      updateStatementPart.setStatementPart(answer);
      return updateStatementPart;
   }
   public String toString() {
      return "{\"SprTaskAssignmentsDAO\":{\"tat_id\": \""+getTat_id()+"\", \"tat_usr_id\": \""+getTat_usr_id()+"\", \"tat_org_id\": \""+getTat_org_id()+"\", \"tat_rol_id\": \""+getTat_rol_id()+"\", \"tat_ins_id\": \""+getTat_ins_id()+"\", \"tat_tas_id\": \""+getTat_tas_id()+"\", \"tat_date_from\": \""+getTat_date_from()+"\", \"tat_date_to\": \""+getTat_date_to()+"\", \"rec_version\": \""+getRec_version()+"\", \"rec_create_timestamp\": \""+getRec_create_timestamp()+"\", \"rec_userid\": \""+getRec_userid()+"\", \"rec_timestamp\": \""+getRec_timestamp()+"\", \"n01\": \""+getN01()+"\", \"n02\": \""+getN02()+"\", \"n03\": \""+getN03()+"\", \"n04\": \""+getN04()+"\", \"n05\": \""+getN05()+"\", \"c01\": \""+getC01()+"\", \"c02\": \""+getC02()+"\", \"c03\": \""+getC03()+"\", \"c04\": \""+getC04()+"\", \"c05\": \""+getC05()+"\", \"d01\": \""+getD01()+"\", \"d02\": \""+getD02()+"\", \"d03\": \""+getD03()+"\", \"d04\": \""+getD04()+"\", \"d05\": \""+getD05()+"\"}}";
   }

...
public class SprApiKeysDAOGen extends SprBaseDAO{
   ...
   public void setApi_id(Double api_id) {
      if (this.isForceUpdate() || 
               (this.api_id != null && !this.api_id.equals(api_id))  ||
               (api_id != null && !api_id.equals(this.api_id)) ){
   ...
   public void setApi_type_code(String api_type_code) {
      if (this.isForceUpdate() || 
               (this.api_type_code != null && !this.api_type_code.equals(api_type_code))  ||
               (api_type_code != null && !api_type_code.equals(this.api_type_code)) ){
   ...
   public void setApi_key(String api_key) {
      if (this.isForceUpdate() || 
               (this.api_key != null && !this.api_key.equals(api_key))  ||
               (api_key != null && !api_key.equals(this.api_key)) ){
   ...
   public void setApi_ou_id(Double api_ou_id) {
      if (this.isForceUpdate() || 
               (this.api_ou_id != null && !this.api_ou_id.equals(api_ou_id))  ||
               (api_ou_id != null && !api_ou_id.equals(this.api_ou_id)) ){
   ...
   public void setApi_usr_id(Double api_usr_id) {
      if (this.isForceUpdate() || 
               (this.api_usr_id != null && !this.api_usr_id.equals(api_usr_id))  ||
               (api_usr_id != null && !api_usr_id.equals(this.api_usr_id)) ){
   ...
   public void setApi_date_from(Date api_date_from) {
      if (this.isForceUpdate() || 
               (this.api_date_from != null && (api_date_from == null ||this.api_date_from.compareTo(api_date_from) != 0 )) ||
               (api_date_from != null && (this.api_date_from == null ||api_date_from.compareTo(this.api_date_from) != 0 ))){
   ...
   public void setApi_date_to(Date api_date_to) {
      if (this.isForceUpdate() || 
               (this.api_date_to != null && (api_date_to == null ||this.api_date_to.compareTo(api_date_to) != 0 )) ||
               (api_date_to != null && (this.api_date_to == null ||api_date_to.compareTo(this.api_date_to) != 0 ))){
   ...
   public Date getD05() {
    ...
    public void validateObject(int operation, SprBaseDBServiceImpl<?> baseService) throws SparkBusinessException{
      ...
      if (api_key_changed || operation == Utils.OPERATION_INSERT) {
         if (api_key!= null && api_key.length()>2000) {
            throw new SparkBusinessException(new S2Message("SPR_API_KEYS", "API_KEY", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2000"));
         }
      }
      ...
      if (c01_changed || operation == Utils.OPERATION_INSERT) {
         if (c01!= null && c01.length()>4000) {
            throw new SparkBusinessException(new S2Message("SPR_API_KEYS", "C01", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"4000"));
         }
      }
      if (c02_changed || operation == Utils.OPERATION_INSERT) {
         if (c02!= null && c02.length()>4000) {
            throw new SparkBusinessException(new S2Message("SPR_API_KEYS", "C02", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"4000"));
         }
      }
      if (c03_changed || operation == Utils.OPERATION_INSERT) {
         if (c03!= null && c03.length()>4000) {
            throw new SparkBusinessException(new S2Message("SPR_API_KEYS", "C03", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"4000"));
         }
      }
      if (c04_changed || operation == Utils.OPERATION_INSERT) {
         if (c04!= null && c04.length()>4000) {
            throw new SparkBusinessException(new S2Message("SPR_API_KEYS", "C04", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"4000"));
         }
      }
      if (c05_changed || operation == Utils.OPERATION_INSERT) {
         if (c05!= null && c05.length()>4000) {
            throw new SparkBusinessException(new S2Message("SPR_API_KEYS", "C05", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"4000"));
         }
      }
   }
   ...
   public UpdateStatementPart constructUpdatePart(String userName) {
      ...
      if (api_date_from_changed) {
         ...
         changedExists = true;
         updateStatementPart.addStatementParam(api_date_from);
      }
      if (api_date_to_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"API_DATE_TO = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(api_date_to);
      }
      if (n01_changed) {

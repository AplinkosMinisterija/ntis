...
public class SprUserRolesDAOGen extends SprBaseDAO{
   public static String IDENTIFIER="SPR_USER_ROLES.URO_ID";
   private Double uro_id;
   private Date uro_date_from;
   private Date uro_date_to;
   private Double uro_usr_id;
   private Double uro_rol_id;
   ...
   protected boolean uro_id_changed;
   protected boolean uro_date_from_changed;
   protected boolean uro_date_to_changed;
   protected boolean uro_usr_id_changed;
   protected boolean uro_rol_id_changed;
   ...
   public SprUserRolesDAOGen() {
      markObjectAsInitial();
      setRecordLoaded(false);
      setForceUpdate(false);
   }
   public SprUserRolesDAOGen(Double uro_id, Date uro_date_from, Date uro_date_to, Double uro_usr_id, Double uro_rol_id, Double rec_version, Date rec_create_timestamp, String rec_userid, Date rec_timestamp, Double n01, Double n02, Double n03, Double n04, Double n05, String c01, String c02, String c03, String c04, String c05, Date d01, Date d02, Date d03, Date d04, Date d05) {
      this.uro_id = uro_id;
      this.uro_date_from = uro_date_from;
      this.uro_date_to = uro_date_to;
      this.uro_usr_id = uro_usr_id;
   ...
   public void copyValues(SprUserRolesDAOGen obj) {
      this.setUro_id(obj.getUro_id());
      this.setUro_date_from(obj.getUro_date_from());
      this.setUro_date_to(obj.getUro_date_to());
      this.setUro_usr_id(obj.getUro_usr_id());
      this.setUro_rol_id(obj.getUro_rol_id());
   ...
   protected void markObjectAsInitial() {
      this.uro_id_changed = false;
      this.uro_date_from_changed = false;
      this.uro_date_to_changed = false;
      this.uro_usr_id_changed = false;
      this.uro_rol_id_changed = false;
   ...
   public void setUro_id(Double uro_id) {
      if (this.isForceUpdate() || 
               (this.uro_id != null && !this.uro_id.equals(uro_id))  ||
               (uro_id != null && !uro_id.equals(this.uro_id)) ){
         this.uro_id_changed = true; 
         this.record_changed = true;
         this.uro_id = uro_id;
      }
   }
   public Double getUro_id() {
      return this.uro_id;
   }
   public void setUro_date_from(Date uro_date_from) {
      if (this.isForceUpdate() || 
               (this.uro_date_from != null && (uro_date_from == null ||this.uro_date_from.compareTo(uro_date_from) != 0 )) ||
               (uro_date_from != null && (this.uro_date_from == null ||uro_date_from.compareTo(this.uro_date_from) != 0 ))){
         this.uro_date_from_changed = true; 
         this.record_changed = true;
         this.uro_date_from = uro_date_from;
      }
   }
   public Date getUro_date_from() {
      return this.uro_date_from;
   }
   public void setUro_date_to(Date uro_date_to) {
      if (this.isForceUpdate() || 
               (this.uro_date_to != null && (uro_date_to == null ||this.uro_date_to.compareTo(uro_date_to) != 0 )) ||
               (uro_date_to != null && (this.uro_date_to == null ||uro_date_to.compareTo(this.uro_date_to) != 0 ))){
         this.uro_date_to_changed = true; 
         this.record_changed = true;
         this.uro_date_to = uro_date_to;
      }
   }
   public Date getUro_date_to() {
      return this.uro_date_to;
   }
   public void setUro_usr_id(Double uro_usr_id) {
      if (this.isForceUpdate() || 
               (this.uro_usr_id != null && !this.uro_usr_id.equals(uro_usr_id))  ||
               (uro_usr_id != null && !uro_usr_id.equals(this.uro_usr_id)) ){
         this.uro_usr_id_changed = true; 
         this.record_changed = true;
         this.uro_usr_id = uro_usr_id;
      }
   }
   public Double getUro_usr_id() {
      return this.uro_usr_id;
   }
   public void setUro_rol_id(Double uro_rol_id) {
      if (this.isForceUpdate() || 
               (this.uro_rol_id != null && !this.uro_rol_id.equals(uro_rol_id))  ||
               (uro_rol_id != null && !uro_rol_id.equals(this.uro_rol_id)) ){
         this.uro_rol_id_changed = true; 
         this.record_changed = true;
         this.uro_rol_id = uro_rol_id;
      }
   }
   public Double getUro_rol_id() {
      return this.uro_rol_id;
   }
   ...
   public Date getD05() {
    ...
    public void setRecordIdentifier(Object recIdentifier) {
        if (recIdentifier != null && !EMPTY_STRING.equals(recIdentifier)  && !"null".equalsIgnoreCase(recIdentifier.toString())){
            this.uro_id = (Double)recIdentifier;
        }
    }
    @JsonIgnore
    ...
    public void validateObject(int operation, SprBaseDBServiceImpl<?> baseService) throws SparkBusinessException{
      if (uro_date_from_changed || operation == Utils.OPERATION_INSERT) {
         if (uro_date_from== null) {
            throw new SparkBusinessException(new S2Message("SPR_USER_ROLES", "URO_DATE_FROM", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }
      }
      if (uro_usr_id_changed || operation == Utils.OPERATION_INSERT) {
         if (uro_usr_id!= null && (""+uro_usr_id.intValue()).length()>12) {
            throw new SparkBusinessException(new S2Message("SPR_USER_ROLES", "URO_USR_ID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"12"));
         }
      }
      if (uro_rol_id_changed || operation == Utils.OPERATION_INSERT) {
         if (uro_rol_id!= null && (""+uro_rol_id.intValue()).length()>12) {
            throw new SparkBusinessException(new S2Message("SPR_USER_ROLES", "URO_ROL_ID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"12"));
         }
      }
      if (rec_version_changed || operation == Utils.OPERATION_INSERT) {
         if (rec_version!= null && (""+rec_version.intValue()).length()>6) {
            throw new SparkBusinessException(new S2Message("SPR_USER_ROLES", "REC_VERSION", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"6"));
         }
      }
      if (rec_userid_changed || operation == Utils.OPERATION_INSERT) {
         if (rec_userid!= null && rec_userid.length()>128) {
            throw new SparkBusinessException(new S2Message("SPR_USER_ROLES", "REC_USERID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"128"));
         }
      }
      if (c01_changed || operation == Utils.OPERATION_INSERT) {
         if (c01!= null && c01.length()>2000) {
            throw new SparkBusinessException(new S2Message("SPR_USER_ROLES", "C01", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2000"));
         }
      }
      if (c02_changed || operation == Utils.OPERATION_INSERT) {
         if (c02!= null && c02.length()>2000) {
            throw new SparkBusinessException(new S2Message("SPR_USER_ROLES", "C02", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2000"));
         }
      }
      if (c03_changed || operation == Utils.OPERATION_INSERT) {
         if (c03!= null && c03.length()>2000) {
            throw new SparkBusinessException(new S2Message("SPR_USER_ROLES", "C03", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2000"));
         }
      }
      if (c04_changed || operation == Utils.OPERATION_INSERT) {
         if (c04!= null && c04.length()>2000) {
            throw new SparkBusinessException(new S2Message("SPR_USER_ROLES", "C04", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2000"));
         }
      }
      if (c05_changed || operation == Utils.OPERATION_INSERT) {
         if (c05!= null && c05.length()>2000) {
            throw new SparkBusinessException(new S2Message("SPR_USER_ROLES", "C05", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2000"));
         }
      }
   }
   ...
   public UpdateStatementPart constructUpdatePart(String userName) {
      ...
      String answer = "UPDATE SPR_USER_ROLES SET ";
      boolean changedExists = false;      if (uro_date_from_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"URO_DATE_FROM = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(uro_date_from);
      }
      if (uro_date_to_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"URO_DATE_TO = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(uro_date_to);
      }
      if (uro_usr_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"URO_USR_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(uro_usr_id);
      }
      if (uro_rol_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"URO_ROL_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(uro_rol_id);
      }
      if (n01_changed) {
      ...
      answer = answer +" WHERE  URO_ID = ? ";
      updateStatementPart.addStatementParam(uro_id);
      updateStatementPart.setStatementPart(answer);
      return updateStatementPart;
   }
   public String toString() {
      return "{\"SprUserRolesDAO\":{\"uro_id\": \""+getUro_id()+"\", \"uro_date_from\": \""+getUro_date_from()+"\", \"uro_date_to\": \""+getUro_date_to()+"\", \"uro_usr_id\": \""+getUro_usr_id()+"\", \"uro_rol_id\": \""+getUro_rol_id()+"\", \"rec_version\": \""+getRec_version()+"\", \"rec_create_timestamp\": \""+getRec_create_timestamp()+"\", \"rec_userid\": \""+getRec_userid()+"\", \"rec_timestamp\": \""+getRec_timestamp()+"\", \"n01\": \""+getN01()+"\", \"n02\": \""+getN02()+"\", \"n03\": \""+getN03()+"\", \"n04\": \""+getN04()+"\", \"n05\": \""+getN05()+"\", \"c01\": \""+getC01()+"\", \"c02\": \""+getC02()+"\", \"c03\": \""+getC03()+"\", \"c04\": \""+getC04()+"\", \"c05\": \""+getC05()+"\", \"d01\": \""+getD01()+"\", \"d02\": \""+getD02()+"\", \"d03\": \""+getD03()+"\", \"d04\": \""+getD04()+"\", \"d05\": \""+getD05()+"\"}}";
   }

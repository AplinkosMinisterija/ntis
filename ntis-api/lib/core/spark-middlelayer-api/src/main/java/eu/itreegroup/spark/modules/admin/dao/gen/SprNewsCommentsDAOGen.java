...
public class SprNewsCommentsDAOGen extends SprBaseDAO{
   public static String IDENTIFIER="SPR_NEWS_COMMENTS.NWC_ID";
   private Double nwc_id;
   private String nwc_comment;
   private Date nwc_create_date;
   private Double nwc_usr_id;
   private Double nwc_nw_id;
   private Double nwc_nwc_id;
   ...
   protected boolean nwc_id_changed;
   protected boolean nwc_comment_changed;
   protected boolean nwc_create_date_changed;
   protected boolean nwc_usr_id_changed;
   protected boolean nwc_nw_id_changed;
   protected boolean nwc_nwc_id_changed;
   ...
   public SprNewsCommentsDAOGen() {
      markObjectAsInitial();
      setRecordLoaded(false);
      setForceUpdate(false);
   }
   public SprNewsCommentsDAOGen(Double nwc_id, String nwc_comment, Date nwc_create_date, Double nwc_usr_id, Double nwc_nw_id, Double nwc_nwc_id, Double rec_version, Date rec_create_timestamp, String rec_userid, Date rec_timestamp, Double n01, Double n02, Double n03, Double n04, Double n05, String c01, String c02, String c03, String c04, String c05, Date d01, Date d02, Date d03, Date d04, Date d05) {
      this.nwc_id = nwc_id;
      this.nwc_comment = nwc_comment;
      this.nwc_create_date = nwc_create_date;
      this.nwc_usr_id = nwc_usr_id;
      this.nwc_nw_id = nwc_nw_id;
      this.nwc_nwc_id = nwc_nwc_id;
   ...
   public void copyValues(SprNewsCommentsDAOGen obj) {
      this.setNwc_id(obj.getNwc_id());
      this.setNwc_comment(obj.getNwc_comment());
      this.setNwc_create_date(obj.getNwc_create_date());
      this.setNwc_usr_id(obj.getNwc_usr_id());
      this.setNwc_nw_id(obj.getNwc_nw_id());
      this.setNwc_nwc_id(obj.getNwc_nwc_id());
   ...
   protected void markObjectAsInitial() {
      this.nwc_id_changed = false;
      this.nwc_comment_changed = false;
      this.nwc_create_date_changed = false;
      this.nwc_usr_id_changed = false;
      this.nwc_nw_id_changed = false;
      this.nwc_nwc_id_changed = false;
   ...
   public void setNwc_id(Double nwc_id) {
      if (this.isForceUpdate() || 
               (this.nwc_id != null && !this.nwc_id.equals(nwc_id))  ||
               (nwc_id != null && !nwc_id.equals(this.nwc_id)) ){
         this.nwc_id_changed = true; 
         this.record_changed = true;
         this.nwc_id = nwc_id;
      }
   }
   public Double getNwc_id() {
      return this.nwc_id;
   }
   public void setNwc_comment(String nwc_comment) {
      if (this.isForceUpdate() || 
               (this.nwc_comment != null && !this.nwc_comment.equals(nwc_comment))  ||
               (nwc_comment != null && !nwc_comment.equals(this.nwc_comment)) ){
         this.nwc_comment_changed = true; 
         this.record_changed = true;
         this.nwc_comment = nwc_comment;
      }
   }
   public String getNwc_comment() {
      return this.nwc_comment;
   }
   public void setNwc_create_date(Date nwc_create_date) {
      if (this.isForceUpdate() || 
               (this.nwc_create_date != null && (nwc_create_date == null ||this.nwc_create_date.compareTo(nwc_create_date) != 0 )) ||
               (nwc_create_date != null && (this.nwc_create_date == null ||nwc_create_date.compareTo(this.nwc_create_date) != 0 ))){
         this.nwc_create_date_changed = true; 
         this.record_changed = true;
         this.nwc_create_date = nwc_create_date;
      }
   }
   public Date getNwc_create_date() {
      return this.nwc_create_date;
   }
   public void setNwc_usr_id(Double nwc_usr_id) {
      if (this.isForceUpdate() || 
               (this.nwc_usr_id != null && !this.nwc_usr_id.equals(nwc_usr_id))  ||
               (nwc_usr_id != null && !nwc_usr_id.equals(this.nwc_usr_id)) ){
         this.nwc_usr_id_changed = true; 
         this.record_changed = true;
         this.nwc_usr_id = nwc_usr_id;
      }
   }
   public Double getNwc_usr_id() {
      return this.nwc_usr_id;
   }
   public void setNwc_nw_id(Double nwc_nw_id) {
      if (this.isForceUpdate() || 
               (this.nwc_nw_id != null && !this.nwc_nw_id.equals(nwc_nw_id))  ||
               (nwc_nw_id != null && !nwc_nw_id.equals(this.nwc_nw_id)) ){
         this.nwc_nw_id_changed = true; 
         this.record_changed = true;
         this.nwc_nw_id = nwc_nw_id;
      }
   }
   public Double getNwc_nw_id() {
      return this.nwc_nw_id;
   }
   public void setNwc_nwc_id(Double nwc_nwc_id) {
      if (this.isForceUpdate() || 
               (this.nwc_nwc_id != null && !this.nwc_nwc_id.equals(nwc_nwc_id))  ||
               (nwc_nwc_id != null && !nwc_nwc_id.equals(this.nwc_nwc_id)) ){
         this.nwc_nwc_id_changed = true; 
         this.record_changed = true;
         this.nwc_nwc_id = nwc_nwc_id;
      }
   }
   public Double getNwc_nwc_id() {
      return this.nwc_nwc_id;
   }
   ...
   public Date getD05() {
    ...
    public void setRecordIdentifier(Object recIdentifier) {
        if (recIdentifier != null && !EMPTY_STRING.equals(recIdentifier)  && !"null".equalsIgnoreCase(recIdentifier.toString())){
            this.nwc_id = (Double)recIdentifier;
        }
    }
    @JsonIgnore
    ...
    public void validateObject(int operation, SprBaseDBServiceImpl<?> baseService) throws SparkBusinessException{
      if (nwc_comment_changed || operation == Utils.OPERATION_INSERT) {
         if (nwc_comment== null || EMPTY_STRING.equals(nwc_comment)) {
            throw new SparkBusinessException(new S2Message("SPR_NEWS_COMMENTS", "NWC_COMMENT", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }else{
            if (nwc_comment!= null && nwc_comment.length()>2000000000) {
               throw new SparkBusinessException(new S2Message("SPR_NEWS_COMMENTS", "NWC_COMMENT", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2000000000"));
            }
         }
      }
      if (nwc_create_date_changed || operation == Utils.OPERATION_INSERT) {
         if (nwc_create_date== null) {
            throw new SparkBusinessException(new S2Message("SPR_NEWS_COMMENTS", "NWC_CREATE_DATE", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }
      }
      if (nwc_usr_id_changed || operation == Utils.OPERATION_INSERT) {
         if (nwc_usr_id== null) {
            throw new SparkBusinessException(new S2Message("SPR_NEWS_COMMENTS", "NWC_USR_ID", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }else{
            if (nwc_usr_id!= null && (""+nwc_usr_id.intValue()).length()>12) {
               throw new SparkBusinessException(new S2Message("SPR_NEWS_COMMENTS", "NWC_USR_ID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"12"));
            }
         }
      }
      if (nwc_nw_id_changed || operation == Utils.OPERATION_INSERT) {
         if (nwc_nw_id== null) {
            throw new SparkBusinessException(new S2Message("SPR_NEWS_COMMENTS", "NWC_NW_ID", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }else{
            if (nwc_nw_id!= null && (""+nwc_nw_id.intValue()).length()>12) {
               throw new SparkBusinessException(new S2Message("SPR_NEWS_COMMENTS", "NWC_NW_ID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"12"));
            }
         }
      }
      if (nwc_nwc_id_changed || operation == Utils.OPERATION_INSERT) {
         if (nwc_nwc_id!= null && (""+nwc_nwc_id.intValue()).length()>12) {
            throw new SparkBusinessException(new S2Message("SPR_NEWS_COMMENTS", "NWC_NWC_ID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"12"));
         }
      }
      if (rec_version_changed || operation == Utils.OPERATION_INSERT) {
         if (rec_version!= null && (""+rec_version.intValue()).length()>6) {
            throw new SparkBusinessException(new S2Message("SPR_NEWS_COMMENTS", "REC_VERSION", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"6"));
         }
      }
      if (rec_userid_changed || operation == Utils.OPERATION_INSERT) {
         if (rec_userid!= null && rec_userid.length()>128) {
            throw new SparkBusinessException(new S2Message("SPR_NEWS_COMMENTS", "REC_USERID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"128"));
         }
      }
      if (c01_changed || operation == Utils.OPERATION_INSERT) {
         if (c01!= null && c01.length()>4000) {
            throw new SparkBusinessException(new S2Message("SPR_NEWS_COMMENTS", "C01", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"4000"));
         }
      }
      if (c02_changed || operation == Utils.OPERATION_INSERT) {
         if (c02!= null && c02.length()>4000) {
            throw new SparkBusinessException(new S2Message("SPR_NEWS_COMMENTS", "C02", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"4000"));
         }
      }
      if (c03_changed || operation == Utils.OPERATION_INSERT) {
         if (c03!= null && c03.length()>4000) {
            throw new SparkBusinessException(new S2Message("SPR_NEWS_COMMENTS", "C03", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"4000"));
         }
      }
      if (c04_changed || operation == Utils.OPERATION_INSERT) {
         if (c04!= null && c04.length()>4000) {
            throw new SparkBusinessException(new S2Message("SPR_NEWS_COMMENTS", "C04", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"4000"));
         }
      }
      if (c05_changed || operation == Utils.OPERATION_INSERT) {
         if (c05!= null && c05.length()>4000) {
            throw new SparkBusinessException(new S2Message("SPR_NEWS_COMMENTS", "C05", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"4000"));
         }
      }
   }
   ...
   public UpdateStatementPart constructUpdatePart(String userName) {
      ...
      String answer = "UPDATE SPR_NEWS_COMMENTS SET ";
      boolean changedExists = false;      if (nwc_comment_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"NWC_COMMENT = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(nwc_comment);
      }
      if (nwc_create_date_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"NWC_CREATE_DATE = ? ";
         changedExists = true;
         updateStatementPart.addStatementTimestampParam(nwc_create_date);
      }
      if (nwc_usr_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"NWC_USR_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(nwc_usr_id);
      }
      if (nwc_nw_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"NWC_NW_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(nwc_nw_id);
      }
      if (nwc_nwc_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"NWC_NWC_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(nwc_nwc_id);
      }
      if (n01_changed) {
      ...
      answer = answer +" WHERE  NWC_ID = ? ";
      updateStatementPart.addStatementParam(nwc_id);
      updateStatementPart.setStatementPart(answer);
      return updateStatementPart;
   }
   public String toString() {
      return "{\"SprNewsCommentsDAO\":{\"nwc_id\": \""+getNwc_id()+"\", \"nwc_comment\": \""+getNwc_comment()+"\", \"nwc_create_date\": \""+getNwc_create_date()+"\", \"nwc_usr_id\": \""+getNwc_usr_id()+"\", \"nwc_nw_id\": \""+getNwc_nw_id()+"\", \"nwc_nwc_id\": \""+getNwc_nwc_id()+"\", \"rec_version\": \""+getRec_version()+"\", \"rec_create_timestamp\": \""+getRec_create_timestamp()+"\", \"rec_userid\": \""+getRec_userid()+"\", \"rec_timestamp\": \""+getRec_timestamp()+"\", \"n01\": \""+getN01()+"\", \"n02\": \""+getN02()+"\", \"n03\": \""+getN03()+"\", \"n04\": \""+getN04()+"\", \"n05\": \""+getN05()+"\", \"c01\": \""+getC01()+"\", \"c02\": \""+getC02()+"\", \"c03\": \""+getC03()+"\", \"c04\": \""+getC04()+"\", \"c05\": \""+getC05()+"\", \"d01\": \""+getD01()+"\", \"d02\": \""+getD02()+"\", \"d03\": \""+getD03()+"\", \"d04\": \""+getD04()+"\", \"d05\": \""+getD05()+"\"}}";
   }

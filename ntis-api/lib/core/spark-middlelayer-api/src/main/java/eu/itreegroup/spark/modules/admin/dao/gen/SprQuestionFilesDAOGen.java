...
public class SprQuestionFilesDAOGen extends SprBaseDAO{
   public static String IDENTIFIER="SPR_QUESTION_FILES.FCF_ID";
   private Double fcf_id;
   private Double fcf_fil_id;
   private Double fcf_fac_id;
   ...
   protected boolean fcf_id_changed;
   protected boolean fcf_fil_id_changed;
   protected boolean fcf_fac_id_changed;
   ...
   public SprQuestionFilesDAOGen() {
      markObjectAsInitial();
      setRecordLoaded(false);
      setForceUpdate(false);
   }
   public SprQuestionFilesDAOGen(Double fcf_id, Double fcf_fil_id, Double fcf_fac_id, Double rec_version, Date rec_create_timestamp, String rec_userid, Date rec_timestamp, Double n01, Double n02, Double n03, Double n04, Double n05, String c01, String c02, String c03, String c04, String c05, Date d01, Date d02, Date d03, Date d04, Date d05) {
      this.fcf_id = fcf_id;
      this.fcf_fil_id = fcf_fil_id;
      this.fcf_fac_id = fcf_fac_id;
   ...
   public void copyValues(SprQuestionFilesDAOGen obj) {
      this.setFcf_id(obj.getFcf_id());
      this.setFcf_fil_id(obj.getFcf_fil_id());
      this.setFcf_fac_id(obj.getFcf_fac_id());
   ...
   protected void markObjectAsInitial() {
      this.fcf_id_changed = false;
      this.fcf_fil_id_changed = false;
      this.fcf_fac_id_changed = false;
   ...
   public void setFcf_id(Double fcf_id) {
      if (this.isForceUpdate() || 
               (this.fcf_id != null && !this.fcf_id.equals(fcf_id))  ||
               (fcf_id != null && !fcf_id.equals(this.fcf_id)) ){
         this.fcf_id_changed = true; 
         this.record_changed = true;
         this.fcf_id = fcf_id;
      }
   }
   public Double getFcf_id() {
      return this.fcf_id;
   }
   public void setFcf_fil_id(Double fcf_fil_id) {
      if (this.isForceUpdate() || 
               (this.fcf_fil_id != null && !this.fcf_fil_id.equals(fcf_fil_id))  ||
               (fcf_fil_id != null && !fcf_fil_id.equals(this.fcf_fil_id)) ){
         this.fcf_fil_id_changed = true; 
         this.record_changed = true;
         this.fcf_fil_id = fcf_fil_id;
      }
   }
   public Double getFcf_fil_id() {
      return this.fcf_fil_id;
   }
   public void setFcf_fac_id(Double fcf_fac_id) {
      if (this.isForceUpdate() || 
               (this.fcf_fac_id != null && !this.fcf_fac_id.equals(fcf_fac_id))  ||
               (fcf_fac_id != null && !fcf_fac_id.equals(this.fcf_fac_id)) ){
         this.fcf_fac_id_changed = true; 
         this.record_changed = true;
         this.fcf_fac_id = fcf_fac_id;
      }
   }
   public Double getFcf_fac_id() {
      return this.fcf_fac_id;
   }
   ...
   public Date getD05() {
    ...
    public void setRecordIdentifier(Object recIdentifier) {
        if (recIdentifier != null && !EMPTY_STRING.equals(recIdentifier)  && !"null".equalsIgnoreCase(recIdentifier.toString())){
            this.fcf_id = (Double)recIdentifier;
        }
    }
    @JsonIgnore
    ...
    public void validateObject(int operation, SprBaseDBServiceImpl<?> baseService) throws SparkBusinessException{
      if (fcf_fil_id_changed || operation == Utils.OPERATION_INSERT) {
         if (fcf_fil_id== null) {
            throw new SparkBusinessException(new S2Message("SPR_QUESTION_FILES", "FCF_FIL_ID", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }
      }
      if (fcf_fac_id_changed || operation == Utils.OPERATION_INSERT) {
         if (fcf_fac_id== null) {
            throw new SparkBusinessException(new S2Message("SPR_QUESTION_FILES", "FCF_FAC_ID", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }else{
            if (fcf_fac_id!= null && (""+fcf_fac_id.intValue()).length()>12) {
               throw new SparkBusinessException(new S2Message("SPR_QUESTION_FILES", "FCF_FAC_ID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"12"));
            }
         }
      }
      if (rec_version_changed || operation == Utils.OPERATION_INSERT) {
         if (rec_version!= null && (""+rec_version.intValue()).length()>6) {
            throw new SparkBusinessException(new S2Message("SPR_QUESTION_FILES", "REC_VERSION", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"6"));
         }
      }
      if (rec_userid_changed || operation == Utils.OPERATION_INSERT) {
         if (rec_userid!= null && rec_userid.length()>128) {
            throw new SparkBusinessException(new S2Message("SPR_QUESTION_FILES", "REC_USERID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"128"));
         }
      }
      if (c01_changed || operation == Utils.OPERATION_INSERT) {
         if (c01!= null && c01.length()>4000) {
            throw new SparkBusinessException(new S2Message("SPR_QUESTION_FILES", "C01", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"4000"));
         }
      }
      if (c02_changed || operation == Utils.OPERATION_INSERT) {
         if (c02!= null && c02.length()>4000) {
            throw new SparkBusinessException(new S2Message("SPR_QUESTION_FILES", "C02", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"4000"));
         }
      }
      if (c03_changed || operation == Utils.OPERATION_INSERT) {
         if (c03!= null && c03.length()>4000) {
            throw new SparkBusinessException(new S2Message("SPR_QUESTION_FILES", "C03", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"4000"));
         }
      }
      if (c04_changed || operation == Utils.OPERATION_INSERT) {
         if (c04!= null && c04.length()>4000) {
            throw new SparkBusinessException(new S2Message("SPR_QUESTION_FILES", "C04", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"4000"));
         }
      }
      if (c05_changed || operation == Utils.OPERATION_INSERT) {
         if (c05!= null && c05.length()>4000) {
            throw new SparkBusinessException(new S2Message("SPR_QUESTION_FILES", "C05", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"4000"));
         }
      }
   }
   ...
   public UpdateStatementPart constructUpdatePart(String userName) {
      ...
      String answer = "UPDATE SPR_QUESTION_FILES SET ";
      boolean changedExists = false;      if (fcf_fil_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"FCF_FIL_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(fcf_fil_id);
      }
      if (fcf_fac_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"FCF_FAC_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(fcf_fac_id);
      }
      if (n01_changed) {
      ...
      answer = answer +" WHERE  FCF_ID = ? ";
      updateStatementPart.addStatementParam(fcf_id);
      updateStatementPart.setStatementPart(answer);
      return updateStatementPart;
   }
   public String toString() {
      return "{\"SprQuestionFilesDAO\":{\"fcf_id\": \""+getFcf_id()+"\", \"fcf_fil_id\": \""+getFcf_fil_id()+"\", \"fcf_fac_id\": \""+getFcf_fac_id()+"\", \"rec_version\": \""+getRec_version()+"\", \"rec_create_timestamp\": \""+getRec_create_timestamp()+"\", \"rec_userid\": \""+getRec_userid()+"\", \"rec_timestamp\": \""+getRec_timestamp()+"\", \"n01\": \""+getN01()+"\", \"n02\": \""+getN02()+"\", \"n03\": \""+getN03()+"\", \"n04\": \""+getN04()+"\", \"n05\": \""+getN05()+"\", \"c01\": \""+getC01()+"\", \"c02\": \""+getC02()+"\", \"c03\": \""+getC03()+"\", \"c04\": \""+getC04()+"\", \"c05\": \""+getC05()+"\", \"d01\": \""+getD01()+"\", \"d02\": \""+getD02()+"\", \"d03\": \""+getD03()+"\", \"d04\": \""+getD04()+"\", \"d05\": \""+getD05()+"\"}}";
   }

...
public class SprJobRequestExecutionsDAOGen extends SprBaseDAO{
   public static String IDENTIFIER="SPR_JOB_REQUEST_EXECUTIONS.JRE_ID";
   private Double jre_id;
   private String jre_name;
   private Date jre_time;
   private String jre_event_info;
   private String jre_err;
   private Double jre_jrq_id;
   ...
   protected boolean jre_id_changed;
   protected boolean jre_name_changed;
   protected boolean jre_time_changed;
   protected boolean jre_event_info_changed;
   protected boolean jre_err_changed;
   protected boolean jre_jrq_id_changed;
   ...
   public SprJobRequestExecutionsDAOGen() {
      markObjectAsInitial();
      setRecordLoaded(false);
      setForceUpdate(false);
   }
   public SprJobRequestExecutionsDAOGen(Double jre_id, String jre_name, Date jre_time, String jre_event_info, String jre_err, Double jre_jrq_id, Double rec_version, Date rec_create_timestamp, String rec_userid, Date rec_timestamp, Double n01, Double n02, Double n03, Double n04, Double n05, String c01, String c02, String c03, String c04, String c05, Date d01, Date d02, Date d03, Date d04, Date d05) {
      this.jre_id = jre_id;
      this.jre_name = jre_name;
      this.jre_time = jre_time;
      this.jre_event_info = jre_event_info;
      this.jre_err = jre_err;
      this.jre_jrq_id = jre_jrq_id;
   ...
   public void copyValues(SprJobRequestExecutionsDAOGen obj) {
      this.setJre_id(obj.getJre_id());
      this.setJre_name(obj.getJre_name());
      this.setJre_time(obj.getJre_time());
      this.setJre_event_info(obj.getJre_event_info());
      this.setJre_err(obj.getJre_err());
      this.setJre_jrq_id(obj.getJre_jrq_id());
   ...
   protected void markObjectAsInitial() {
      this.jre_id_changed = false;
      this.jre_name_changed = false;
      this.jre_time_changed = false;
      this.jre_event_info_changed = false;
      this.jre_err_changed = false;
      this.jre_jrq_id_changed = false;
   ...
   public void setJre_id(Double jre_id) {
      if (this.isForceUpdate() || 
               (this.jre_id != null && !this.jre_id.equals(jre_id))  ||
               (jre_id != null && !jre_id.equals(this.jre_id)) ){
         this.jre_id_changed = true; 
         this.record_changed = true;
         this.jre_id = jre_id;
      }
   }
   public Double getJre_id() {
      return this.jre_id;
   }
   public void setJre_name(String jre_name) {
      if (this.isForceUpdate() || 
               (this.jre_name != null && !this.jre_name.equals(jre_name))  ||
               (jre_name != null && !jre_name.equals(this.jre_name)) ){
         this.jre_name_changed = true; 
         this.record_changed = true;
         this.jre_name = jre_name;
      }
   }
   public String getJre_name() {
      return this.jre_name;
   }
   public void setJre_time(Date jre_time) {
      if (this.isForceUpdate() || 
               (this.jre_time != null && (jre_time == null ||this.jre_time.compareTo(jre_time) != 0 )) ||
               (jre_time != null && (this.jre_time == null ||jre_time.compareTo(this.jre_time) != 0 ))){
         this.jre_time_changed = true; 
         this.record_changed = true;
         this.jre_time = jre_time;
      }
   }
   public Date getJre_time() {
      return this.jre_time;
   }
   public void setJre_event_info(String jre_event_info) {
      if (this.isForceUpdate() || 
               (this.jre_event_info != null && !this.jre_event_info.equals(jre_event_info))  ||
               (jre_event_info != null && !jre_event_info.equals(this.jre_event_info)) ){
         this.jre_event_info_changed = true; 
         this.record_changed = true;
         this.jre_event_info = jre_event_info;
      }
   }
   public String getJre_event_info() {
      return this.jre_event_info;
   }
   public void setJre_err(String jre_err) {
      if (this.isForceUpdate() || 
               (this.jre_err != null && !this.jre_err.equals(jre_err))  ||
               (jre_err != null && !jre_err.equals(this.jre_err)) ){
         this.jre_err_changed = true; 
         this.record_changed = true;
         this.jre_err = jre_err;
      }
   }
   public String getJre_err() {
      return this.jre_err;
   }
   public void setJre_jrq_id(Double jre_jrq_id) {
      if (this.isForceUpdate() || 
               (this.jre_jrq_id != null && !this.jre_jrq_id.equals(jre_jrq_id))  ||
               (jre_jrq_id != null && !jre_jrq_id.equals(this.jre_jrq_id)) ){
         this.jre_jrq_id_changed = true; 
         this.record_changed = true;
         this.jre_jrq_id = jre_jrq_id;
      }
   }
   public Double getJre_jrq_id() {
      return this.jre_jrq_id;
   }
   ...
   public Date getD05() {
    ...
    public void setRecordIdentifier(Object recIdentifier) {
        if (recIdentifier != null && !EMPTY_STRING.equals(recIdentifier)  && !"null".equalsIgnoreCase(recIdentifier.toString())){
            this.jre_id = (Double)recIdentifier;
        }
    }
    @JsonIgnore
    ...
    public void validateObject(int operation, SprBaseDBServiceImpl<?> baseService) throws SparkBusinessException{
      if (jre_name_changed || operation == Utils.OPERATION_INSERT) {
         if (jre_name!= null && jre_name.length()>1000) {
            throw new SparkBusinessException(new S2Message("SPR_JOB_REQUEST_EXECUTIONS", "JRE_NAME", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"1000"));
         }
      }
      if (jre_event_info_changed || operation == Utils.OPERATION_INSERT) {
         if (jre_event_info!= null && jre_event_info.length()>4000) {
            throw new SparkBusinessException(new S2Message("SPR_JOB_REQUEST_EXECUTIONS", "JRE_EVENT_INFO", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"4000"));
         }
      }
      if (jre_err_changed || operation == Utils.OPERATION_INSERT) {
         if (jre_err!= null && jre_err.length()>4000) {
            throw new SparkBusinessException(new S2Message("SPR_JOB_REQUEST_EXECUTIONS", "JRE_ERR", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"4000"));
         }
      }
      if (jre_jrq_id_changed || operation == Utils.OPERATION_INSERT) {
         if (jre_jrq_id== null) {
            throw new SparkBusinessException(new S2Message("SPR_JOB_REQUEST_EXECUTIONS", "JRE_JRQ_ID", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }else{
            if (jre_jrq_id!= null && (""+jre_jrq_id.intValue()).length()>12) {
               throw new SparkBusinessException(new S2Message("SPR_JOB_REQUEST_EXECUTIONS", "JRE_JRQ_ID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"12"));
            }
         }
      }
      if (rec_version_changed || operation == Utils.OPERATION_INSERT) {
         if (rec_version!= null && (""+rec_version.intValue()).length()>6) {
            throw new SparkBusinessException(new S2Message("SPR_JOB_REQUEST_EXECUTIONS", "REC_VERSION", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"6"));
         }
      }
      if (rec_userid_changed || operation == Utils.OPERATION_INSERT) {
         if (rec_userid!= null && rec_userid.length()>128) {
            throw new SparkBusinessException(new S2Message("SPR_JOB_REQUEST_EXECUTIONS", "REC_USERID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"128"));
         }
      }
      if (c01_changed || operation == Utils.OPERATION_INSERT) {
         if (c01!= null && c01.length()>2000) {
            throw new SparkBusinessException(new S2Message("SPR_JOB_REQUEST_EXECUTIONS", "C01", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2000"));
         }
      }
      if (c02_changed || operation == Utils.OPERATION_INSERT) {
         if (c02!= null && c02.length()>2000) {
            throw new SparkBusinessException(new S2Message("SPR_JOB_REQUEST_EXECUTIONS", "C02", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2000"));
         }
      }
      if (c03_changed || operation == Utils.OPERATION_INSERT) {
         if (c03!= null && c03.length()>2000) {
            throw new SparkBusinessException(new S2Message("SPR_JOB_REQUEST_EXECUTIONS", "C03", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2000"));
         }
      }
      if (c04_changed || operation == Utils.OPERATION_INSERT) {
         if (c04!= null && c04.length()>2000) {
            throw new SparkBusinessException(new S2Message("SPR_JOB_REQUEST_EXECUTIONS", "C04", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2000"));
         }
      }
      if (c05_changed || operation == Utils.OPERATION_INSERT) {
         if (c05!= null && c05.length()>2000) {
            throw new SparkBusinessException(new S2Message("SPR_JOB_REQUEST_EXECUTIONS", "C05", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2000"));
         }
      }
   }
   ...
   public UpdateStatementPart constructUpdatePart(String userName) {
      ...
      String answer = "UPDATE SPR_JOB_REQUEST_EXECUTIONS SET ";
      boolean changedExists = false;      if (jre_name_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"JRE_NAME = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(jre_name);
      }
      if (jre_time_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"JRE_TIME = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(jre_time);
      }
      if (jre_event_info_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"JRE_EVENT_INFO = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(jre_event_info);
      }
      if (jre_err_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"JRE_ERR = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(jre_err);
      }
      if (jre_jrq_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"JRE_JRQ_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(jre_jrq_id);
      }
      if (n01_changed) {
      ...
      answer = answer +" WHERE  JRE_ID = ? ";
      updateStatementPart.addStatementParam(jre_id);
      updateStatementPart.setStatementPart(answer);
      return updateStatementPart;
   }
   public String toString() {
      return "{\"SprJobRequestExecutionsDAO\":{\"jre_id\": \""+getJre_id()+"\", \"jre_name\": \""+getJre_name()+"\", \"jre_time\": \""+getJre_time()+"\", \"jre_event_info\": \""+getJre_event_info()+"\", \"jre_err\": \""+getJre_err()+"\", \"jre_jrq_id\": \""+getJre_jrq_id()+"\", \"rec_version\": \""+getRec_version()+"\", \"rec_create_timestamp\": \""+getRec_create_timestamp()+"\", \"rec_userid\": \""+getRec_userid()+"\", \"rec_timestamp\": \""+getRec_timestamp()+"\", \"n01\": \""+getN01()+"\", \"n02\": \""+getN02()+"\", \"n03\": \""+getN03()+"\", \"n04\": \""+getN04()+"\", \"n05\": \""+getN05()+"\", \"c01\": \""+getC01()+"\", \"c02\": \""+getC02()+"\", \"c03\": \""+getC03()+"\", \"c04\": \""+getC04()+"\", \"c05\": \""+getC05()+"\", \"d01\": \""+getD01()+"\", \"d02\": \""+getD02()+"\", \"d03\": \""+getD03()+"\", \"d04\": \""+getD04()+"\", \"d05\": \""+getD05()+"\"}}";
   }

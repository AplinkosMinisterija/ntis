...
public class SprFormActionsDAOGen extends SprBaseDAO{
   public static String IDENTIFIER="SPR_FORM_ACTIONS.FRA_ID";
   private Double fra_id;
   private String fra_code;
   private String fra_name;
   private String fra_description;
   private Double fra_frm_id;
   ...
   protected boolean fra_id_changed;
   protected boolean fra_code_changed;
   protected boolean fra_name_changed;
   protected boolean fra_description_changed;
   protected boolean fra_frm_id_changed;
   ...
   public SprFormActionsDAOGen() {
      markObjectAsInitial();
      setRecordLoaded(false);
      setForceUpdate(false);
   }
   public SprFormActionsDAOGen(Double fra_id, String fra_code, String fra_name, String fra_description, Double fra_frm_id, Double rec_version, Date rec_create_timestamp, String rec_userid, Date rec_timestamp, Double n01, Double n02, Double n03, Double n04, Double n05, String c01, String c02, String c03, String c04, String c05, Date d01, Date d02, Date d03, Date d04, Date d05) {
      this.fra_id = fra_id;
      this.fra_code = fra_code;
      this.fra_name = fra_name;
      this.fra_description = fra_description;
      this.fra_frm_id = fra_frm_id;
   ...
   public void copyValues(SprFormActionsDAOGen obj) {
      this.setFra_id(obj.getFra_id());
      this.setFra_code(obj.getFra_code());
      this.setFra_name(obj.getFra_name());
      this.setFra_description(obj.getFra_description());
      this.setFra_frm_id(obj.getFra_frm_id());
   ...
   protected void markObjectAsInitial() {
      this.fra_id_changed = false;
      this.fra_code_changed = false;
      this.fra_name_changed = false;
      this.fra_description_changed = false;
      this.fra_frm_id_changed = false;
   ...
   public void setFra_id(Double fra_id) {
      if (this.isForceUpdate() || 
               (this.fra_id != null && !this.fra_id.equals(fra_id))  ||
               (fra_id != null && !fra_id.equals(this.fra_id)) ){
         this.fra_id_changed = true; 
         this.record_changed = true;
         this.fra_id = fra_id;
      }
   }
   public Double getFra_id() {
      return this.fra_id;
   }
   public void setFra_code(String fra_code) {
      if (this.isForceUpdate() || 
               (this.fra_code != null && !this.fra_code.equals(fra_code))  ||
               (fra_code != null && !fra_code.equals(this.fra_code)) ){
         this.fra_code_changed = true; 
         this.record_changed = true;
         this.fra_code = fra_code;
      }
   }
   public String getFra_code() {
      return this.fra_code;
   }
   public void setFra_name(String fra_name) {
      if (this.isForceUpdate() || 
               (this.fra_name != null && !this.fra_name.equals(fra_name))  ||
               (fra_name != null && !fra_name.equals(this.fra_name)) ){
         this.fra_name_changed = true; 
         this.record_changed = true;
         this.fra_name = fra_name;
      }
   }
   ...
   public void setFra_description(String fra_description) {
      if (this.isForceUpdate() || 
               (this.fra_description != null && !this.fra_description.equals(fra_description))  ||
               (fra_description != null && !fra_description.equals(this.fra_description)) ){
         this.fra_description_changed = true; 
         this.record_changed = true;
         this.fra_description = fra_description;
      }
   }
   public String getFra_description() {
      return this.fra_description;
   }
   public void setFra_frm_id(Double fra_frm_id) {
      if (this.isForceUpdate() || 
               (this.fra_frm_id != null && !this.fra_frm_id.equals(fra_frm_id))  ||
               (fra_frm_id != null && !fra_frm_id.equals(this.fra_frm_id)) ){
         this.fra_frm_id_changed = true; 
         this.record_changed = true;
         this.fra_frm_id = fra_frm_id;
      }
   }
   public Double getFra_frm_id() {
      return this.fra_frm_id;
   }
   ...
   public Date getD05() {
    ...
    public void setRecordIdentifier(Object recIdentifier) {
        if (recIdentifier != null && !EMPTY_STRING.equals(recIdentifier)  && !"null".equalsIgnoreCase(recIdentifier.toString())){
            this.fra_id = (Double)recIdentifier;
        }
    }
    @JsonIgnore
    ...
    public void validateObject(int operation, SprBaseDBServiceImpl<?> baseService) throws SparkBusinessException{
      if (fra_code_changed || operation == Utils.OPERATION_INSERT) {
         if (fra_code== null || EMPTY_STRING.equals(fra_code)) {
            throw new SparkBusinessException(new S2Message("SPR_FORM_ACTIONS", "FRA_CODE", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }else{
            if (fra_code!= null && fra_code.length()>50) {
               throw new SparkBusinessException(new S2Message("SPR_FORM_ACTIONS", "FRA_CODE", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"50"));
            }
         }
      }
      if (fra_name_changed || operation == Utils.OPERATION_INSERT) {
         if (fra_name== null || EMPTY_STRING.equals(fra_name)) {
            throw new SparkBusinessException(new S2Message("SPR_FORM_ACTIONS", "FRA_NAME", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }else{
            if (fra_name!= null && fra_name.length()>200) {
               throw new SparkBusinessException(new S2Message("SPR_FORM_ACTIONS", "FRA_NAME", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"200"));
            }
         }
      }
      if (fra_description_changed || operation == Utils.OPERATION_INSERT) {
         if (fra_description!= null && fra_description.length()>500) {
            throw new SparkBusinessException(new S2Message("SPR_FORM_ACTIONS", "FRA_DESCRIPTION", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"500"));
         }
      }
      if (fra_frm_id_changed || operation == Utils.OPERATION_INSERT) {
         if (fra_frm_id!= null && (""+fra_frm_id.intValue()).length()>12) {
            throw new SparkBusinessException(new S2Message("SPR_FORM_ACTIONS", "FRA_FRM_ID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"12"));
         }
      }
      if (rec_version_changed || operation == Utils.OPERATION_INSERT) {
         if (rec_version!= null && (""+rec_version.intValue()).length()>6) {
            throw new SparkBusinessException(new S2Message("SPR_FORM_ACTIONS", "REC_VERSION", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"6"));
         }
      }
      if (rec_userid_changed || operation == Utils.OPERATION_INSERT) {
         if (rec_userid!= null && rec_userid.length()>128) {
            throw new SparkBusinessException(new S2Message("SPR_FORM_ACTIONS", "REC_USERID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"128"));
         }
      }
      if (c01_changed || operation == Utils.OPERATION_INSERT) {
         if (c01!= null && c01.length()>2000) {
            throw new SparkBusinessException(new S2Message("SPR_FORM_ACTIONS", "C01", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2000"));
         }
      }
      if (c02_changed || operation == Utils.OPERATION_INSERT) {
         if (c02!= null && c02.length()>2000) {
            throw new SparkBusinessException(new S2Message("SPR_FORM_ACTIONS", "C02", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2000"));
         }
      }
      if (c03_changed || operation == Utils.OPERATION_INSERT) {
         if (c03!= null && c03.length()>2000) {
            throw new SparkBusinessException(new S2Message("SPR_FORM_ACTIONS", "C03", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2000"));
         }
      }
      if (c04_changed || operation == Utils.OPERATION_INSERT) {
         if (c04!= null && c04.length()>2000) {
            throw new SparkBusinessException(new S2Message("SPR_FORM_ACTIONS", "C04", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2000"));
         }
      }
      if (c05_changed || operation == Utils.OPERATION_INSERT) {
         if (c05!= null && c05.length()>2000) {
            throw new SparkBusinessException(new S2Message("SPR_FORM_ACTIONS", "C05", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2000"));
         }
      }
   }
   ...
   public UpdateStatementPart constructUpdatePart(String userName) {
      ...
      String answer = "UPDATE SPR_FORM_ACTIONS SET ";
      boolean changedExists = false;      if (fra_code_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"FRA_CODE = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(fra_code);
      }
      if (fra_name_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"FRA_NAME = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(fra_name);
      }
      if (fra_description_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"FRA_DESCRIPTION = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(fra_description);
      }
      if (fra_frm_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"FRA_FRM_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(fra_frm_id);
      }
      if (n01_changed) {
      ...
      answer = answer +" WHERE  FRA_ID = ? ";
      updateStatementPart.addStatementParam(fra_id);
      updateStatementPart.setStatementPart(answer);
      return updateStatementPart;
   }
   public String toString() {
      return "{\"SprFormActionsDAO\":{\"fra_id\": \""+getFra_id()+"\", \"fra_code\": \""+getFra_code()+"\", \"fra_name\": \""+getFra_name()+"\", \"fra_description\": \""+getFra_description()+"\", \"fra_frm_id\": \""+getFra_frm_id()+"\", \"rec_version\": \""+getRec_version()+"\", \"rec_create_timestamp\": \""+getRec_create_timestamp()+"\", \"rec_userid\": \""+getRec_userid()+"\", \"rec_timestamp\": \""+getRec_timestamp()+"\", \"n01\": \""+getN01()+"\", \"n02\": \""+getN02()+"\", \"n03\": \""+getN03()+"\", \"n04\": \""+getN04()+"\", \"n05\": \""+getN05()+"\", \"c01\": \""+getC01()+"\", \"c02\": \""+getC02()+"\", \"c03\": \""+getC03()+"\", \"c04\": \""+getC04()+"\", \"c05\": \""+getC05()+"\", \"d01\": \""+getD01()+"\", \"d02\": \""+getD02()+"\", \"d03\": \""+getD03()+"\", \"d04\": \""+getD04()+"\", \"d05\": \""+getD05()+"\"}}";
   }

...
public class SprUserExtIdentificationsDAOGen extends SprBaseDAO{
   public static String IDENTIFIER="SPR_USER_EXT_IDENTIFICATIONS.EID_ID";
   private Double eid_id;
   private String eid_type;
   private String eid_token;
   private Double eid_usr_id;
   ...
   protected boolean eid_id_changed;
   protected boolean eid_type_changed;
   protected boolean eid_token_changed;
   protected boolean eid_usr_id_changed;
   ...
   public SprUserExtIdentificationsDAOGen() {
      markObjectAsInitial();
      setRecordLoaded(false);
      setForceUpdate(false);
   }
   public SprUserExtIdentificationsDAOGen(Double eid_id, String eid_type, String eid_token, Double eid_usr_id, Double rec_version, Date rec_create_timestamp, String rec_userid, Date rec_timestamp, Double n01, Double n02, Double n03, Double n04, Double n05, String c01, String c02, String c03, String c04, String c05, Date d01, Date d02, Date d03, Date d04, Date d05) {
      this.eid_id = eid_id;
      this.eid_type = eid_type;
      this.eid_token = eid_token;
      this.eid_usr_id = eid_usr_id;
   ...
   public void copyValues(SprUserExtIdentificationsDAOGen obj) {
      this.setEid_id(obj.getEid_id());
      this.setEid_type(obj.getEid_type());
      this.setEid_token(obj.getEid_token());
      this.setEid_usr_id(obj.getEid_usr_id());
   ...
   protected void markObjectAsInitial() {
      this.eid_id_changed = false;
      this.eid_type_changed = false;
      this.eid_token_changed = false;
      this.eid_usr_id_changed = false;
   ...
   public void setEid_id(Double eid_id) {
      if (this.isForceUpdate() || 
               (this.eid_id != null && !this.eid_id.equals(eid_id))  ||
               (eid_id != null && !eid_id.equals(this.eid_id)) ){
         this.eid_id_changed = true; 
         this.record_changed = true;
         this.eid_id = eid_id;
      }
   }
   public Double getEid_id() {
      return this.eid_id;
   }
   public void setEid_type(String eid_type) {
      if (this.isForceUpdate() || 
               (this.eid_type != null && !this.eid_type.equals(eid_type))  ||
               (eid_type != null && !eid_type.equals(this.eid_type)) ){
         this.eid_type_changed = true; 
         this.record_changed = true;
         this.eid_type = eid_type;
      }
   }
   public String getEid_type() {
      return this.eid_type;
   }
   public void setEid_token(String eid_token) {
      if (this.isForceUpdate() || 
               (this.eid_token != null && !this.eid_token.equals(eid_token))  ||
               (eid_token != null && !eid_token.equals(this.eid_token)) ){
         this.eid_token_changed = true; 
         this.record_changed = true;
         this.eid_token = eid_token;
      }
   }
   public String getEid_token() {
      return this.eid_token;
   }
   public void setEid_usr_id(Double eid_usr_id) {
      if (this.isForceUpdate() || 
               (this.eid_usr_id != null && !this.eid_usr_id.equals(eid_usr_id))  ||
               (eid_usr_id != null && !eid_usr_id.equals(this.eid_usr_id)) ){
         this.eid_usr_id_changed = true; 
         this.record_changed = true;
         this.eid_usr_id = eid_usr_id;
      }
   }
   public Double getEid_usr_id() {
      return this.eid_usr_id;
   }
   ...
   public Date getD05() {
    ...
    public void setRecordIdentifier(Object recIdentifier) {
        if (recIdentifier != null && !EMPTY_STRING.equals(recIdentifier)  && !"null".equalsIgnoreCase(recIdentifier.toString())){
            this.eid_id = (Double)recIdentifier;
        }
    }
    @JsonIgnore
    ...
    public void validateObject(int operation, SprBaseDBServiceImpl<?> baseService) throws SparkBusinessException{
      if (eid_type_changed || operation == Utils.OPERATION_INSERT) {
         if (eid_type== null || EMPTY_STRING.equals(eid_type)) {
            throw new SparkBusinessException(new S2Message("SPR_USER_EXT_IDENTIFICATIONS", "EID_TYPE", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }else{
            if (eid_type!= null && eid_type.length()>50) {
               throw new SparkBusinessException(new S2Message("SPR_USER_EXT_IDENTIFICATIONS", "EID_TYPE", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"50"));
            }
         }
      }
      if (eid_token_changed || operation == Utils.OPERATION_INSERT) {
         if (eid_token== null || EMPTY_STRING.equals(eid_token)) {
            throw new SparkBusinessException(new S2Message("SPR_USER_EXT_IDENTIFICATIONS", "EID_TOKEN", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }else{
            if (eid_token!= null && eid_token.length()>2000) {
               throw new SparkBusinessException(new S2Message("SPR_USER_EXT_IDENTIFICATIONS", "EID_TOKEN", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2000"));
            }
         }
      }
      if (eid_usr_id_changed || operation == Utils.OPERATION_INSERT) {
         if (eid_usr_id== null) {
            throw new SparkBusinessException(new S2Message("SPR_USER_EXT_IDENTIFICATIONS", "EID_USR_ID", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }else{
            if (eid_usr_id!= null && (""+eid_usr_id.intValue()).length()>12) {
               throw new SparkBusinessException(new S2Message("SPR_USER_EXT_IDENTIFICATIONS", "EID_USR_ID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"12"));
            }
         }
      }
      if (rec_version_changed || operation == Utils.OPERATION_INSERT) {
         if (rec_version!= null && (""+rec_version.intValue()).length()>6) {
            throw new SparkBusinessException(new S2Message("SPR_USER_EXT_IDENTIFICATIONS", "REC_VERSION", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"6"));
         }
      }
      if (rec_userid_changed || operation == Utils.OPERATION_INSERT) {
         if (rec_userid!= null && rec_userid.length()>128) {
            throw new SparkBusinessException(new S2Message("SPR_USER_EXT_IDENTIFICATIONS", "REC_USERID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"128"));
         }
      }
      if (c01_changed || operation == Utils.OPERATION_INSERT) {
         if (c01!= null && c01.length()>2000) {
            throw new SparkBusinessException(new S2Message("SPR_USER_EXT_IDENTIFICATIONS", "C01", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2000"));
         }
      }
      if (c02_changed || operation == Utils.OPERATION_INSERT) {
         if (c02!= null && c02.length()>2000) {
            throw new SparkBusinessException(new S2Message("SPR_USER_EXT_IDENTIFICATIONS", "C02", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2000"));
         }
      }
      if (c03_changed || operation == Utils.OPERATION_INSERT) {
         if (c03!= null && c03.length()>2000) {
            throw new SparkBusinessException(new S2Message("SPR_USER_EXT_IDENTIFICATIONS", "C03", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2000"));
         }
      }
      if (c04_changed || operation == Utils.OPERATION_INSERT) {
         if (c04!= null && c04.length()>2000) {
            throw new SparkBusinessException(new S2Message("SPR_USER_EXT_IDENTIFICATIONS", "C04", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2000"));
         }
      }
      if (c05_changed || operation == Utils.OPERATION_INSERT) {
         if (c05!= null && c05.length()>2000) {
            throw new SparkBusinessException(new S2Message("SPR_USER_EXT_IDENTIFICATIONS", "C05", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2000"));
         }
      }
   }
   ...
   public UpdateStatementPart constructUpdatePart(String userName) {
      ...
      String answer = "UPDATE SPR_USER_EXT_IDENTIFICATIONS SET ";
      boolean changedExists = false;      if (eid_type_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"EID_TYPE = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(eid_type);
      }
      if (eid_token_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"EID_TOKEN = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(eid_token);
      }
      if (eid_usr_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"EID_USR_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(eid_usr_id);
      }
      if (n01_changed) {

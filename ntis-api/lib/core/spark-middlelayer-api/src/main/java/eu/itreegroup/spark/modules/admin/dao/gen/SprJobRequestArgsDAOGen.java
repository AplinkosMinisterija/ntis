...
public class SprJobRequestArgsDAOGen extends SprBaseDAO{
   public static String IDENTIFIER="SPR_JOB_REQUEST_ARGS.JRA_ID";
   private Double jra_id;
   private String jra_value;
   private String jra_name;
   private Double jra_jrq_id;
   ...
   protected boolean jra_id_changed;
   protected boolean jra_value_changed;
   protected boolean jra_name_changed;
   protected boolean jra_jrq_id_changed;
   ...
   public SprJobRequestArgsDAOGen() {
      markObjectAsInitial();
      setRecordLoaded(false);
      setForceUpdate(false);
   }
   public SprJobRequestArgsDAOGen(Double jra_id, String jra_value, String jra_name, Double jra_jrq_id, Double rec_version, Date rec_create_timestamp, String rec_userid, Date rec_timestamp, Double n01, Double n02, Double n03, Double n04, Double n05, String c01, String c02, String c03, String c04, String c05, Date d01, Date d02, Date d03, Date d04, Date d05) {
      this.jra_id = jra_id;
      this.jra_value = jra_value;
      this.jra_name = jra_name;
      this.jra_jrq_id = jra_jrq_id;
   ...
   public void copyValues(SprJobRequestArgsDAOGen obj) {
      this.setJra_id(obj.getJra_id());
      this.setJra_value(obj.getJra_value());
      this.setJra_name(obj.getJra_name());
      this.setJra_jrq_id(obj.getJra_jrq_id());
   ...
   protected void markObjectAsInitial() {
      this.jra_id_changed = false;
      this.jra_value_changed = false;
      this.jra_name_changed = false;
      this.jra_jrq_id_changed = false;
   ...
   public void setJra_id(Double jra_id) {
      if (this.isForceUpdate() || 
               (this.jra_id != null && !this.jra_id.equals(jra_id))  ||
               (jra_id != null && !jra_id.equals(this.jra_id)) ){
         this.jra_id_changed = true; 
         this.record_changed = true;
         this.jra_id = jra_id;
      }
   }
   public Double getJra_id() {
      return this.jra_id;
   }
   public void setJra_value(String jra_value) {
      if (this.isForceUpdate() || 
               (this.jra_value != null && !this.jra_value.equals(jra_value))  ||
               (jra_value != null && !jra_value.equals(this.jra_value)) ){
         this.jra_value_changed = true; 
         this.record_changed = true;
         this.jra_value = jra_value;
      }
   }
   public String getJra_value() {
      return this.jra_value;
   }
   public void setJra_name(String jra_name) {
      if (this.isForceUpdate() || 
               (this.jra_name != null && !this.jra_name.equals(jra_name))  ||
               (jra_name != null && !jra_name.equals(this.jra_name)) ){
         this.jra_name_changed = true; 
         this.record_changed = true;
         this.jra_name = jra_name;
      }
   }
   public String getJra_name() {
      return this.jra_name;
   }
   public void setJra_jrq_id(Double jra_jrq_id) {
      if (this.isForceUpdate() || 
               (this.jra_jrq_id != null && !this.jra_jrq_id.equals(jra_jrq_id))  ||
               (jra_jrq_id != null && !jra_jrq_id.equals(this.jra_jrq_id)) ){
         this.jra_jrq_id_changed = true; 
         this.record_changed = true;
         this.jra_jrq_id = jra_jrq_id;
      }
   }
   public Double getJra_jrq_id() {
      return this.jra_jrq_id;
   }
   ...
   public Date getD05() {
    ...
    public void setRecordIdentifier(Object recIdentifier) {
        if (recIdentifier != null && !EMPTY_STRING.equals(recIdentifier)  && !"null".equalsIgnoreCase(recIdentifier.toString())){
            this.jra_id = (Double)recIdentifier;
        }
    }
    @JsonIgnore
    ...
    public void validateObject(int operation, SprBaseDBServiceImpl<?> baseService) throws SparkBusinessException{
      if (jra_value_changed || operation == Utils.OPERATION_INSERT) {
         if (jra_value== null || EMPTY_STRING.equals(jra_value)) {
            throw new SparkBusinessException(new S2Message("SPR_JOB_REQUEST_ARGS", "JRA_VALUE", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }else{
            if (jra_value!= null && jra_value.length()>4000) {
               throw new SparkBusinessException(new S2Message("SPR_JOB_REQUEST_ARGS", "JRA_VALUE", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"4000"));
            }
         }
      }
      if (jra_name_changed || operation == Utils.OPERATION_INSERT) {
         if (jra_name== null || EMPTY_STRING.equals(jra_name)) {
            throw new SparkBusinessException(new S2Message("SPR_JOB_REQUEST_ARGS", "JRA_NAME", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }else{
            if (jra_name!= null && jra_name.length()>4000) {
               throw new SparkBusinessException(new S2Message("SPR_JOB_REQUEST_ARGS", "JRA_NAME", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"4000"));
            }
         }
      }
      if (jra_jrq_id_changed || operation == Utils.OPERATION_INSERT) {
         if (jra_jrq_id== null) {
            throw new SparkBusinessException(new S2Message("SPR_JOB_REQUEST_ARGS", "JRA_JRQ_ID", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }else{
            if (jra_jrq_id!= null && (""+jra_jrq_id.intValue()).length()>12) {
               throw new SparkBusinessException(new S2Message("SPR_JOB_REQUEST_ARGS", "JRA_JRQ_ID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"12"));
            }
         }
      }
      if (rec_version_changed || operation == Utils.OPERATION_INSERT) {
         if (rec_version!= null && (""+rec_version.intValue()).length()>6) {
            throw new SparkBusinessException(new S2Message("SPR_JOB_REQUEST_ARGS", "REC_VERSION", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"6"));
         }
      }
      if (rec_userid_changed || operation == Utils.OPERATION_INSERT) {
         if (rec_userid!= null && rec_userid.length()>128) {
            throw new SparkBusinessException(new S2Message("SPR_JOB_REQUEST_ARGS", "REC_USERID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"128"));
         }
      }
      if (c01_changed || operation == Utils.OPERATION_INSERT) {
         if (c01!= null && c01.length()>2000) {
            throw new SparkBusinessException(new S2Message("SPR_JOB_REQUEST_ARGS", "C01", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2000"));
         }
      }
      if (c02_changed || operation == Utils.OPERATION_INSERT) {
         if (c02!= null && c02.length()>2000) {
            throw new SparkBusinessException(new S2Message("SPR_JOB_REQUEST_ARGS", "C02", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2000"));
         }
      }
      if (c03_changed || operation == Utils.OPERATION_INSERT) {
         if (c03!= null && c03.length()>2000) {
            throw new SparkBusinessException(new S2Message("SPR_JOB_REQUEST_ARGS", "C03", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2000"));
         }
      }
      if (c04_changed || operation == Utils.OPERATION_INSERT) {
         if (c04!= null && c04.length()>2000) {
            throw new SparkBusinessException(new S2Message("SPR_JOB_REQUEST_ARGS", "C04", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2000"));
         }
      }
      if (c05_changed || operation == Utils.OPERATION_INSERT) {
         if (c05!= null && c05.length()>2000) {
            throw new SparkBusinessException(new S2Message("SPR_JOB_REQUEST_ARGS", "C05", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2000"));
         }
      }
   }
   ...
   public UpdateStatementPart constructUpdatePart(String userName) {
      ...
      String answer = "UPDATE SPR_JOB_REQUEST_ARGS SET ";
      boolean changedExists = false;      if (jra_value_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"JRA_VALUE = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(jra_value);
      }
      if (jra_name_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"JRA_NAME = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(jra_name);
      }
      if (jra_jrq_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"JRA_JRQ_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(jra_jrq_id);
      }
      if (n01_changed) {
      ...
      answer = answer +" WHERE  JRA_ID = ? ";
      updateStatementPart.addStatementParam(jra_id);
      updateStatementPart.setStatementPart(answer);
      return updateStatementPart;
   }
   public String toString() {
      return "{\"SprJobRequestArgsDAO\":{\"jra_id\": \""+getJra_id()+"\", \"jra_value\": \""+getJra_value()+"\", \"jra_name\": \""+getJra_name()+"\", \"jra_jrq_id\": \""+getJra_jrq_id()+"\", \"rec_version\": \""+getRec_version()+"\", \"rec_create_timestamp\": \""+getRec_create_timestamp()+"\", \"rec_userid\": \""+getRec_userid()+"\", \"rec_timestamp\": \""+getRec_timestamp()+"\", \"n01\": \""+getN01()+"\", \"n02\": \""+getN02()+"\", \"n03\": \""+getN03()+"\", \"n04\": \""+getN04()+"\", \"n05\": \""+getN05()+"\", \"c01\": \""+getC01()+"\", \"c02\": \""+getC02()+"\", \"c03\": \""+getC03()+"\", \"c04\": \""+getC04()+"\", \"c05\": \""+getC05()+"\", \"d01\": \""+getD01()+"\", \"d02\": \""+getD02()+"\", \"d03\": \""+getD03()+"\", \"d04\": \""+getD04()+"\", \"d05\": \""+getD05()+"\"}}";
   }

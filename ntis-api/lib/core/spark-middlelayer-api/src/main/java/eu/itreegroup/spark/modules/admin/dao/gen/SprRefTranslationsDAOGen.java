...
public class SprRefTranslationsDAOGen extends SprBaseDAO{
   public static String IDENTIFIER="SPR_REF_TRANSLATIONS.RFT_ID";
   private Double rft_id;
   private String rft_lang;
   private String rft_display_code;
   private String rft_description;
   private Double rft_rfc_id;
   ...
   protected boolean rft_id_changed;
   protected boolean rft_lang_changed;
   protected boolean rft_display_code_changed;
   protected boolean rft_description_changed;
   protected boolean rft_rfc_id_changed;
   ...
   public SprRefTranslationsDAOGen() {
      markObjectAsInitial();
      setRecordLoaded(false);
      setForceUpdate(false);
   }
   public SprRefTranslationsDAOGen(Double rft_id, String rft_lang, String rft_display_code, String rft_description, Double rft_rfc_id, Double rec_version, Date rec_create_timestamp, String rec_userid, Date rec_timestamp, Double n01, Double n02, Double n03, Double n04, Double n05, String c01, String c02, String c03, String c04, String c05, Date d01, Date d02, Date d03, Date d04, Date d05) {
      this.rft_id = rft_id;
      this.rft_lang = rft_lang;
      this.rft_display_code = rft_display_code;
      this.rft_description = rft_description;
      this.rft_rfc_id = rft_rfc_id;
   ...
   public void copyValues(SprRefTranslationsDAOGen obj) {
      this.setRft_id(obj.getRft_id());
      this.setRft_lang(obj.getRft_lang());
      this.setRft_display_code(obj.getRft_display_code());
      this.setRft_description(obj.getRft_description());
      this.setRft_rfc_id(obj.getRft_rfc_id());
   ...
   protected void markObjectAsInitial() {
      this.rft_id_changed = false;
      this.rft_lang_changed = false;
      this.rft_display_code_changed = false;
      this.rft_description_changed = false;
      this.rft_rfc_id_changed = false;
   ...
   public void setRft_id(Double rft_id) {
      if (this.isForceUpdate() || 
               (this.rft_id != null && !this.rft_id.equals(rft_id))  ||
               (rft_id != null && !rft_id.equals(this.rft_id)) ){
         this.rft_id_changed = true; 
         this.record_changed = true;
         this.rft_id = rft_id;
      }
   }
   public Double getRft_id() {
      return this.rft_id;
   }
   public void setRft_lang(String rft_lang) {
      if (this.isForceUpdate() || 
               (this.rft_lang != null && !this.rft_lang.equals(rft_lang))  ||
               (rft_lang != null && !rft_lang.equals(this.rft_lang)) ){
         this.rft_lang_changed = true; 
         this.record_changed = true;
         this.rft_lang = rft_lang;
      }
   }
   public String getRft_lang() {
      return this.rft_lang;
   }
   public void setRft_display_code(String rft_display_code) {
      if (this.isForceUpdate() || 
               (this.rft_display_code != null && !this.rft_display_code.equals(rft_display_code))  ||
               (rft_display_code != null && !rft_display_code.equals(this.rft_display_code)) ){
         this.rft_display_code_changed = true; 
         this.record_changed = true;
         this.rft_display_code = rft_display_code;
      }
   }
   public String getRft_display_code() {
      return this.rft_display_code;
   }
   public void setRft_description(String rft_description) {
      if (this.isForceUpdate() || 
               (this.rft_description != null && !this.rft_description.equals(rft_description))  ||
               (rft_description != null && !rft_description.equals(this.rft_description)) ){
         this.rft_description_changed = true; 
         this.record_changed = true;
         this.rft_description = rft_description;
      }
   }
   public String getRft_description() {
      return this.rft_description;
   }
   public void setRft_rfc_id(Double rft_rfc_id) {
      if (this.isForceUpdate() || 
               (this.rft_rfc_id != null && !this.rft_rfc_id.equals(rft_rfc_id))  ||
               (rft_rfc_id != null && !rft_rfc_id.equals(this.rft_rfc_id)) ){
         this.rft_rfc_id_changed = true; 
         this.record_changed = true;
         this.rft_rfc_id = rft_rfc_id;
      }
   }
   public Double getRft_rfc_id() {
      return this.rft_rfc_id;
   }
   ...
   public Date getD05() {
    ...
    public void setRecordIdentifier(Object recIdentifier) {
        if (recIdentifier != null && !EMPTY_STRING.equals(recIdentifier)  && !"null".equalsIgnoreCase(recIdentifier.toString())){
            this.rft_id = (Double)recIdentifier;
        }
    }
    @JsonIgnore
    ...
    public void validateObject(int operation, SprBaseDBServiceImpl<?> baseService) throws SparkBusinessException{
      if (rft_lang_changed || operation == Utils.OPERATION_INSERT) {
         if (rft_lang== null || EMPTY_STRING.equals(rft_lang)) {
            throw new SparkBusinessException(new S2Message("SPR_REF_TRANSLATIONS", "RFT_LANG", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }else{
            if (rft_lang!= null && rft_lang.length()>50) {
               throw new SparkBusinessException(new S2Message("SPR_REF_TRANSLATIONS", "RFT_LANG", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"50"));
            }
         }
      }
      if (rft_display_code_changed || operation == Utils.OPERATION_INSERT) {
         if (rft_display_code== null || EMPTY_STRING.equals(rft_display_code)) {
            throw new SparkBusinessException(new S2Message("SPR_REF_TRANSLATIONS", "RFT_DISPLAY_CODE", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }else{
            if (rft_display_code!= null && rft_display_code.length()>50) {
               throw new SparkBusinessException(new S2Message("SPR_REF_TRANSLATIONS", "RFT_DISPLAY_CODE", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"50"));
            }
         }
      }
      if (rft_description_changed || operation == Utils.OPERATION_INSERT) {
         if (rft_description== null || EMPTY_STRING.equals(rft_description)) {
            throw new SparkBusinessException(new S2Message("SPR_REF_TRANSLATIONS", "RFT_DESCRIPTION", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }else{
            if (rft_description!= null && rft_description.length()>200) {
               throw new SparkBusinessException(new S2Message("SPR_REF_TRANSLATIONS", "RFT_DESCRIPTION", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"200"));
            }
         }
      }
      if (rft_rfc_id_changed || operation == Utils.OPERATION_INSERT) {
         if (rft_rfc_id!= null && (""+rft_rfc_id.intValue()).length()>12) {
            throw new SparkBusinessException(new S2Message("SPR_REF_TRANSLATIONS", "RFT_RFC_ID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"12"));
         }
      }
      if (rec_version_changed || operation == Utils.OPERATION_INSERT) {
         if (rec_version!= null && (""+rec_version.intValue()).length()>6) {
            throw new SparkBusinessException(new S2Message("SPR_REF_TRANSLATIONS", "REC_VERSION", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"6"));
         }
      }
      if (rec_userid_changed || operation == Utils.OPERATION_INSERT) {
         if (rec_userid!= null && rec_userid.length()>128) {
            throw new SparkBusinessException(new S2Message("SPR_REF_TRANSLATIONS", "REC_USERID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"128"));
         }
      }
      if (c01_changed || operation == Utils.OPERATION_INSERT) {
         if (c01!= null && c01.length()>2000) {
            throw new SparkBusinessException(new S2Message("SPR_REF_TRANSLATIONS", "C01", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2000"));
         }
      }
      if (c02_changed || operation == Utils.OPERATION_INSERT) {
         if (c02!= null && c02.length()>2000) {
            throw new SparkBusinessException(new S2Message("SPR_REF_TRANSLATIONS", "C02", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2000"));
         }
      }
      if (c03_changed || operation == Utils.OPERATION_INSERT) {
         if (c03!= null && c03.length()>2000) {
            throw new SparkBusinessException(new S2Message("SPR_REF_TRANSLATIONS", "C03", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2000"));
         }
      }
      if (c04_changed || operation == Utils.OPERATION_INSERT) {
         if (c04!= null && c04.length()>2000) {
            throw new SparkBusinessException(new S2Message("SPR_REF_TRANSLATIONS", "C04", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2000"));
         }
      }
      if (c05_changed || operation == Utils.OPERATION_INSERT) {
         if (c05!= null && c05.length()>2000) {
            throw new SparkBusinessException(new S2Message("SPR_REF_TRANSLATIONS", "C05", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2000"));
         }
      }
   }
   ...
   public UpdateStatementPart constructUpdatePart(String userName) {
      ...
      String answer = "UPDATE SPR_REF_TRANSLATIONS SET ";
      boolean changedExists = false;      if (rft_lang_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"RFT_LANG = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(rft_lang);
      }
      if (rft_display_code_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"RFT_DISPLAY_CODE = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(rft_display_code);
      }
      if (rft_description_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"RFT_DESCRIPTION = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(rft_description);
      }
      if (rft_rfc_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"RFT_RFC_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(rft_rfc_id);
      }
      if (n01_changed) {
      ...
      answer = answer +" WHERE  RFT_ID = ? ";
      updateStatementPart.addStatementParam(rft_id);
      updateStatementPart.setStatementPart(answer);
      return updateStatementPart;
   }
   public String toString() {
      return "{\"SprRefTranslationsDAO\":{\"rft_id\": \""+getRft_id()+"\", \"rft_lang\": \""+getRft_lang()+"\", \"rft_display_code\": \""+getRft_display_code()+"\", \"rft_description\": \""+getRft_description()+"\", \"rft_rfc_id\": \""+getRft_rfc_id()+"\", \"rec_version\": \""+getRec_version()+"\", \"rec_create_timestamp\": \""+getRec_create_timestamp()+"\", \"rec_userid\": \""+getRec_userid()+"\", \"rec_timestamp\": \""+getRec_timestamp()+"\", \"n01\": \""+getN01()+"\", \"n02\": \""+getN02()+"\", \"n03\": \""+getN03()+"\", \"n04\": \""+getN04()+"\", \"n05\": \""+getN05()+"\", \"c01\": \""+getC01()+"\", \"c02\": \""+getC02()+"\", \"c03\": \""+getC03()+"\", \"c04\": \""+getC04()+"\", \"c05\": \""+getC05()+"\", \"d01\": \""+getD01()+"\", \"d02\": \""+getD02()+"\", \"d03\": \""+getD03()+"\", \"d04\": \""+getD04()+"\", \"d05\": \""+getD05()+"\"}}";
   }

...
public class SprOrgUserRolesDAOGen extends SprBaseDAO{
   public static String IDENTIFIER="SPR_ORG_USER_ROLES.OUR_ID";
   private Double our_id;
   private Date our_date_from;
   private Date our_date_to;
   private Double our_ou_id;
   private Double our_rol_id;
   ...
   protected boolean our_id_changed;
   protected boolean our_date_from_changed;
   protected boolean our_date_to_changed;
   protected boolean our_ou_id_changed;
   protected boolean our_rol_id_changed;
   ...
   public SprOrgUserRolesDAOGen() {
      markObjectAsInitial();
      setRecordLoaded(false);
      setForceUpdate(false);
   }
   public SprOrgUserRolesDAOGen(Double our_id, Date our_date_from, Date our_date_to, Double our_ou_id, Double our_rol_id, Double rec_version, Date rec_create_timestamp, String rec_userid, Date rec_timestamp, Double n01, Double n02, Double n03, Double n04, Double n05, String c01, String c02, String c03, String c04, String c05, Date d01, Date d02, Date d03, Date d04, Date d05) {
      this.our_id = our_id;
      this.our_date_from = our_date_from;
      this.our_date_to = our_date_to;
      this.our_ou_id = our_ou_id;
      this.our_rol_id = our_rol_id;
   ...
   public void copyValues(SprOrgUserRolesDAOGen obj) {
      this.setOur_id(obj.getOur_id());
      this.setOur_date_from(obj.getOur_date_from());
      this.setOur_date_to(obj.getOur_date_to());
      this.setOur_ou_id(obj.getOur_ou_id());
      this.setOur_rol_id(obj.getOur_rol_id());
   ...
   protected void markObjectAsInitial() {
      this.our_id_changed = false;
      this.our_date_from_changed = false;
      this.our_date_to_changed = false;
      this.our_ou_id_changed = false;
      this.our_rol_id_changed = false;
   ...
   public void setOur_id(Double our_id) {
      if (this.isForceUpdate() || 
               (this.our_id != null && !this.our_id.equals(our_id))  ||
               (our_id != null && !our_id.equals(this.our_id)) ){
         this.our_id_changed = true; 
   ...
   public void setOur_date_from(Date our_date_from) {
      if (this.isForceUpdate() || 
               (this.our_date_from != null && (our_date_from == null ||this.our_date_from.compareTo(our_date_from) != 0 )) ||
               (our_date_from != null && (this.our_date_from == null ||our_date_from.compareTo(this.our_date_from) != 0 ))){
         this.our_date_from_changed = true; 
         this.record_changed = true;
         this.our_date_from = our_date_from;
      }
   }
   public Date getOur_date_from() {
      return this.our_date_from;
   }
   public void setOur_date_to(Date our_date_to) {
      if (this.isForceUpdate() || 
               (this.our_date_to != null && (our_date_to == null ||this.our_date_to.compareTo(our_date_to) != 0 )) ||
               (our_date_to != null && (this.our_date_to == null ||our_date_to.compareTo(this.our_date_to) != 0 ))){
         this.our_date_to_changed = true; 
         this.record_changed = true;
         this.our_date_to = our_date_to;
      }
   }
   public Date getOur_date_to() {
      return this.our_date_to;
   }
   public void setOur_ou_id(Double our_ou_id) {
      if (this.isForceUpdate() || 
               (this.our_ou_id != null && !this.our_ou_id.equals(our_ou_id))  ||
               (our_ou_id != null && !our_ou_id.equals(this.our_ou_id)) ){
         this.our_ou_id_changed = true; 
         this.record_changed = true;
         this.our_ou_id = our_ou_id;
      }
   }
   public Double getOur_ou_id() {
      return this.our_ou_id;
   }
   public void setOur_rol_id(Double our_rol_id) {
      if (this.isForceUpdate() || 
               (this.our_rol_id != null && !this.our_rol_id.equals(our_rol_id))  ||
               (our_rol_id != null && !our_rol_id.equals(this.our_rol_id)) ){
         this.our_rol_id_changed = true; 
         this.record_changed = true;
         this.our_rol_id = our_rol_id;
      }
   }
   public Double getOur_rol_id() {
      return this.our_rol_id;
   }
   ...
   public Date getD05() {
    ...
    public void setRecordIdentifier(Object recIdentifier) {
        if (recIdentifier != null && !EMPTY_STRING.equals(recIdentifier)  && !"null".equalsIgnoreCase(recIdentifier.toString())){
            this.our_id = (Double)recIdentifier;
        }
    }
    @JsonIgnore
    ...
    public void validateObject(int operation, SprBaseDBServiceImpl<?> baseService) throws SparkBusinessException{
      if (our_date_from_changed || operation == Utils.OPERATION_INSERT) {
         if (our_date_from== null) {
            throw new SparkBusinessException(new S2Message("SPR_ORG_USER_ROLES", "OUR_DATE_FROM", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }
      }
      if (our_ou_id_changed || operation == Utils.OPERATION_INSERT) {
         if (our_ou_id== null) {
            throw new SparkBusinessException(new S2Message("SPR_ORG_USER_ROLES", "OUR_OU_ID", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }else{
            if (our_ou_id!= null && (""+our_ou_id.intValue()).length()>12) {
               throw new SparkBusinessException(new S2Message("SPR_ORG_USER_ROLES", "OUR_OU_ID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"12"));
            }
         }
      }
      if (our_rol_id_changed || operation == Utils.OPERATION_INSERT) {
         if (our_rol_id== null) {
            throw new SparkBusinessException(new S2Message("SPR_ORG_USER_ROLES", "OUR_ROL_ID", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }else{
            if (our_rol_id!= null && (""+our_rol_id.intValue()).length()>12) {
               throw new SparkBusinessException(new S2Message("SPR_ORG_USER_ROLES", "OUR_ROL_ID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"12"));
            }
         }
      }
      if (rec_version_changed || operation == Utils.OPERATION_INSERT) {
         if (rec_version!= null && (""+rec_version.intValue()).length()>6) {
            throw new SparkBusinessException(new S2Message("SPR_ORG_USER_ROLES", "REC_VERSION", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"6"));
         }
      }
      if (rec_userid_changed || operation == Utils.OPERATION_INSERT) {
         if (rec_userid!= null && rec_userid.length()>128) {
            throw new SparkBusinessException(new S2Message("SPR_ORG_USER_ROLES", "REC_USERID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"128"));
         }
      }
      if (c01_changed || operation == Utils.OPERATION_INSERT) {
         if (c01!= null && c01.length()>2000) {
            throw new SparkBusinessException(new S2Message("SPR_ORG_USER_ROLES", "C01", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2000"));
         }
      }
      if (c02_changed || operation == Utils.OPERATION_INSERT) {
         if (c02!= null && c02.length()>2000) {
            throw new SparkBusinessException(new S2Message("SPR_ORG_USER_ROLES", "C02", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2000"));
         }
      }
      if (c03_changed || operation == Utils.OPERATION_INSERT) {
         if (c03!= null && c03.length()>2000) {
            throw new SparkBusinessException(new S2Message("SPR_ORG_USER_ROLES", "C03", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2000"));
         }
      }
      if (c04_changed || operation == Utils.OPERATION_INSERT) {
         if (c04!= null && c04.length()>2000) {
            throw new SparkBusinessException(new S2Message("SPR_ORG_USER_ROLES", "C04", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2000"));
         }
      }
      if (c05_changed || operation == Utils.OPERATION_INSERT) {
         if (c05!= null && c05.length()>2000) {
            throw new SparkBusinessException(new S2Message("SPR_ORG_USER_ROLES", "C05", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2000"));
         }
      }
   }
   ...
   public UpdateStatementPart constructUpdatePart(String userName) {
      ...
      String answer = "UPDATE SPR_ORG_USER_ROLES SET ";
      boolean changedExists = false;      if (our_date_from_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"OUR_DATE_FROM = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(our_date_from);
      }
      if (our_date_to_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"OUR_DATE_TO = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(our_date_to);
      }
      if (our_ou_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"OUR_OU_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(our_ou_id);
      }
      if (our_rol_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"OUR_ROL_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(our_rol_id);
      }
      if (n01_changed) {
      ...
      answer = answer +" WHERE  OUR_ID = ? ";
      updateStatementPart.addStatementParam(our_id);
      updateStatementPart.setStatementPart(answer);
      return updateStatementPart;
   }
   public String toString() {
      return "{\"SprOrgUserRolesDAO\":{\"our_id\": \""+getOur_id()+"\", \"our_date_from\": \""+getOur_date_from()+"\", \"our_date_to\": \""+getOur_date_to()+"\", \"our_ou_id\": \""+getOur_ou_id()+"\", \"our_rol_id\": \""+getOur_rol_id()+"\", \"rec_version\": \""+getRec_version()+"\", \"rec_create_timestamp\": \""+getRec_create_timestamp()+"\", \"rec_userid\": \""+getRec_userid()+"\", \"rec_timestamp\": \""+getRec_timestamp()+"\", \"n01\": \""+getN01()+"\", \"n02\": \""+getN02()+"\", \"n03\": \""+getN03()+"\", \"n04\": \""+getN04()+"\", \"n05\": \""+getN05()+"\", \"c01\": \""+getC01()+"\", \"c02\": \""+getC02()+"\", \"c03\": \""+getC03()+"\", \"c04\": \""+getC04()+"\", \"c05\": \""+getC05()+"\", \"d01\": \""+getD01()+"\", \"d02\": \""+getD02()+"\", \"d03\": \""+getD03()+"\", \"d04\": \""+getD04()+"\", \"d05\": \""+getD05()+"\"}}";
   }

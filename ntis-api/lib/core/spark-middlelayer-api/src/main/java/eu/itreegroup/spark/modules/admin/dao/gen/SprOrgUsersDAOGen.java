...
public class SprOrgUsersDAOGen extends SprBaseDAO{
   public static String IDENTIFIER="SPR_ORG_USERS.OU_ID";
   private Double ou_id;
   private String ou_position;
   private String ou_profile_token;
   private Date ou_date_from;
   private Date ou_date_to;
   private Double ou_usr_id;
   private Double ou_org_id;
   ...
   protected boolean ou_id_changed;
   protected boolean ou_position_changed;
   protected boolean ou_profile_token_changed;
   protected boolean ou_date_from_changed;
   protected boolean ou_date_to_changed;
   protected boolean ou_usr_id_changed;
   protected boolean ou_org_id_changed;
   ...
   public SprOrgUsersDAOGen() {
      markObjectAsInitial();
      setRecordLoaded(false);
      setForceUpdate(false);
   }
   public SprOrgUsersDAOGen(Double ou_id, String ou_position, String ou_profile_token, Date ou_date_from, Date ou_date_to, Double ou_usr_id, Double ou_org_id, Double rec_version, Date rec_create_timestamp, String rec_userid, Date rec_timestamp, Double n01, Double n02, Double n03, Double n04, Double n05, String c01, String c02, String c03, String c04, String c05, Date d01, Date d02, Date d03, Date d04, Date d05) {
      this.ou_id = ou_id;
      this.ou_position = ou_position;
      this.ou_profile_token = ou_profile_token;
   ...
   public void copyValues(SprOrgUsersDAOGen obj) {
      this.setOu_id(obj.getOu_id());
      this.setOu_position(obj.getOu_position());
      this.setOu_profile_token(obj.getOu_profile_token());
      this.setOu_date_from(obj.getOu_date_from());
      this.setOu_date_to(obj.getOu_date_to());
      this.setOu_usr_id(obj.getOu_usr_id());
      this.setOu_org_id(obj.getOu_org_id());
   ...
   protected void markObjectAsInitial() {
      this.ou_id_changed = false;
      this.ou_position_changed = false;
      this.ou_profile_token_changed = false;
      this.ou_date_from_changed = false;
      this.ou_date_to_changed = false;
      this.ou_usr_id_changed = false;
      this.ou_org_id_changed = false;
   ...
   public void setOu_id(Double ou_id) {
      if (this.isForceUpdate() || 
               (this.ou_id != null && !this.ou_id.equals(ou_id))  ||
               (ou_id != null && !ou_id.equals(this.ou_id)) ){
         this.ou_id_changed = true; 
   ...
   public void setOu_position(String ou_position) {
      if (this.isForceUpdate() || 
               (this.ou_position != null && !this.ou_position.equals(ou_position))  ||
               (ou_position != null && !ou_position.equals(this.ou_position)) ){
         this.ou_position_changed = true; 
         this.record_changed = true;
         this.ou_position = ou_position;
      }
   }
   public String getOu_position() {
      return this.ou_position;
   }
   public void setOu_profile_token(String ou_profile_token) {
      if (this.isForceUpdate() || 
               (this.ou_profile_token != null && !this.ou_profile_token.equals(ou_profile_token))  ||
               (ou_profile_token != null && !ou_profile_token.equals(this.ou_profile_token)) ){
         this.ou_profile_token_changed = true; 
         this.record_changed = true;
         this.ou_profile_token = ou_profile_token;
      }
   }
   public String getOu_profile_token() {
      return this.ou_profile_token;
   }
   public void setOu_date_from(Date ou_date_from) {
      if (this.isForceUpdate() || 
               (this.ou_date_from != null && (ou_date_from == null ||this.ou_date_from.compareTo(ou_date_from) != 0 )) ||
               (ou_date_from != null && (this.ou_date_from == null ||ou_date_from.compareTo(this.ou_date_from) != 0 ))){
         this.ou_date_from_changed = true; 
         this.record_changed = true;
         this.ou_date_from = ou_date_from;
      }
   }
   public Date getOu_date_from() {
      return this.ou_date_from;
   }
   public void setOu_date_to(Date ou_date_to) {
      if (this.isForceUpdate() || 
               (this.ou_date_to != null && (ou_date_to == null ||this.ou_date_to.compareTo(ou_date_to) != 0 )) ||
               (ou_date_to != null && (this.ou_date_to == null ||ou_date_to.compareTo(this.ou_date_to) != 0 ))){
         this.ou_date_to_changed = true; 
         this.record_changed = true;
         this.ou_date_to = ou_date_to;
      }
   }
   public Date getOu_date_to() {
      return this.ou_date_to;
   }
   public void setOu_usr_id(Double ou_usr_id) {
      if (this.isForceUpdate() || 
               (this.ou_usr_id != null && !this.ou_usr_id.equals(ou_usr_id))  ||
               (ou_usr_id != null && !ou_usr_id.equals(this.ou_usr_id)) ){
         this.ou_usr_id_changed = true; 
         this.record_changed = true;
         this.ou_usr_id = ou_usr_id;
      }
   }
   public Double getOu_usr_id() {
      return this.ou_usr_id;
   }
   public void setOu_org_id(Double ou_org_id) {
      if (this.isForceUpdate() || 
               (this.ou_org_id != null && !this.ou_org_id.equals(ou_org_id))  ||
               (ou_org_id != null && !ou_org_id.equals(this.ou_org_id)) ){
         this.ou_org_id_changed = true; 
         this.record_changed = true;
         this.ou_org_id = ou_org_id;
      }
   }
   public Double getOu_org_id() {
      return this.ou_org_id;
   }
   ...
   public Date getD05() {
    ...
    public void setRecordIdentifier(Object recIdentifier) {
        if (recIdentifier != null && !EMPTY_STRING.equals(recIdentifier)  && !"null".equalsIgnoreCase(recIdentifier.toString())){
            this.ou_id = (Double)recIdentifier;
        }
    }
    @JsonIgnore
    ...
    public void validateObject(int operation, SprBaseDBServiceImpl<?> baseService) throws SparkBusinessException{
      if (ou_position_changed || operation == Utils.OPERATION_INSERT) {
         if (ou_position!= null && ou_position.length()>50) {
            throw new SparkBusinessException(new S2Message("SPR_ORG_USERS", "OU_POSITION", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"50"));
         }
      }
      if (ou_profile_token_changed || operation == Utils.OPERATION_INSERT) {
         if (ou_profile_token!= null && ou_profile_token.length()>2000) {
            throw new SparkBusinessException(new S2Message("SPR_ORG_USERS", "OU_PROFILE_TOKEN", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2000"));
         }
      }
      if (ou_date_from_changed || operation == Utils.OPERATION_INSERT) {
         if (ou_date_from== null) {
            throw new SparkBusinessException(new S2Message("SPR_ORG_USERS", "OU_DATE_FROM", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }
      }
      if (ou_usr_id_changed || operation == Utils.OPERATION_INSERT) {
         if (ou_usr_id== null) {
            throw new SparkBusinessException(new S2Message("SPR_ORG_USERS", "OU_USR_ID", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }else{
            if (ou_usr_id!= null && (""+ou_usr_id.intValue()).length()>12) {
               throw new SparkBusinessException(new S2Message("SPR_ORG_USERS", "OU_USR_ID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"12"));
            }
         }
      }
      if (ou_org_id_changed || operation == Utils.OPERATION_INSERT) {
         if (ou_org_id== null) {
            throw new SparkBusinessException(new S2Message("SPR_ORG_USERS", "OU_ORG_ID", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }else{
            if (ou_org_id!= null && (""+ou_org_id.intValue()).length()>12) {
               throw new SparkBusinessException(new S2Message("SPR_ORG_USERS", "OU_ORG_ID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"12"));
            }
         }
      }
      if (rec_version_changed || operation == Utils.OPERATION_INSERT) {
         if (rec_version!= null && (""+rec_version.intValue()).length()>6) {
            throw new SparkBusinessException(new S2Message("SPR_ORG_USERS", "REC_VERSION", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"6"));
         }
      }
      if (rec_userid_changed || operation == Utils.OPERATION_INSERT) {
         if (rec_userid!= null && rec_userid.length()>128) {
            throw new SparkBusinessException(new S2Message("SPR_ORG_USERS", "REC_USERID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"128"));
         }
      }
      if (c01_changed || operation == Utils.OPERATION_INSERT) {
         if (c01!= null && c01.length()>2000) {
            throw new SparkBusinessException(new S2Message("SPR_ORG_USERS", "C01", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2000"));
         }
      }
      if (c02_changed || operation == Utils.OPERATION_INSERT) {
         if (c02!= null && c02.length()>2000) {
            throw new SparkBusinessException(new S2Message("SPR_ORG_USERS", "C02", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2000"));
         }
      }
      if (c03_changed || operation == Utils.OPERATION_INSERT) {
         if (c03!= null && c03.length()>2000) {
            throw new SparkBusinessException(new S2Message("SPR_ORG_USERS", "C03", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2000"));
         }
      }
      if (c04_changed || operation == Utils.OPERATION_INSERT) {
         if (c04!= null && c04.length()>2000) {
            throw new SparkBusinessException(new S2Message("SPR_ORG_USERS", "C04", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2000"));
         }
      }
      if (c05_changed || operation == Utils.OPERATION_INSERT) {
         if (c05!= null && c05.length()>2000) {
            throw new SparkBusinessException(new S2Message("SPR_ORG_USERS", "C05", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2000"));
         }
      }
   }
   ...
   public UpdateStatementPart constructUpdatePart(String userName) {
      ...
      String answer = "UPDATE SPR_ORG_USERS SET ";
      boolean changedExists = false;      if (ou_position_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"OU_POSITION = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(ou_position);
      }
      if (ou_profile_token_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"OU_PROFILE_TOKEN = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(ou_profile_token);
      }
      if (ou_date_from_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"OU_DATE_FROM = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(ou_date_from);
      }
      if (ou_date_to_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"OU_DATE_TO = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(ou_date_to);
      }
      if (ou_usr_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"OU_USR_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(ou_usr_id);
      }
      if (ou_org_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"OU_ORG_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(ou_org_id);
      }
      if (n01_changed) {
      ...
      answer = answer +" WHERE  OU_ID = ? ";
      updateStatementPart.addStatementParam(ou_id);
      updateStatementPart.setStatementPart(answer);
      return updateStatementPart;
   }
   public String toString() {
      return "{\"SprOrgUsersDAO\":{\"ou_id\": \""+getOu_id()+"\", \"ou_position\": \""+getOu_position()+"\", \"ou_profile_token\": \""+getOu_profile_token()+"\", \"ou_date_from\": \""+getOu_date_from()+"\", \"ou_date_to\": \""+getOu_date_to()+"\", \"ou_usr_id\": \""+getOu_usr_id()+"\", \"ou_org_id\": \""+getOu_org_id()+"\", \"rec_version\": \""+getRec_version()+"\", \"rec_create_timestamp\": \""+getRec_create_timestamp()+"\", \"rec_userid\": \""+getRec_userid()+"\", \"rec_timestamp\": \""+getRec_timestamp()+"\", \"n01\": \""+getN01()+"\", \"n02\": \""+getN02()+"\", \"n03\": \""+getN03()+"\", \"n04\": \""+getN04()+"\", \"n05\": \""+getN05()+"\", \"c01\": \""+getC01()+"\", \"c02\": \""+getC02()+"\", \"c03\": \""+getC03()+"\", \"c04\": \""+getC04()+"\", \"c05\": \""+getC05()+"\", \"d01\": \""+getD01()+"\", \"d02\": \""+getD02()+"\", \"d03\": \""+getD03()+"\", \"d04\": \""+getD04()+"\", \"d05\": \""+getD05()+"\"}}";
   }

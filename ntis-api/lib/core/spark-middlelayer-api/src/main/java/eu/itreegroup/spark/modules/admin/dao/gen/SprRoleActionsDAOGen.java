...
public class SprRoleActionsDAOGen extends SprBaseDAO{
   public static String IDENTIFIER="SPR_ROLE_ACTIONS.ROA_ID";
   private Double roa_id;
   private String roa_type;
   private Date roa_date_from;
   private Date roa_date_to;
   private String roa_default_menu_item;
   private Double roa_rol_id;
   private Double roa_mst_id;
   private Double roa_fra_id;
   private Double roa_frm_id;
   private Double roa_assigned_rol_id;
   ...
   protected boolean roa_id_changed;
   protected boolean roa_type_changed;
   protected boolean roa_date_from_changed;
   protected boolean roa_date_to_changed;
   protected boolean roa_default_menu_item_changed;
   protected boolean roa_rol_id_changed;
   protected boolean roa_mst_id_changed;
   protected boolean roa_fra_id_changed;
   protected boolean roa_frm_id_changed;
   protected boolean roa_assigned_rol_id_changed;
   ...
   public SprRoleActionsDAOGen() {
      markObjectAsInitial();
      setRecordLoaded(false);
      setForceUpdate(false);
   }
   public SprRoleActionsDAOGen(Double roa_id, String roa_type, Date roa_date_from, Date roa_date_to, String roa_default_menu_item, Double roa_rol_id, Double roa_mst_id, Double roa_fra_id, Double roa_frm_id, Double roa_assigned_rol_id, Double rec_version, Date rec_create_timestamp, String rec_userid, Date rec_timestamp, Double n01, Double n02, Double n03, Double n04, Double n05, String c01, String c02, String c03, String c04, String c05, Date d01, Date d02, Date d03, Date d04, Date d05) {
      this.roa_id = roa_id;
      this.roa_type = roa_type;
      this.roa_date_from = roa_date_from;
      this.roa_date_to = roa_date_to;
      this.roa_default_menu_item = roa_default_menu_item;
      this.roa_rol_id = roa_rol_id;
      this.roa_mst_id = roa_mst_id;
      this.roa_fra_id = roa_fra_id;
      this.roa_frm_id = roa_frm_id;
   ...
   public void copyValues(SprRoleActionsDAOGen obj) {
      this.setRoa_id(obj.getRoa_id());
      this.setRoa_type(obj.getRoa_type());
      this.setRoa_date_from(obj.getRoa_date_from());
      this.setRoa_date_to(obj.getRoa_date_to());
      this.setRoa_default_menu_item(obj.getRoa_default_menu_item());
      this.setRoa_rol_id(obj.getRoa_rol_id());
      this.setRoa_mst_id(obj.getRoa_mst_id());
      this.setRoa_fra_id(obj.getRoa_fra_id());
      this.setRoa_frm_id(obj.getRoa_frm_id());
      this.setRoa_assigned_rol_id(obj.getRoa_assigned_rol_id());
   ...
   protected void markObjectAsInitial() {
      this.roa_id_changed = false;
      this.roa_type_changed = false;
      this.roa_date_from_changed = false;
      this.roa_date_to_changed = false;
      this.roa_default_menu_item_changed = false;
      this.roa_rol_id_changed = false;
      this.roa_mst_id_changed = false;
      this.roa_fra_id_changed = false;
      this.roa_frm_id_changed = false;
      this.roa_assigned_rol_id_changed = false;
   ...
   public void setRoa_id(Double roa_id) {
      if (this.isForceUpdate() || 
               (this.roa_id != null && !this.roa_id.equals(roa_id))  ||
               (roa_id != null && !roa_id.equals(this.roa_id)) ){
         this.roa_id_changed = true; 
         this.record_changed = true;
         this.roa_id = roa_id;
      }
   }
   public Double getRoa_id() {
      return this.roa_id;
   }
   public void setRoa_type(String roa_type) {
      if (this.isForceUpdate() || 
               (this.roa_type != null && !this.roa_type.equals(roa_type))  ||
               (roa_type != null && !roa_type.equals(this.roa_type)) ){
         this.roa_type_changed = true; 
         this.record_changed = true;
         this.roa_type = roa_type;
      }
   }
   public String getRoa_type() {
      return this.roa_type;
   }
   public void setRoa_date_from(Date roa_date_from) {
      if (this.isForceUpdate() || 
               (this.roa_date_from != null && (roa_date_from == null ||this.roa_date_from.compareTo(roa_date_from) != 0 )) ||
               (roa_date_from != null && (this.roa_date_from == null ||roa_date_from.compareTo(this.roa_date_from) != 0 ))){
         this.roa_date_from_changed = true; 
         this.record_changed = true;
         this.roa_date_from = roa_date_from;
      }
   }
   public Date getRoa_date_from() {
      return this.roa_date_from;
   }
   public void setRoa_date_to(Date roa_date_to) {
      if (this.isForceUpdate() || 
               (this.roa_date_to != null && (roa_date_to == null ||this.roa_date_to.compareTo(roa_date_to) != 0 )) ||
               (roa_date_to != null && (this.roa_date_to == null ||roa_date_to.compareTo(this.roa_date_to) != 0 ))){
         this.roa_date_to_changed = true; 
         this.record_changed = true;
         this.roa_date_to = roa_date_to;
      }
   }
   public Date getRoa_date_to() {
      return this.roa_date_to;
   }
   public void setRoa_default_menu_item(String roa_default_menu_item) {
      if (this.isForceUpdate() || 
               (this.roa_default_menu_item != null && !this.roa_default_menu_item.equals(roa_default_menu_item))  ||
               (roa_default_menu_item != null && !roa_default_menu_item.equals(this.roa_default_menu_item)) ){
         this.roa_default_menu_item_changed = true; 
         this.record_changed = true;
         this.roa_default_menu_item = roa_default_menu_item;
      }
   }
   public String getRoa_default_menu_item() {
      return this.roa_default_menu_item;
   }
   public void setRoa_rol_id(Double roa_rol_id) {
      if (this.isForceUpdate() || 
               (this.roa_rol_id != null && !this.roa_rol_id.equals(roa_rol_id))  ||
               (roa_rol_id != null && !roa_rol_id.equals(this.roa_rol_id)) ){
         this.roa_rol_id_changed = true; 
         this.record_changed = true;
         this.roa_rol_id = roa_rol_id;
      }
   }
   public Double getRoa_rol_id() {
      return this.roa_rol_id;
   }
   public void setRoa_mst_id(Double roa_mst_id) {
      if (this.isForceUpdate() || 
               (this.roa_mst_id != null && !this.roa_mst_id.equals(roa_mst_id))  ||
               (roa_mst_id != null && !roa_mst_id.equals(this.roa_mst_id)) ){
         this.roa_mst_id_changed = true; 
         this.record_changed = true;
         this.roa_mst_id = roa_mst_id;
      }
   }
   public Double getRoa_mst_id() {
      return this.roa_mst_id;
   }
   public void setRoa_fra_id(Double roa_fra_id) {
      if (this.isForceUpdate() || 
               (this.roa_fra_id != null && !this.roa_fra_id.equals(roa_fra_id))  ||
               (roa_fra_id != null && !roa_fra_id.equals(this.roa_fra_id)) ){
         this.roa_fra_id_changed = true; 
         this.record_changed = true;
         this.roa_fra_id = roa_fra_id;
      }
   }
   public Double getRoa_fra_id() {
      return this.roa_fra_id;
   }
   public void setRoa_frm_id(Double roa_frm_id) {
      if (this.isForceUpdate() || 
               (this.roa_frm_id != null && !this.roa_frm_id.equals(roa_frm_id))  ||
               (roa_frm_id != null && !roa_frm_id.equals(this.roa_frm_id)) ){
         this.roa_frm_id_changed = true; 
         this.record_changed = true;
         this.roa_frm_id = roa_frm_id;
      }
   }
   public Double getRoa_frm_id() {
      return this.roa_frm_id;
   }
   public void setRoa_assigned_rol_id(Double roa_assigned_rol_id) {
      if (this.isForceUpdate() || 
               (this.roa_assigned_rol_id != null && !this.roa_assigned_rol_id.equals(roa_assigned_rol_id))  ||
               (roa_assigned_rol_id != null && !roa_assigned_rol_id.equals(this.roa_assigned_rol_id)) ){
         this.roa_assigned_rol_id_changed = true; 
         this.record_changed = true;
         this.roa_assigned_rol_id = roa_assigned_rol_id;
      }
   }
   public Double getRoa_assigned_rol_id() {
      return this.roa_assigned_rol_id;
   }
   ...
   public Date getD05() {
    ...
    public void setRecordIdentifier(Object recIdentifier) {
        if (recIdentifier != null && !EMPTY_STRING.equals(recIdentifier)  && !"null".equalsIgnoreCase(recIdentifier.toString())){
            this.roa_id = (Double)recIdentifier;
        }
    }
    @JsonIgnore
    ...
    public void validateObject(int operation, SprBaseDBServiceImpl<?> baseService) throws SparkBusinessException{
      if (roa_type_changed || operation == Utils.OPERATION_INSERT) {
         if (roa_type== null || EMPTY_STRING.equals(roa_type)) {
            throw new SparkBusinessException(new S2Message("SPR_ROLE_ACTIONS", "ROA_TYPE", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }else{
            if (roa_type!= null && roa_type.length()>50) {
               throw new SparkBusinessException(new S2Message("SPR_ROLE_ACTIONS", "ROA_TYPE", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"50"));
            }
         }
      }
      if (roa_date_from_changed || operation == Utils.OPERATION_INSERT) {
         if (roa_date_from== null) {
            throw new SparkBusinessException(new S2Message("SPR_ROLE_ACTIONS", "ROA_DATE_FROM", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }
      }
      if (roa_default_menu_item_changed || operation == Utils.OPERATION_INSERT) {
         if (roa_default_menu_item!= null && roa_default_menu_item.length()>1) {
            throw new SparkBusinessException(new S2Message("SPR_ROLE_ACTIONS", "ROA_DEFAULT_MENU_ITEM", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"1"));
         }
      }
      if (rec_userid_changed || operation == Utils.OPERATION_INSERT) {
         if (rec_userid!= null && rec_userid.length()>128) {
            throw new SparkBusinessException(new S2Message("SPR_ROLE_ACTIONS", "REC_USERID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"128"));
         }
      }
      if (c01_changed || operation == Utils.OPERATION_INSERT) {
         if (c01!= null && c01.length()>2000) {
            throw new SparkBusinessException(new S2Message("SPR_ROLE_ACTIONS", "C01", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2000"));
         }
      }
      if (c02_changed || operation == Utils.OPERATION_INSERT) {
         if (c02!= null && c02.length()>2000) {
            throw new SparkBusinessException(new S2Message("SPR_ROLE_ACTIONS", "C02", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2000"));
         }
      }
      if (c03_changed || operation == Utils.OPERATION_INSERT) {
         if (c03!= null && c03.length()>2000) {
            throw new SparkBusinessException(new S2Message("SPR_ROLE_ACTIONS", "C03", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2000"));
         }
      }
      if (c04_changed || operation == Utils.OPERATION_INSERT) {
         if (c04!= null && c04.length()>2000) {
            throw new SparkBusinessException(new S2Message("SPR_ROLE_ACTIONS", "C04", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2000"));
         }
      }
      if (c05_changed || operation == Utils.OPERATION_INSERT) {
         if (c05!= null && c05.length()>2000) {
            throw new SparkBusinessException(new S2Message("SPR_ROLE_ACTIONS", "C05", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2000"));
         }
      }
   }
   ...
   public UpdateStatementPart constructUpdatePart(String userName) {
      ...
      String answer = "UPDATE SPR_ROLE_ACTIONS SET ";
      boolean changedExists = false;      if (roa_type_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"ROA_TYPE = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(roa_type);
      }
      if (roa_date_from_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"ROA_DATE_FROM = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(roa_date_from);
      }
      if (roa_date_to_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"ROA_DATE_TO = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(roa_date_to);
      }
      if (roa_default_menu_item_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"ROA_DEFAULT_MENU_ITEM = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(roa_default_menu_item);
      }
      if (roa_rol_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"ROA_ROL_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(roa_rol_id);
      }
      if (roa_mst_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"ROA_MST_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(roa_mst_id);
      }
      if (roa_fra_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"ROA_FRA_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(roa_fra_id);
      }
      if (roa_frm_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"ROA_FRM_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(roa_frm_id);
      }
      if (roa_assigned_rol_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"ROA_ASSIGNED_ROL_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(roa_assigned_rol_id);
      }
      if (n01_changed) {
      ...
      answer = answer +" WHERE  ROA_ID = ? ";
      updateStatementPart.addStatementParam(roa_id);
      updateStatementPart.setStatementPart(answer);
      return updateStatementPart;
   }
   public String toString() {
      return "{\"SprRoleActionsDAO\":{\"roa_id\": \""+getRoa_id()+"\", \"roa_type\": \""+getRoa_type()+"\", \"roa_date_from\": \""+getRoa_date_from()+"\", \"roa_date_to\": \""+getRoa_date_to()+"\", \"roa_default_menu_item\": \""+getRoa_default_menu_item()+"\", \"roa_rol_id\": \""+getRoa_rol_id()+"\", \"roa_mst_id\": \""+getRoa_mst_id()+"\", \"roa_fra_id\": \""+getRoa_fra_id()+"\", \"roa_frm_id\": \""+getRoa_frm_id()+"\", \"roa_assigned_rol_id\": \""+getRoa_assigned_rol_id()+"\", \"rec_version\": \""+getRec_version()+"\", \"rec_create_timestamp\": \""+getRec_create_timestamp()+"\", \"rec_userid\": \""+getRec_userid()+"\", \"rec_timestamp\": \""+getRec_timestamp()+"\", \"n01\": \""+getN01()+"\", \"n02\": \""+getN02()+"\", \"n03\": \""+getN03()+"\", \"n04\": \""+getN04()+"\", \"n05\": \""+getN05()+"\", \"c01\": \""+getC01()+"\", \"c02\": \""+getC02()+"\", \"c03\": \""+getC03()+"\", \"c04\": \""+getC04()+"\", \"c05\": \""+getC05()+"\", \"d01\": \""+getD01()+"\", \"d02\": \""+getD02()+"\", \"d03\": \""+getD03()+"\", \"d04\": \""+getD04()+"\", \"d05\": \""+getD05()+"\"}}";
   }

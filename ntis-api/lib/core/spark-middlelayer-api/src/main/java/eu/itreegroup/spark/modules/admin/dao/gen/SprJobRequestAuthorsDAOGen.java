...
public class SprJobRequestAuthorsDAOGen extends SprBaseDAO{
   public static String IDENTIFIER="SPR_JOB_REQUEST_AUTHORS.JRT_ID";
   private Double jrt_id;
   private Double jrt_jrq_id;
   private Double jrt_org_id;
   private Double jrt_usr_id;
   ...
   protected boolean jrt_id_changed;
   protected boolean jrt_jrq_id_changed;
   protected boolean jrt_org_id_changed;
   protected boolean jrt_usr_id_changed;
   ...
   public SprJobRequestAuthorsDAOGen() {
      markObjectAsInitial();
      setRecordLoaded(false);
      setForceUpdate(false);
   }
   public SprJobRequestAuthorsDAOGen(Double jrt_id, Double jrt_jrq_id, Double jrt_org_id, Double jrt_usr_id, Double rec_version, Date rec_create_timestamp, String rec_userid, Date rec_timestamp, Double n01, Double n02, Double n03, Double n04, Double n05, String c01, String c02, String c03, String c04, String c05, Date d01, Date d02, Date d03, Date d04, Date d05) {
      this.jrt_id = jrt_id;
      this.jrt_jrq_id = jrt_jrq_id;
      this.jrt_org_id = jrt_org_id;
      this.jrt_usr_id = jrt_usr_id;
   ...
   public void copyValues(SprJobRequestAuthorsDAOGen obj) {
      this.setJrt_id(obj.getJrt_id());
      this.setJrt_jrq_id(obj.getJrt_jrq_id());
      this.setJrt_org_id(obj.getJrt_org_id());
      this.setJrt_usr_id(obj.getJrt_usr_id());
   ...
   protected void markObjectAsInitial() {
      this.jrt_id_changed = false;
      this.jrt_jrq_id_changed = false;
      this.jrt_org_id_changed = false;
      this.jrt_usr_id_changed = false;
   ...
   public void setJrt_id(Double jrt_id) {
      if (this.isForceUpdate() || 
               (this.jrt_id != null && !this.jrt_id.equals(jrt_id))  ||
               (jrt_id != null && !jrt_id.equals(this.jrt_id)) ){
         this.jrt_id_changed = true; 
         this.record_changed = true;
         this.jrt_id = jrt_id;
      }
   }
   public Double getJrt_id() {
      return this.jrt_id;
   }
   public void setJrt_jrq_id(Double jrt_jrq_id) {
      if (this.isForceUpdate() || 
               (this.jrt_jrq_id != null && !this.jrt_jrq_id.equals(jrt_jrq_id))  ||
               (jrt_jrq_id != null && !jrt_jrq_id.equals(this.jrt_jrq_id)) ){
         this.jrt_jrq_id_changed = true; 
         this.record_changed = true;
         this.jrt_jrq_id = jrt_jrq_id;
      }
   }
   public Double getJrt_jrq_id() {
      return this.jrt_jrq_id;
   }
   public void setJrt_org_id(Double jrt_org_id) {
      if (this.isForceUpdate() || 
               (this.jrt_org_id != null && !this.jrt_org_id.equals(jrt_org_id))  ||
               (jrt_org_id != null && !jrt_org_id.equals(this.jrt_org_id)) ){
         this.jrt_org_id_changed = true; 
         this.record_changed = true;
         this.jrt_org_id = jrt_org_id;
      }
   }
   public Double getJrt_org_id() {
      return this.jrt_org_id;
   }
   public void setJrt_usr_id(Double jrt_usr_id) {
      if (this.isForceUpdate() || 
               (this.jrt_usr_id != null && !this.jrt_usr_id.equals(jrt_usr_id))  ||
               (jrt_usr_id != null && !jrt_usr_id.equals(this.jrt_usr_id)) ){
         this.jrt_usr_id_changed = true; 
         this.record_changed = true;
         this.jrt_usr_id = jrt_usr_id;
      }
   }
   public Double getJrt_usr_id() {
      return this.jrt_usr_id;
   }
   ...
   public Date getD05() {
    ...
    public void setRecordIdentifier(Object recIdentifier) {
        if (recIdentifier != null && !EMPTY_STRING.equals(recIdentifier)  && !"null".equalsIgnoreCase(recIdentifier.toString())){
            this.jrt_id = (Double)recIdentifier;
        }
    }
    @JsonIgnore
    ...
    public void validateObject(int operation, SprBaseDBServiceImpl<?> baseService) throws SparkBusinessException{
      if (jrt_jrq_id_changed || operation == Utils.OPERATION_INSERT) {
         if (jrt_jrq_id!= null && (""+jrt_jrq_id.intValue()).length()>10) {
            throw new SparkBusinessException(new S2Message("SPR_JOB_REQUEST_AUTHORS", "JRT_JRQ_ID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"10"));
         }
      }
      if (jrt_org_id_changed || operation == Utils.OPERATION_INSERT) {
         if (jrt_org_id!= null && (""+jrt_org_id.intValue()).length()>10) {
            throw new SparkBusinessException(new S2Message("SPR_JOB_REQUEST_AUTHORS", "JRT_ORG_ID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"10"));
         }
      }
      if (jrt_usr_id_changed || operation == Utils.OPERATION_INSERT) {
         if (jrt_usr_id!= null && (""+jrt_usr_id.intValue()).length()>10) {
            throw new SparkBusinessException(new S2Message("SPR_JOB_REQUEST_AUTHORS", "JRT_USR_ID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"10"));
         }
      }
      if (rec_version_changed || operation == Utils.OPERATION_INSERT) {
         if (rec_version!= null && (""+rec_version.intValue()).length()>6) {
            throw new SparkBusinessException(new S2Message("SPR_JOB_REQUEST_AUTHORS", "REC_VERSION", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"6"));
         }
      }
      if (rec_userid_changed || operation == Utils.OPERATION_INSERT) {
         if (rec_userid!= null && rec_userid.length()>128) {
            throw new SparkBusinessException(new S2Message("SPR_JOB_REQUEST_AUTHORS", "REC_USERID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"128"));
         }
      }
      if (c01_changed || operation == Utils.OPERATION_INSERT) {
         if (c01!= null && c01.length()>4000) {
            throw new SparkBusinessException(new S2Message("SPR_JOB_REQUEST_AUTHORS", "C01", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"4000"));
         }
      }
      if (c02_changed || operation == Utils.OPERATION_INSERT) {
         if (c02!= null && c02.length()>4000) {
            throw new SparkBusinessException(new S2Message("SPR_JOB_REQUEST_AUTHORS", "C02", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"4000"));
         }
      }
      if (c03_changed || operation == Utils.OPERATION_INSERT) {
         if (c03!= null && c03.length()>4000) {
            throw new SparkBusinessException(new S2Message("SPR_JOB_REQUEST_AUTHORS", "C03", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"4000"));
         }
      }
      if (c04_changed || operation == Utils.OPERATION_INSERT) {
         if (c04!= null && c04.length()>4000) {
            throw new SparkBusinessException(new S2Message("SPR_JOB_REQUEST_AUTHORS", "C04", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"4000"));
         }
      }
      if (c05_changed || operation == Utils.OPERATION_INSERT) {
         if (c05!= null && c05.length()>4000) {
            throw new SparkBusinessException(new S2Message("SPR_JOB_REQUEST_AUTHORS", "C05", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"4000"));
         }
      }
   }
   ...
   public UpdateStatementPart constructUpdatePart(String userName) {
      ...
      String answer = "UPDATE SPR_JOB_REQUEST_AUTHORS SET ";
      boolean changedExists = false;      if (jrt_jrq_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"JRT_JRQ_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(jrt_jrq_id);
      }
      if (jrt_org_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"JRT_ORG_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(jrt_org_id);
      }
      if (jrt_usr_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"JRT_USR_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(jrt_usr_id);
      }
      if (n01_changed) {
      ...
      answer = answer +" WHERE  JRT_ID = ? ";
      updateStatementPart.addStatementParam(jrt_id);
      updateStatementPart.setStatementPart(answer);
      return updateStatementPart;
   }
   public String toString() {
      return "{\"SprJobRequestAuthorsDAO\":{\"jrt_id\": \""+getJrt_id()+"\", \"jrt_jrq_id\": \""+getJrt_jrq_id()+"\", \"jrt_org_id\": \""+getJrt_org_id()+"\", \"jrt_usr_id\": \""+getJrt_usr_id()+"\", \"rec_version\": \""+getRec_version()+"\", \"rec_create_timestamp\": \""+getRec_create_timestamp()+"\", \"rec_userid\": \""+getRec_userid()+"\", \"rec_timestamp\": \""+getRec_timestamp()+"\", \"n01\": \""+getN01()+"\", \"n02\": \""+getN02()+"\", \"n03\": \""+getN03()+"\", \"n04\": \""+getN04()+"\", \"n05\": \""+getN05()+"\", \"c01\": \""+getC01()+"\", \"c02\": \""+getC02()+"\", \"c03\": \""+getC03()+"\", \"c04\": \""+getC04()+"\", \"c05\": \""+getC05()+"\", \"d01\": \""+getD01()+"\", \"d02\": \""+getD02()+"\", \"d03\": \""+getD03()+"\", \"d04\": \""+getD04()+"\", \"d05\": \""+getD05()+"\"}}";
   }

...
@Component("NEW_USER_INFROM_REQUEST")
public class NewUserInformJobRequest extends JobRequestImpl {

    @SuppressWarnings("unused")
    private static final Logger log = LoggerFactory.getLogger(NewUserInformJobRequest.class);
    ...
    public static final String CODE = "NEW_USER_INFORM";

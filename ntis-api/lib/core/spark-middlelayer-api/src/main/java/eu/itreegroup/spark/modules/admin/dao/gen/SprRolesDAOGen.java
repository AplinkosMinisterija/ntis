...
public class SprRolesDAOGen extends SprBaseDAO{
   public static String IDENTIFIER="SPR_ROLES.ROL_ID";
   private Double rol_id;
   private String rol_code;
   private String rol_type;
   private String rol_name;
   private String rol_description;
   private Date rol_date_from;
   private Date rol_date_to;
   private Double rol_rol_id;
   ...
   protected boolean rol_id_changed;
   protected boolean rol_code_changed;
   protected boolean rol_type_changed;
   protected boolean rol_name_changed;
   protected boolean rol_description_changed;
   protected boolean rol_date_from_changed;
   protected boolean rol_date_to_changed;
   protected boolean rol_rol_id_changed;
   ...
   public SprRolesDAOGen() {
      markObjectAsInitial();
      setRecordLoaded(false);
      setForceUpdate(false);
   }
   public SprRolesDAOGen(Double rol_id, String rol_code, String rol_type, String rol_name, String rol_description, Date rol_date_from, Date rol_date_to, Double rol_rol_id, Double rec_version, Date rec_create_timestamp, String rec_userid, Date rec_timestamp, Double n01, Double n02, Double n03, Double n04, Double n05, String c01, String c02, String c03, String c04, String c05, Date d01, Date d02, Date d03, Date d04, Date d05) {
      this.rol_id = rol_id;
      this.rol_code = rol_code;
      this.rol_type = rol_type;
      this.rol_name = rol_name;
      this.rol_description = rol_description;
      this.rol_date_from = rol_date_from;
      this.rol_date_to = rol_date_to;
   ...
   public void copyValues(SprRolesDAOGen obj) {
      this.setRol_id(obj.getRol_id());
      this.setRol_code(obj.getRol_code());
      this.setRol_type(obj.getRol_type());
      this.setRol_name(obj.getRol_name());
      this.setRol_description(obj.getRol_description());
      this.setRol_date_from(obj.getRol_date_from());
      this.setRol_date_to(obj.getRol_date_to());
      this.setRol_rol_id(obj.getRol_rol_id());
   ...
   protected void markObjectAsInitial() {
      this.rol_id_changed = false;
      this.rol_code_changed = false;
      this.rol_type_changed = false;
      this.rol_name_changed = false;
      this.rol_description_changed = false;
      this.rol_date_from_changed = false;
      this.rol_date_to_changed = false;
      this.rol_rol_id_changed = false;
   ...
   public void setRol_id(Double rol_id) {
      if (this.isForceUpdate() || 
               (this.rol_id != null && !this.rol_id.equals(rol_id))  ||
               (rol_id != null && !rol_id.equals(this.rol_id)) ){
         this.rol_id_changed = true; 
   ...
   public void setRol_code(String rol_code) {
      if (this.isForceUpdate() || 
               (this.rol_code != null && !this.rol_code.equals(rol_code))  ||
               (rol_code != null && !rol_code.equals(this.rol_code)) ){
         this.rol_code_changed = true; 
         this.record_changed = true;
         this.rol_code = rol_code;
      }
   }
   ...
   public void setRol_type(String rol_type) {
      if (this.isForceUpdate() || 
               (this.rol_type != null && !this.rol_type.equals(rol_type))  ||
               (rol_type != null && !rol_type.equals(this.rol_type)) ){
         this.rol_type_changed = true; 
         this.record_changed = true;
         this.rol_type = rol_type;
      }
   }
   ...
   public void setRol_name(String rol_name) {
      if (this.isForceUpdate() || 
               (this.rol_name != null && !this.rol_name.equals(rol_name))  ||
               (rol_name != null && !rol_name.equals(this.rol_name)) ){
         this.rol_name_changed = true; 
         this.record_changed = true;
         this.rol_name = rol_name;
      }
   }
   ...
   public void setRol_description(String rol_description) {
      if (this.isForceUpdate() || 
               (this.rol_description != null && !this.rol_description.equals(rol_description))  ||
               (rol_description != null && !rol_description.equals(this.rol_description)) ){
         this.rol_description_changed = true; 
         this.record_changed = true;
         this.rol_description = rol_description;
      }
   }
   ...
   public void setRol_date_from(Date rol_date_from) {
      if (this.isForceUpdate() || 
               (this.rol_date_from != null && (rol_date_from == null ||this.rol_date_from.compareTo(rol_date_from) != 0 )) ||
               (rol_date_from != null && (this.rol_date_from == null ||rol_date_from.compareTo(this.rol_date_from) != 0 ))){
         this.rol_date_from_changed = true; 
         this.record_changed = true;
         this.rol_date_from = rol_date_from;
      }
   }
   public Date getRol_date_from() {
      return this.rol_date_from;
   }
   public void setRol_date_to(Date rol_date_to) {
      if (this.isForceUpdate() || 
               (this.rol_date_to != null && (rol_date_to == null ||this.rol_date_to.compareTo(rol_date_to) != 0 )) ||
               (rol_date_to != null && (this.rol_date_to == null ||rol_date_to.compareTo(this.rol_date_to) != 0 ))){
         this.rol_date_to_changed = true; 
         this.record_changed = true;
         this.rol_date_to = rol_date_to;
      }
   }
   public Date getRol_date_to() {
      return this.rol_date_to;
   }
   public void setRol_rol_id(Double rol_rol_id) {
      if (this.isForceUpdate() || 
               (this.rol_rol_id != null && !this.rol_rol_id.equals(rol_rol_id))  ||
               (rol_rol_id != null && !rol_rol_id.equals(this.rol_rol_id)) ){
         this.rol_rol_id_changed = true; 
         this.record_changed = true;
         this.rol_rol_id = rol_rol_id;
      }
   }
   public Double getRol_rol_id() {
   ...
   public Date getD05() {
    ...
    public void setRecordIdentifier(Object recIdentifier) {
        if (recIdentifier != null && !EMPTY_STRING.equals(recIdentifier)  && !"null".equalsIgnoreCase(recIdentifier.toString())){
            this.rol_id = (Double)recIdentifier;
        }
    }
    @JsonIgnore
    ...
    public void validateObject(int operation, SprBaseDBServiceImpl<?> baseService) throws SparkBusinessException{
      if (rol_code_changed || operation == Utils.OPERATION_INSERT) {
         if (rol_code== null || EMPTY_STRING.equals(rol_code)) {
            throw new SparkBusinessException(new S2Message("SPR_ROLES", "ROL_CODE", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }else{
            if (rol_code!= null && rol_code.length()>240) {
               throw new SparkBusinessException(new S2Message("SPR_ROLES", "ROL_CODE", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"240"));
            }
         }
      }
      if (rol_type_changed || operation == Utils.OPERATION_INSERT) {
         if (rol_type== null || EMPTY_STRING.equals(rol_type)) {
            throw new SparkBusinessException(new S2Message("SPR_ROLES", "ROL_TYPE", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }else{
            if (rol_type!= null && rol_type.length()>50) {
               throw new SparkBusinessException(new S2Message("SPR_ROLES", "ROL_TYPE", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"50"));
            }
         }
      }
      if (rol_name_changed || operation == Utils.OPERATION_INSERT) {
         if (rol_name== null || EMPTY_STRING.equals(rol_name)) {
            throw new SparkBusinessException(new S2Message("SPR_ROLES", "ROL_NAME", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }else{
            if (rol_name!= null && rol_name.length()>200) {
               throw new SparkBusinessException(new S2Message("SPR_ROLES", "ROL_NAME", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"200"));
            }
         }
      }
      if (rol_description_changed || operation == Utils.OPERATION_INSERT) {
         if (rol_description!= null && rol_description.length()>200) {
            throw new SparkBusinessException(new S2Message("SPR_ROLES", "ROL_DESCRIPTION", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"200"));
         }
      }
      if (rol_date_from_changed || operation == Utils.OPERATION_INSERT) {
         if (rol_date_from== null) {
            throw new SparkBusinessException(new S2Message("SPR_ROLES", "ROL_DATE_FROM", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }
      }
      if (rol_rol_id_changed || operation == Utils.OPERATION_INSERT) {
         if (rol_rol_id!= null && (""+rol_rol_id.intValue()).length()>12) {
            throw new SparkBusinessException(new S2Message("SPR_ROLES", "ROL_ROL_ID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"12"));
         }
      }
      if (rec_version_changed || operation == Utils.OPERATION_INSERT) {
         if (rec_version!= null && (""+rec_version.intValue()).length()>6) {
            throw new SparkBusinessException(new S2Message("SPR_ROLES", "REC_VERSION", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"6"));
         }
      }
      if (rec_userid_changed || operation == Utils.OPERATION_INSERT) {
         if (rec_userid!= null && rec_userid.length()>128) {
            throw new SparkBusinessException(new S2Message("SPR_ROLES", "REC_USERID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"128"));
         }
      }
      if (c01_changed || operation == Utils.OPERATION_INSERT) {
         if (c01!= null && c01.length()>2000) {
            throw new SparkBusinessException(new S2Message("SPR_ROLES", "C01", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2000"));
         }
      }
      if (c02_changed || operation == Utils.OPERATION_INSERT) {
         if (c02!= null && c02.length()>2000) {
            throw new SparkBusinessException(new S2Message("SPR_ROLES", "C02", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2000"));
         }
      }
      if (c03_changed || operation == Utils.OPERATION_INSERT) {
         if (c03!= null && c03.length()>2000) {
            throw new SparkBusinessException(new S2Message("SPR_ROLES", "C03", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2000"));
         }
      }
      if (c04_changed || operation == Utils.OPERATION_INSERT) {
         if (c04!= null && c04.length()>2000) {
            throw new SparkBusinessException(new S2Message("SPR_ROLES", "C04", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2000"));
         }
      }
      if (c05_changed || operation == Utils.OPERATION_INSERT) {
         if (c05!= null && c05.length()>2000) {
            throw new SparkBusinessException(new S2Message("SPR_ROLES", "C05", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2000"));
         }
      }
   }
   ...
   public UpdateStatementPart constructUpdatePart(String userName) {
      ...
      String answer = "UPDATE SPR_ROLES SET ";
      boolean changedExists = false;      if (rol_code_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"ROL_CODE = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(rol_code);
      }
      if (rol_type_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"ROL_TYPE = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(rol_type);
      }
      if (rol_name_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"ROL_NAME = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(rol_name);
      }
      if (rol_description_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"ROL_DESCRIPTION = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(rol_description);
      }
      if (rol_date_from_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"ROL_DATE_FROM = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(rol_date_from);
      }
      if (rol_date_to_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"ROL_DATE_TO = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(rol_date_to);
      }
      if (rol_rol_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"ROL_ROL_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(rol_rol_id);
      }
      if (n01_changed) {
      ...
      answer = answer +" WHERE  ROL_ID = ? ";
      updateStatementPart.addStatementParam(rol_id);
      updateStatementPart.setStatementPart(answer);
      return updateStatementPart;
   }
   public String toString() {
      return "{\"SprRolesDAO\":{\"rol_id\": \""+getRol_id()+"\", \"rol_code\": \""+getRol_code()+"\", \"rol_type\": \""+getRol_type()+"\", \"rol_name\": \""+getRol_name()+"\", \"rol_description\": \""+getRol_description()+"\", \"rol_date_from\": \""+getRol_date_from()+"\", \"rol_date_to\": \""+getRol_date_to()+"\", \"rol_rol_id\": \""+getRol_rol_id()+"\", \"rec_version\": \""+getRec_version()+"\", \"rec_create_timestamp\": \""+getRec_create_timestamp()+"\", \"rec_userid\": \""+getRec_userid()+"\", \"rec_timestamp\": \""+getRec_timestamp()+"\", \"n01\": \""+getN01()+"\", \"n02\": \""+getN02()+"\", \"n03\": \""+getN03()+"\", \"n04\": \""+getN04()+"\", \"n05\": \""+getN05()+"\", \"c01\": \""+getC01()+"\", \"c02\": \""+getC02()+"\", \"c03\": \""+getC03()+"\", \"c04\": \""+getC04()+"\", \"c05\": \""+getC05()+"\", \"d01\": \""+getD01()+"\", \"d02\": \""+getD02()+"\", \"d03\": \""+getD03()+"\", \"d04\": \""+getD04()+"\", \"d05\": \""+getD05()+"\"}}";
   }

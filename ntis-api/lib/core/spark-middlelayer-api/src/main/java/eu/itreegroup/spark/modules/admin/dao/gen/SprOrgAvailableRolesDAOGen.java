...
public class SprOrgAvailableRolesDAOGen extends SprBaseDAO{
   public static String IDENTIFIER="SPR_ORG_AVAILABLE_ROLES.OAR_ID";
   private Double oar_id;
   private Date oar_date_from;
   private Date oar_date_to;
   private Double oar_org_id;
   private Double oar_rol_id;
   ...
   protected boolean oar_id_changed;
   protected boolean oar_date_from_changed;
   protected boolean oar_date_to_changed;
   protected boolean oar_org_id_changed;
   protected boolean oar_rol_id_changed;
   ...
   public SprOrgAvailableRolesDAOGen() {
      markObjectAsInitial();
      setRecordLoaded(false);
      setForceUpdate(false);
   }
   public SprOrgAvailableRolesDAOGen(Double oar_id, Date oar_date_from, Date oar_date_to, Double oar_org_id, Double oar_rol_id, Double rec_version, Date rec_create_timestamp, String rec_userid, Date rec_timestamp, Double n01, Double n02, Double n03, Double n04, Double n05, String c01, String c02, String c03, String c04, String c05, Date d01, Date d02, Date d03, Date d04, Date d05) {
      this.oar_id = oar_id;
      this.oar_date_from = oar_date_from;
      this.oar_date_to = oar_date_to;
      this.oar_org_id = oar_org_id;
      this.oar_rol_id = oar_rol_id;
   ...
   public void copyValues(SprOrgAvailableRolesDAOGen obj) {
      this.setOar_id(obj.getOar_id());
      this.setOar_date_from(obj.getOar_date_from());
      this.setOar_date_to(obj.getOar_date_to());
      this.setOar_org_id(obj.getOar_org_id());
      this.setOar_rol_id(obj.getOar_rol_id());
   ...
   protected void markObjectAsInitial() {
      this.oar_id_changed = false;
      this.oar_date_from_changed = false;
      this.oar_date_to_changed = false;
      this.oar_org_id_changed = false;
      this.oar_rol_id_changed = false;
   ...
   public void setOar_id(Double oar_id) {
      if (this.isForceUpdate() || 
               (this.oar_id != null && !this.oar_id.equals(oar_id))  ||
               (oar_id != null && !oar_id.equals(this.oar_id)) ){
         this.oar_id_changed = true; 
         this.record_changed = true;
         this.oar_id = oar_id;
      }
   }
   public Double getOar_id() {
      return this.oar_id;
   }
   public void setOar_date_from(Date oar_date_from) {
      if (this.isForceUpdate() || 
               (this.oar_date_from != null && (oar_date_from == null ||this.oar_date_from.compareTo(oar_date_from) != 0 )) ||
               (oar_date_from != null && (this.oar_date_from == null ||oar_date_from.compareTo(this.oar_date_from) != 0 ))){
         this.oar_date_from_changed = true; 
         this.record_changed = true;
         this.oar_date_from = oar_date_from;
      }
   }
   public Date getOar_date_from() {
      return this.oar_date_from;
   }
   public void setOar_date_to(Date oar_date_to) {
      if (this.isForceUpdate() || 
               (this.oar_date_to != null && (oar_date_to == null ||this.oar_date_to.compareTo(oar_date_to) != 0 )) ||
               (oar_date_to != null && (this.oar_date_to == null ||oar_date_to.compareTo(this.oar_date_to) != 0 ))){
         this.oar_date_to_changed = true; 
         this.record_changed = true;
         this.oar_date_to = oar_date_to;
      }
   }
   public Date getOar_date_to() {
      return this.oar_date_to;
   }
   public void setOar_org_id(Double oar_org_id) {
      if (this.isForceUpdate() || 
               (this.oar_org_id != null && !this.oar_org_id.equals(oar_org_id))  ||
               (oar_org_id != null && !oar_org_id.equals(this.oar_org_id)) ){
         this.oar_org_id_changed = true; 
         this.record_changed = true;
         this.oar_org_id = oar_org_id;
      }
   }
   public Double getOar_org_id() {
      return this.oar_org_id;
   }
   public void setOar_rol_id(Double oar_rol_id) {
      if (this.isForceUpdate() || 
               (this.oar_rol_id != null && !this.oar_rol_id.equals(oar_rol_id))  ||
               (oar_rol_id != null && !oar_rol_id.equals(this.oar_rol_id)) ){
         this.oar_rol_id_changed = true; 
         this.record_changed = true;
         this.oar_rol_id = oar_rol_id;
      }
   }
   public Double getOar_rol_id() {
      return this.oar_rol_id;
   }
   ...
   public Date getD05() {
    ...
    public void setRecordIdentifier(Object recIdentifier) {
        if (recIdentifier != null && !EMPTY_STRING.equals(recIdentifier)  && !"null".equalsIgnoreCase(recIdentifier.toString())){
            this.oar_id = (Double)recIdentifier;
        }
    }
    @JsonIgnore
    ...
    public void validateObject(int operation, SprBaseDBServiceImpl<?> baseService) throws SparkBusinessException{
      if (oar_org_id_changed || operation == Utils.OPERATION_INSERT) {
         if (oar_org_id== null) {
            throw new SparkBusinessException(new S2Message("SPR_ORG_AVAILABLE_ROLES", "OAR_ORG_ID", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }else{
            if (oar_org_id!= null && (""+oar_org_id.intValue()).length()>12) {
               throw new SparkBusinessException(new S2Message("SPR_ORG_AVAILABLE_ROLES", "OAR_ORG_ID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"12"));
            }
         }
      }
      if (oar_rol_id_changed || operation == Utils.OPERATION_INSERT) {
         if (oar_rol_id== null) {
            throw new SparkBusinessException(new S2Message("SPR_ORG_AVAILABLE_ROLES", "OAR_ROL_ID", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }else{
            if (oar_rol_id!= null && (""+oar_rol_id.intValue()).length()>12) {
               throw new SparkBusinessException(new S2Message("SPR_ORG_AVAILABLE_ROLES", "OAR_ROL_ID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"12"));
            }
         }
      }
      if (rec_version_changed || operation == Utils.OPERATION_INSERT) {
         if (rec_version!= null && (""+rec_version.intValue()).length()>6) {
            throw new SparkBusinessException(new S2Message("SPR_ORG_AVAILABLE_ROLES", "REC_VERSION", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"6"));
         }
      }
      if (rec_userid_changed || operation == Utils.OPERATION_INSERT) {
         if (rec_userid!= null && rec_userid.length()>128) {
            throw new SparkBusinessException(new S2Message("SPR_ORG_AVAILABLE_ROLES", "REC_USERID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"128"));
         }
      }
      if (c01_changed || operation == Utils.OPERATION_INSERT) {
         if (c01!= null && c01.length()>2000) {
            throw new SparkBusinessException(new S2Message("SPR_ORG_AVAILABLE_ROLES", "C01", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2000"));
         }
      }
      if (c02_changed || operation == Utils.OPERATION_INSERT) {
         if (c02!= null && c02.length()>2000) {
            throw new SparkBusinessException(new S2Message("SPR_ORG_AVAILABLE_ROLES", "C02", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2000"));
         }
      }
      if (c03_changed || operation == Utils.OPERATION_INSERT) {
         if (c03!= null && c03.length()>2000) {
            throw new SparkBusinessException(new S2Message("SPR_ORG_AVAILABLE_ROLES", "C03", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2000"));
         }
      }
      if (c04_changed || operation == Utils.OPERATION_INSERT) {
         if (c04!= null && c04.length()>2000) {
            throw new SparkBusinessException(new S2Message("SPR_ORG_AVAILABLE_ROLES", "C04", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2000"));
         }
      }
      if (c05_changed || operation == Utils.OPERATION_INSERT) {
         if (c05!= null && c05.length()>2000) {
            throw new SparkBusinessException(new S2Message("SPR_ORG_AVAILABLE_ROLES", "C05", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2000"));
         }
      }
   }
   ...
   public UpdateStatementPart constructUpdatePart(String userName) {
      ...
      String answer = "UPDATE SPR_ORG_AVAILABLE_ROLES SET ";
      boolean changedExists = false;      if (oar_date_from_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"OAR_DATE_FROM = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(oar_date_from);
      }
      if (oar_date_to_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"OAR_DATE_TO = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(oar_date_to);
      }
      if (oar_org_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"OAR_ORG_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(oar_org_id);
      }
      if (oar_rol_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"OAR_ROL_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(oar_rol_id);
      }
      if (n01_changed) {
      ...
      answer = answer +" WHERE  OAR_ID = ? ";
      updateStatementPart.addStatementParam(oar_id);
      updateStatementPart.setStatementPart(answer);
      return updateStatementPart;
   }
   public String toString() {
      return "{\"SprOrgAvailableRolesDAO\":{\"oar_id\": \""+getOar_id()+"\", \"oar_date_from\": \""+getOar_date_from()+"\", \"oar_date_to\": \""+getOar_date_to()+"\", \"oar_org_id\": \""+getOar_org_id()+"\", \"oar_rol_id\": \""+getOar_rol_id()+"\", \"rec_version\": \""+getRec_version()+"\", \"rec_create_timestamp\": \""+getRec_create_timestamp()+"\", \"rec_userid\": \""+getRec_userid()+"\", \"rec_timestamp\": \""+getRec_timestamp()+"\", \"n01\": \""+getN01()+"\", \"n02\": \""+getN02()+"\", \"n03\": \""+getN03()+"\", \"n04\": \""+getN04()+"\", \"n05\": \""+getN05()+"\", \"c01\": \""+getC01()+"\", \"c02\": \""+getC02()+"\", \"c03\": \""+getC03()+"\", \"c04\": \""+getC04()+"\", \"c05\": \""+getC05()+"\", \"d01\": \""+getD01()+"\", \"d02\": \""+getD02()+"\", \"d03\": \""+getD03()+"\", \"d04\": \""+getD04()+"\", \"d05\": \""+getD05()+"\"}}";
   }

...
public class SprTaskFilesDAOGen extends SprBaseDAO{
   public static String IDENTIFIER="SPR_TASK_FILES.TFI_ID";
   private Double tfi_id;
   private Date tfi_date_from;
   private Double tfi_fil_id;
   private Double tfi_tas_id;
   private Double tfi_usr_id;
   ...
   protected boolean tfi_id_changed;
   protected boolean tfi_date_from_changed;
   protected boolean tfi_fil_id_changed;
   protected boolean tfi_tas_id_changed;
   protected boolean tfi_usr_id_changed;
   ...
   public SprTaskFilesDAOGen() {
      markObjectAsInitial();
      setRecordLoaded(false);
      setForceUpdate(false);
   }
   public SprTaskFilesDAOGen(Double tfi_id, Date tfi_date_from, Double tfi_fil_id, Double tfi_tas_id, Double tfi_usr_id, Double rec_version, Date rec_create_timestamp, String rec_userid, Date rec_timestamp, Double n01, Double n02, Double n03, Double n04, Double n05, String c01, String c02, String c03, String c04, String c05, Date d01, Date d02, Date d03, Date d04, Date d05) {
      this.tfi_id = tfi_id;
      this.tfi_date_from = tfi_date_from;
      this.tfi_fil_id = tfi_fil_id;
      this.tfi_tas_id = tfi_tas_id;
      this.tfi_usr_id = tfi_usr_id;
   ...
   public void copyValues(SprTaskFilesDAOGen obj) {
      this.setTfi_id(obj.getTfi_id());
      this.setTfi_date_from(obj.getTfi_date_from());
      this.setTfi_fil_id(obj.getTfi_fil_id());
      this.setTfi_tas_id(obj.getTfi_tas_id());
      this.setTfi_usr_id(obj.getTfi_usr_id());
   ...
   protected void markObjectAsInitial() {
      this.tfi_id_changed = false;
      this.tfi_date_from_changed = false;
      this.tfi_fil_id_changed = false;
      this.tfi_tas_id_changed = false;
      this.tfi_usr_id_changed = false;
   ...
   public void setTfi_id(Double tfi_id) {
      if (this.isForceUpdate() || 
               (this.tfi_id != null && !this.tfi_id.equals(tfi_id))  ||
               (tfi_id != null && !tfi_id.equals(this.tfi_id)) ){
         this.tfi_id_changed = true; 
   ...
   public void setTfi_date_from(Date tfi_date_from) {
      if (this.isForceUpdate() || 
               (this.tfi_date_from != null && (tfi_date_from == null ||this.tfi_date_from.compareTo(tfi_date_from) != 0 )) ||
               (tfi_date_from != null && (this.tfi_date_from == null ||tfi_date_from.compareTo(this.tfi_date_from) != 0 ))){
         this.tfi_date_from_changed = true; 
         this.record_changed = true;
         this.tfi_date_from = tfi_date_from;
      }
   }
   public Date getTfi_date_from() {
      return this.tfi_date_from;
   }
   public void setTfi_fil_id(Double tfi_fil_id) {
      if (this.isForceUpdate() || 
               (this.tfi_fil_id != null && !this.tfi_fil_id.equals(tfi_fil_id))  ||
               (tfi_fil_id != null && !tfi_fil_id.equals(this.tfi_fil_id)) ){
         this.tfi_fil_id_changed = true; 
         this.record_changed = true;
         this.tfi_fil_id = tfi_fil_id;
      }
   }
   public Double getTfi_fil_id() {
      return this.tfi_fil_id;
   }
   public void setTfi_tas_id(Double tfi_tas_id) {
      if (this.isForceUpdate() || 
               (this.tfi_tas_id != null && !this.tfi_tas_id.equals(tfi_tas_id))  ||
               (tfi_tas_id != null && !tfi_tas_id.equals(this.tfi_tas_id)) ){
         this.tfi_tas_id_changed = true; 
         this.record_changed = true;
         this.tfi_tas_id = tfi_tas_id;
      }
   }
   public Double getTfi_tas_id() {
      return this.tfi_tas_id;
   }
   public void setTfi_usr_id(Double tfi_usr_id) {
      if (this.isForceUpdate() || 
               (this.tfi_usr_id != null && !this.tfi_usr_id.equals(tfi_usr_id))  ||
               (tfi_usr_id != null && !tfi_usr_id.equals(this.tfi_usr_id)) ){
         this.tfi_usr_id_changed = true; 
         this.record_changed = true;
         this.tfi_usr_id = tfi_usr_id;
      }
   }
   public Double getTfi_usr_id() {
      return this.tfi_usr_id;
   }
   ...
   public Date getD05() {
    ...
    public void setRecordIdentifier(Object recIdentifier) {
        if (recIdentifier != null && !EMPTY_STRING.equals(recIdentifier)  && !"null".equalsIgnoreCase(recIdentifier.toString())){
            this.tfi_id = (Double)recIdentifier;
        }
    }
    @JsonIgnore
    ...
    public void validateObject(int operation, SprBaseDBServiceImpl<?> baseService) throws SparkBusinessException{
      if (tfi_date_from_changed || operation == Utils.OPERATION_INSERT) {
         if (tfi_date_from== null) {
            throw new SparkBusinessException(new S2Message("SPR_TASK_FILES", "TFI_DATE_FROM", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }
      }
      if (tfi_fil_id_changed || operation == Utils.OPERATION_INSERT) {
         if (tfi_fil_id== null) {
            throw new SparkBusinessException(new S2Message("SPR_TASK_FILES", "TFI_FIL_ID", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }else{
            if (tfi_fil_id!= null && (""+tfi_fil_id.intValue()).length()>12) {
               throw new SparkBusinessException(new S2Message("SPR_TASK_FILES", "TFI_FIL_ID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"12"));
            }
         }
      }
      if (tfi_tas_id_changed || operation == Utils.OPERATION_INSERT) {
         if (tfi_tas_id== null) {
            throw new SparkBusinessException(new S2Message("SPR_TASK_FILES", "TFI_TAS_ID", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }else{
            if (tfi_tas_id!= null && (""+tfi_tas_id.intValue()).length()>12) {
               throw new SparkBusinessException(new S2Message("SPR_TASK_FILES", "TFI_TAS_ID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"12"));
            }
         }
      }
      if (tfi_usr_id_changed || operation == Utils.OPERATION_INSERT) {
         if (tfi_usr_id== null) {
            throw new SparkBusinessException(new S2Message("SPR_TASK_FILES", "TFI_USR_ID", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }else{
            if (tfi_usr_id!= null && (""+tfi_usr_id.intValue()).length()>12) {
               throw new SparkBusinessException(new S2Message("SPR_TASK_FILES", "TFI_USR_ID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"12"));
            }
         }
      }
      if (rec_version_changed || operation == Utils.OPERATION_INSERT) {
         if (rec_version!= null && (""+rec_version.intValue()).length()>6) {
            throw new SparkBusinessException(new S2Message("SPR_TASK_FILES", "REC_VERSION", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"6"));
         }
      }
      if (rec_userid_changed || operation == Utils.OPERATION_INSERT) {
         if (rec_userid!= null && rec_userid.length()>128) {
            throw new SparkBusinessException(new S2Message("SPR_TASK_FILES", "REC_USERID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"128"));
         }
      }
      if (c01_changed || operation == Utils.OPERATION_INSERT) {
         if (c01!= null && c01.length()>2000) {
            throw new SparkBusinessException(new S2Message("SPR_TASK_FILES", "C01", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2000"));
         }
      }
      if (c02_changed || operation == Utils.OPERATION_INSERT) {
         if (c02!= null && c02.length()>2000) {
            throw new SparkBusinessException(new S2Message("SPR_TASK_FILES", "C02", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2000"));
         }
      }
      if (c03_changed || operation == Utils.OPERATION_INSERT) {
         if (c03!= null && c03.length()>2000) {
            throw new SparkBusinessException(new S2Message("SPR_TASK_FILES", "C03", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2000"));
         }
      }
      if (c04_changed || operation == Utils.OPERATION_INSERT) {
         if (c04!= null && c04.length()>2000) {
            throw new SparkBusinessException(new S2Message("SPR_TASK_FILES", "C04", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2000"));
         }
      }
      if (c05_changed || operation == Utils.OPERATION_INSERT) {
         if (c05!= null && c05.length()>2000) {
            throw new SparkBusinessException(new S2Message("SPR_TASK_FILES", "C05", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2000"));
         }
      }
   }
   ...
   public UpdateStatementPart constructUpdatePart(String userName) {
      ...
      String answer = "UPDATE SPR_TASK_FILES SET ";
      boolean changedExists = false;      if (tfi_date_from_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"TFI_DATE_FROM = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(tfi_date_from);
      }
      if (tfi_fil_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"TFI_FIL_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(tfi_fil_id);
      }
      if (tfi_tas_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"TFI_TAS_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(tfi_tas_id);
      }
      if (tfi_usr_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"TFI_USR_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(tfi_usr_id);
      }
      if (n01_changed) {
      ...
      answer = answer +" WHERE  TFI_ID = ? ";
      updateStatementPart.addStatementParam(tfi_id);
      updateStatementPart.setStatementPart(answer);
      return updateStatementPart;
   }
   public String toString() {
      return "{\"SprTaskFilesDAO\":{\"tfi_id\": \""+getTfi_id()+"\", \"tfi_date_from\": \""+getTfi_date_from()+"\", \"tfi_fil_id\": \""+getTfi_fil_id()+"\", \"tfi_tas_id\": \""+getTfi_tas_id()+"\", \"tfi_usr_id\": \""+getTfi_usr_id()+"\", \"rec_version\": \""+getRec_version()+"\", \"rec_create_timestamp\": \""+getRec_create_timestamp()+"\", \"rec_userid\": \""+getRec_userid()+"\", \"rec_timestamp\": \""+getRec_timestamp()+"\", \"n01\": \""+getN01()+"\", \"n02\": \""+getN02()+"\", \"n03\": \""+getN03()+"\", \"n04\": \""+getN04()+"\", \"n05\": \""+getN05()+"\", \"c01\": \""+getC01()+"\", \"c02\": \""+getC02()+"\", \"c03\": \""+getC03()+"\", \"c04\": \""+getC04()+"\", \"c05\": \""+getC05()+"\", \"d01\": \""+getD01()+"\", \"d02\": \""+getD02()+"\", \"d03\": \""+getD03()+"\", \"d04\": \""+getD04()+"\", \"d05\": \""+getD05()+"\"}}";
   }

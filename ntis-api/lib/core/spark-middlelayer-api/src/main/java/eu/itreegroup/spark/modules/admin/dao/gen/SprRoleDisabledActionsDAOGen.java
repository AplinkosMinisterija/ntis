...
public class SprRoleDisabledActionsDAOGen extends SprBaseDAO{
   public static String IDENTIFIER="SPR_ROLE_DISABLED_ACTIONS.RDA_ID";
   private Double rda_id;
   private Date rda_date_from;
   private Date rda_date_to;
   private Double rda_fra_id;
   private Double rda_roa_id;
   ...
   protected boolean rda_id_changed;
   protected boolean rda_date_from_changed;
   protected boolean rda_date_to_changed;
   protected boolean rda_fra_id_changed;
   protected boolean rda_roa_id_changed;
   ...
   public SprRoleDisabledActionsDAOGen() {
      markObjectAsInitial();
      setRecordLoaded(false);
      setForceUpdate(false);
   }
   public SprRoleDisabledActionsDAOGen(Double rda_id, Date rda_date_from, Date rda_date_to, Double rda_fra_id, Double rda_roa_id, Double rec_version, Date rec_create_timestamp, String rec_userid, Date rec_timestamp, Double n01, Double n02, Double n03, Double n04, Double n05, String c01, String c02, String c03, String c04, String c05, Date d01, Date d02, Date d03, Date d04, Date d05) {
      this.rda_id = rda_id;
      this.rda_date_from = rda_date_from;
      this.rda_date_to = rda_date_to;
      this.rda_fra_id = rda_fra_id;
      this.rda_roa_id = rda_roa_id;
   ...
   public void copyValues(SprRoleDisabledActionsDAOGen obj) {
      this.setRda_id(obj.getRda_id());
      this.setRda_date_from(obj.getRda_date_from());
      this.setRda_date_to(obj.getRda_date_to());
      this.setRda_fra_id(obj.getRda_fra_id());
      this.setRda_roa_id(obj.getRda_roa_id());
   ...
   protected void markObjectAsInitial() {
      this.rda_id_changed = false;
      this.rda_date_from_changed = false;
      this.rda_date_to_changed = false;
      this.rda_fra_id_changed = false;
      this.rda_roa_id_changed = false;
   ...
   public void setRda_id(Double rda_id) {
      if (this.isForceUpdate() || 
               (this.rda_id != null && !this.rda_id.equals(rda_id))  ||
               (rda_id != null && !rda_id.equals(this.rda_id)) ){
         this.rda_id_changed = true; 
         this.record_changed = true;
         this.rda_id = rda_id;
      }
   }
   public Double getRda_id() {
      return this.rda_id;
   }
   public void setRda_date_from(Date rda_date_from) {
      if (this.isForceUpdate() || 
               (this.rda_date_from != null && (rda_date_from == null ||this.rda_date_from.compareTo(rda_date_from) != 0 )) ||
               (rda_date_from != null && (this.rda_date_from == null ||rda_date_from.compareTo(this.rda_date_from) != 0 ))){
         this.rda_date_from_changed = true; 
         this.record_changed = true;
         this.rda_date_from = rda_date_from;
      }
   }
   public Date getRda_date_from() {
      return this.rda_date_from;
   }
   public void setRda_date_to(Date rda_date_to) {
      if (this.isForceUpdate() || 
               (this.rda_date_to != null && (rda_date_to == null ||this.rda_date_to.compareTo(rda_date_to) != 0 )) ||
               (rda_date_to != null && (this.rda_date_to == null ||rda_date_to.compareTo(this.rda_date_to) != 0 ))){
         this.rda_date_to_changed = true; 
         this.record_changed = true;
         this.rda_date_to = rda_date_to;
      }
   }
   public Date getRda_date_to() {
      return this.rda_date_to;
   }
   public void setRda_fra_id(Double rda_fra_id) {
      if (this.isForceUpdate() || 
               (this.rda_fra_id != null && !this.rda_fra_id.equals(rda_fra_id))  ||
               (rda_fra_id != null && !rda_fra_id.equals(this.rda_fra_id)) ){
         this.rda_fra_id_changed = true; 
         this.record_changed = true;
         this.rda_fra_id = rda_fra_id;
      }
   }
   public Double getRda_fra_id() {
      return this.rda_fra_id;
   }
   public void setRda_roa_id(Double rda_roa_id) {
      if (this.isForceUpdate() || 
               (this.rda_roa_id != null && !this.rda_roa_id.equals(rda_roa_id))  ||
               (rda_roa_id != null && !rda_roa_id.equals(this.rda_roa_id)) ){
         this.rda_roa_id_changed = true; 
         this.record_changed = true;
         this.rda_roa_id = rda_roa_id;
      }
   }
   public Double getRda_roa_id() {
      return this.rda_roa_id;
   }
   ...
   public Date getD05() {
    ...
    public void setRecordIdentifier(Object recIdentifier) {
        if (recIdentifier != null && !EMPTY_STRING.equals(recIdentifier)  && !"null".equalsIgnoreCase(recIdentifier.toString())){
            this.rda_id = (Double)recIdentifier;
        }
    }
    @JsonIgnore
    ...
    public void validateObject(int operation, SprBaseDBServiceImpl<?> baseService) throws SparkBusinessException{
      if (rda_date_from_changed || operation == Utils.OPERATION_INSERT) {
         if (rda_date_from== null) {
            throw new SparkBusinessException(new S2Message("SPR_ROLE_DISABLED_ACTIONS", "RDA_DATE_FROM", DB_ERROR_MANDATORY_PATH, SparkMessageType.ERROR));
         }
      }
      if (rda_fra_id_changed || operation == Utils.OPERATION_INSERT) {
         if (rda_fra_id!= null && (""+rda_fra_id.intValue()).length()>12) {
            throw new SparkBusinessException(new S2Message("SPR_ROLE_DISABLED_ACTIONS", "RDA_FRA_ID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"12"));
         }
      }
      if (rda_roa_id_changed || operation == Utils.OPERATION_INSERT) {
         if (rda_roa_id!= null && (""+rda_roa_id.intValue()).length()>12) {
            throw new SparkBusinessException(new S2Message("SPR_ROLE_DISABLED_ACTIONS", "RDA_ROA_ID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"12"));
         }
      }
      if (rec_version_changed || operation == Utils.OPERATION_INSERT) {
         if (rec_version!= null && (""+rec_version.intValue()).length()>6) {
            throw new SparkBusinessException(new S2Message("SPR_ROLE_DISABLED_ACTIONS", "REC_VERSION", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"6"));
         }
      }
      if (rec_userid_changed || operation == Utils.OPERATION_INSERT) {
         if (rec_userid!= null && rec_userid.length()>128) {
            throw new SparkBusinessException(new S2Message("SPR_ROLE_DISABLED_ACTIONS", "REC_USERID", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"128"));
         }
      }
      if (c01_changed || operation == Utils.OPERATION_INSERT) {
         if (c01!= null && c01.length()>2000) {
            throw new SparkBusinessException(new S2Message("SPR_ROLE_DISABLED_ACTIONS", "C01", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2000"));
         }
      }
      if (c02_changed || operation == Utils.OPERATION_INSERT) {
         if (c02!= null && c02.length()>2000) {
            throw new SparkBusinessException(new S2Message("SPR_ROLE_DISABLED_ACTIONS", "C02", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2000"));
         }
      }
      if (c03_changed || operation == Utils.OPERATION_INSERT) {
         if (c03!= null && c03.length()>2000) {
            throw new SparkBusinessException(new S2Message("SPR_ROLE_DISABLED_ACTIONS", "C03", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2000"));
         }
      }
      if (c04_changed || operation == Utils.OPERATION_INSERT) {
         if (c04!= null && c04.length()>2000) {
            throw new SparkBusinessException(new S2Message("SPR_ROLE_DISABLED_ACTIONS", "C04", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2000"));
         }
      }
      if (c05_changed || operation == Utils.OPERATION_INSERT) {
         if (c05!= null && c05.length()>2000) {
            throw new SparkBusinessException(new S2Message("SPR_ROLE_DISABLED_ACTIONS", "C05", DB_ERROR_LENGTH_PATH, SparkMessageType.ERROR,"2000"));
         }
      }
   }
   ...
   public UpdateStatementPart constructUpdatePart(String userName) {
      ...
      String answer = "UPDATE SPR_ROLE_DISABLED_ACTIONS SET ";
      boolean changedExists = false;      if (rda_date_from_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"RDA_DATE_FROM = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(rda_date_from);
      }
      if (rda_date_to_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"RDA_DATE_TO = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(rda_date_to);
      }
      if (rda_fra_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"RDA_FRA_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(rda_fra_id);
      }
      if (rda_roa_id_changed) {
         answer = answer +  (changedExists? COMMA : EMPTY_STRING)+"RDA_ROA_ID = ? ";
         changedExists = true;
         updateStatementPart.addStatementParam(rda_roa_id);
      }
      if (n01_changed) {
      ...
      answer = answer +" WHERE  RDA_ID = ? ";
      updateStatementPart.addStatementParam(rda_id);
      updateStatementPart.setStatementPart(answer);
      return updateStatementPart;
   }
   public String toString() {
      return "{\"SprRoleDisabledActionsDAO\":{\"rda_id\": \""+getRda_id()+"\", \"rda_date_from\": \""+getRda_date_from()+"\", \"rda_date_to\": \""+getRda_date_to()+"\", \"rda_fra_id\": \""+getRda_fra_id()+"\", \"rda_roa_id\": \""+getRda_roa_id()+"\", \"rec_version\": \""+getRec_version()+"\", \"rec_create_timestamp\": \""+getRec_create_timestamp()+"\", \"rec_userid\": \""+getRec_userid()+"\", \"rec_timestamp\": \""+getRec_timestamp()+"\", \"n01\": \""+getN01()+"\", \"n02\": \""+getN02()+"\", \"n03\": \""+getN03()+"\", \"n04\": \""+getN04()+"\", \"n05\": \""+getN05()+"\", \"c01\": \""+getC01()+"\", \"c02\": \""+getC02()+"\", \"c03\": \""+getC03()+"\", \"c04\": \""+getC04()+"\", \"c05\": \""+getC05()+"\", \"d01\": \""+getD01()+"\", \"d02\": \""+getD02()+"\", \"d03\": \""+getD03()+"\", \"d04\": \""+getD04()+"\", \"d05\": \""+getD05()+"\"}}";
   }
